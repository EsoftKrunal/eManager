<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserOnBehalfManagement.aspx.cs" Inherits="UserOnBehalfManagement" %>
        ...
        <table cellpadding="0" cellspacing="0" width="100%">
          <tr>
            ...
            <tr>
                ...
                <strong class="pagename" >On Behalf-Rights   Assignment</strong>
                                      ...
                                      <ItemTemplate>
                                          <tr>
                                              <td style=" width :200px;text-align : left">
                                                  &nbsp;<%# Eval("UserId")%><asp:HiddenField ID="hfdUserId" runat="server" 
                                                      value='<%# Eval("LoginId") %>' />
                                              </td>
