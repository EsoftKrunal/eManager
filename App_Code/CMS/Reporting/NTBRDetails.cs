...
/// <summary>
/// Summary description for NTBRDetails
/// </summary>
public class NTBRDetails
{
    public NTBRDetails()
    {
        //
    ...
    public static DataTable selectNTBRDetails(int _userid, DateTime _fromdate, DateTime _todate)
    {
        string procedurename = "PrintNTBRDeNTBRReport";
