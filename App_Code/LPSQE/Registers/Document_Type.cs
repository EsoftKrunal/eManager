...
public class Document_Type
{
    ...
    public static DataTable DocumentTypeDetails(int _id, string _type, string _desc, int _createdby, int _modifiedby, string _transtype)
    {
        string procedurename = "PR_ADMS_DocumentType";
        DataTable dt1 = new DataTable();

        Database objDatabase = DatabaseFactory.CreateDatabase();
        DbCommand objDbCommand = objDatabase.GetStoredProcCommand(procedurename);
        objDatabase.AddInParameter(objDbCommand, "@Id", DbType.Int32, _id);
        objDatabase.AddInParameter(objDbCommand, "@Type", DbType.String, _type);
