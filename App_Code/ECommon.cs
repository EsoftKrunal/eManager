...
public class ECommon
{
    ...
    static EMyParameter[] Parameters;
    ...
    public static String ConString = ConfigurationManager.ConnectionStrings["eMANAGER"] != null ? ConfigurationManager.ConnectionStrings["eMANAGER"].ToString() : "";
    //------
    ...
    public static void Set_Parameters(params EMyParameter[] Dummy)
    {
        Parameters = Dummy;
    }
    ...
    {
        ConnectionString = ConfigurationManager.ConnectionStrings["MW_DBConnection"].ToString();
    }
    ...
    //    catch { return null; }
    //}
    public static DataTable Execute_Procedures_Select_ByQuery_CMS(string Query)
    {
        DataSet RetValue = new DataSet();
    ...
    public static DataTable Execute_Procedures_Select_ByQuery_MTM(string Query)
    {
        DataSet RetValue = new DataSet();
        SqlConnection myConnection = new SqlConnection(ConfigurationManager.ConnectionStrings["MW_DBConnection"].ToString());
        SqlDataAdapter Adp = new SqlDataAdapter();
        SqlCommand Command = new SqlCommand(Query, myConnection);
        try
        {
    ...
    {
        object Value = ECommon.getControlValue(itm.FindControl(ControlId));
    ...
    public void SendGEmails(string fromAddress, string toAddress, string tocc, string mailsubject, string msgContent, bool isBodyHTML)
    {
        MailMessage objMessage = new MailMessage();
        SmtpClient objSmtpClient = new SmtpClient();
        MailAddress objfromAddress = new MailAddress(fromAddress, "Web Admin");
        try
        {
            ...
            objSmtpClient.Credentials = new System.Net.NetworkCredential("pankaj.k@esoftech.com", "pankaj99");
            objMessage.IsBodyHtml = isBodyHTML;
            objMessage.Body = msgContent;
            objSmtpClient.Send(objMessage);
        }
    ...
    #endregion
    //-------------
    public void SendRegistrationEmail(string Message, string FromMail)
    {
        string UserEmail = FromMail;
        string strMailBody = Message;
        if (ConfigurationManager.AppSettings["baseurl"].Contains("localhost"))
        {
            SendEmails("newaccount@adultjobzone.com", UserEmail, "", "New member registration", strMailBody, true);
        }
        else
        {
            SendGEmails("pankaj.k@esoftech.com", "vaseem@esoftech.com", "", "New member registration", strMailBody, true);
        }
    }
...
public static void BindYear(DropDownList ddl)
{
    ...
    public static bool APEXPORT(string Company, string Ship, string User, int JeId, string JeType, out string Error)
    {
        using (SqlConnection myConnection = new SqlConnection(ConfigurationManager.ConnectionStrings["EMANAGER"].ToString()))
        {
            DataSet RetValue = new DataSet();
            SqlCommand Command = new SqlCommand("APExport_POS", myConnection);
            Command.CommandType = CommandType.StoredProcedure;
            Command.Parameters.Add(new SqlParameter("@CompCode", Company));
            Command.Parameters.Add(new SqlParameter("@VslCode", Ship));
            Command.Parameters.Add(new SqlParameter("@UserName", User));
            Command.Parameters.Add(new SqlParameter("@JeId", JeId));
            Command.Parameters.Add(new SqlParameter("@JeType", JeType));
            myConnection.Open();
            try
            {
    ...
    public static bool GP_EXPORT(string company, string usercode, string bidcurr, string invoiceno, DateTime invoicedate, string aptravvenid, string bidvenname, string accounnumber, string gpaccountnumber, string shipid, string gpshipid, decimal approvalamount, string bidponum, DateTime datecreated, DateTime OriginalInvoiceDate, int invoiceid, out int importid, out string Error)
    {
        bool result = false;
        Error = "";
        importid = -1;
        string datemonth = DateTime.Today.ToString("ddMM");
        using (SqlConnection myConnection = new SqlConnection(ConfigurationManager.ConnectionStrings["GP_DBConnection"].ToString()))
        {
            SqlCommand cmd = new SqlCommand("pos_export_invoice_gp");
            cmd.CommandType = CommandType.StoredProcedure;
            SqlDataAdapter adp = new SqlDataAdapter();
            try
            {
                cmd.Parameters.Add(new SqlParameter("@Company", (object)company));
                cmd.Parameters.Add(new SqlParameter("@BatchNumber", (object)company + datemonth + bidcurr + usercode));
                cmd.Parameters.Add(new SqlParameter("@DocumentType", (object)1));
                cmd.Parameters.Add(new SqlParameter("@DocumentNumber", (object)invoiceno));
                cmd.Parameters.Add(new SqlParameter("@DocumentDate", (object)invoicedate.ToString("dd-MMM-yyyy")));
                cmd.Parameters.Add(new SqlParameter("@VendorID", (object)aptravvenid));
                cmd.Parameters.Add(new SqlParameter("@VendorName", (object)bidvenname));
                cmd.Parameters.Add(new SqlParameter("@Description", (object)"Export From Shipsoft"));
                cmd.Parameters.Add(new SqlParameter("@PurchaseAccountNumber", (object)company + "-" + gpaccountnumber + "-" + gpshipid));
                cmd.Parameters.Add(new SqlParameter("@APAccountNumber", (object)company + "-13000-" + gpshipid));
                cmd.Parameters.Add(new SqlParameter("@CurrencyID", (object)bidcurr));
                cmd.Parameters.Add(new SqlParameter("@ExchangeRate", (object)0));
                cmd.Parameters.Add(new SqlParameter("@DocumentAmount", (object)approvalamount));
                cmd.Parameters.Add(new SqlParameter("@ReadyToImport", (object)1));
                cmd.Parameters.Add(new SqlParameter("@ImportResult", (object)DBNull.Value));
                cmd.Parameters.Add(new SqlParameter("@ErrorMessage", (object)DBNull.Value));
                cmd.Parameters.Add(new SqlParameter("@UserID", (object)DBNull.Value));
                cmd.Parameters.Add(new SqlParameter("@DateCreated", (object)datecreated.ToString("dd-MMM-yyyy")));
                cmd.Parameters.Add(new SqlParameter("@TransID", (object)DBNull.Value));
                cmd.Parameters.Add(new SqlParameter("@Vessel", (object)gpshipid));
                cmd.Parameters.Add(new SqlParameter("@PoNo", (object)bidponum));
                cmd.Parameters.Add(new SqlParameter("@OriginalInvoiceDate", (object)OriginalInvoiceDate.ToString("dd-MMM-yyyy")));
                cmd.Parameters.Add(new SqlParameter("@invoiceid", (object)invoiceid));


                //------------------------
                SqlParameter param1 = new SqlParameter();
                param1.ParameterName = "@importid";
                ...
                importid = Common.CastAsInt32(cmd.Parameters["@importid"].Value);
                result = true;
            }
            catch (Exception ex)
            {
