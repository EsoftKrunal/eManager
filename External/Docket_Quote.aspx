    ...
    <asp:Panel ID="pnl_Password" runat="server" >
       ...
       <div style="width :100%; height :300px; text-align :center; padding-top :150px; font-family:Calibri; font-size:14px;">
        ...
        <div style="color:Red; padding:10px;">
             Note: If you have not received your password please send request to emanager@energiossolutions.com with your full contact details and ship name.      
        </div>
        </center>
        </div> 
    </asp:Panel>
                ...
                <table cellspacing="0" rules="none" border="0" cellpadding="0" style="width:100%;border-collapse:collapse;">
                                ...
                                <asp:Repeater ID="rptJobs" runat="server">
                                    <ItemTemplate>
                                           ...
                                           <a id="A1" href="#" style="font-size:10px; color:blue; text-decoration:italc;" onclick="View_JobDesc(this);" RFQId='<%#Eval("RFQId")%>' DocketJobId='<%#Eval("DocketJobId")%>' DocketId='<%#Eval("DocketId")%>' title='View Job Description..' runat="server" visible='<%#(Eval("JobDesc").ToString().Trim()!="")%>' >More..</a></div></td>
                                           <td>&nbsp;</td>
                                           </tr>
                                           <tr style=''>
                                           <td colspan="3" style="background-color:#E0F5FF;border-bottom:solid 1px white;">
                                                    ...
                                                    <asp:Repeater ID="rptSubJobs" runat="server" DataSource='<%#BindSubJobs(Eval("DocketJobId"))%>'>
                                                            ...
                                                            <td align="left" >
                                                                <div>
                                                                    ...
                                                                    <div style=" float:left; padding-right:10px;">
                                                                        <a id="A2" href="#" style="font-size:10px; color:blue; text-decoration:italc;" onclick="View_More(this);" RFQId='<%#Eval("RFQId")%>' DocketSubJobId='<%#Eval("DocketSubJobId")%>' DocketJobId='<%#Eval("DocketJobId")%>' DocketId='<%#Eval("DocketId")%>' title='View Job Details..' runat="server" visible='<%#(Eval("LongDescr").ToString().Trim()!="")%>'>More..</a>
                                                                    </div>
                                                                </div>
                                                       ...
                                                       <AlternatingItemTemplate>
                                                           ...
                                                           <td style="text-align:left;width:130px;"><b><%#Eval("SubJobCode")%></b>
                                                            <div id="Div4" style="color:Red; clear:both;" runat="server" visible='<%#(Eval("VendorRemarks").ToString().Trim()!="")%>'>
                                                                Vendor Remarks :
                                                            </div>
                                                            </td>
                                                            <td align="left" >
                                                                <div>
                                                                    <div style="float:left;white-space: nowrap; width: 290px; overflow: hidden;text-overflow: ellipsis;"><%#Eval("SubJobName")%></div>
                                                                    <div style=" float:left; padding-right:10px;">
                                                                        <a id="A3" href="#" style="font-size:10px; color:blue; text-decoration:italc;" onclick="View_More(this);" RFQId='<%#Eval("RFQId")%>' DocketSubJobId='<%#Eval("DocketSubJobId")%>' DocketJobId='<%#Eval("DocketJobId")%>' DocketId='<%#Eval("DocketId")%>' title='View Job Details..' runat="server" visible='<%#(Eval("LongDescr").ToString().Trim()!="")%>'>More..</a>
                                                                    </div>
                                                                </div>
                                                                <div id="Div5" style="color:Red; clear:both;" runat="server" visible='<%#(Eval("VendorRemarks").ToString().Trim()!="")%>'>
                                                                <%#Eval("VendorRemarks")%>
                                                                </div>
                                                            </td>
                                                            <td style="text-align:center;width:30px;"><asp:ImageButton runat="server" Visible='<%#(Eval("AttachmentName").ToString().Trim()!="")%>' ID="imgDownload" ImageUrl="~/Images/paperclipx12.png" CommandArgument='<%#Eval("DocketSubJobId")%>' DocketJobId='<%#Eval("DocketJobId")%>' OnClick="imgDownload_Click" /></td>
                                                            ...
                                                            <td style="text-align:right;width:100px;"><asp:Label runat="server" ID="lblNetAmt" Text='<%#Eval("NetAmount")%>' style="text-align:right" ></asp:Label></td>
                                                            <td style="text-align:center;width:20px;"><span id="Span2" runat="server" visible='<%#CanEdit%>'><img title="Remarks" style="cursor:pointer;" onclick="View_Remarks(this);" src="Images/AddPencil.gif" RFQId='<%#Eval("RFQId")%>' DocketSubJobId='<%#Eval("DocketSubJobId")%>' DocketJobId='<%#Eval("DocketJobId")%>' DocketId='<%#Eval("DocketId")%>' /></span></td>
                                                            <td style="width:20px;">&nbsp;</td>
                                                            </tr>
                                                    </AlternatingItemTemplate>
                                                    </asp:Repeater>
                         ...
                         <td colspan="4">
                            <div style="text-align:center; padding:5px;">
                                    <div style="text-align:center;float:right">
                                        <asp:Button runat="server" ID="btn_UpdateSubJob" Text="Save" OnClick="btn_UpdateSubJob_Click" style=" padding:3px; border:none; color:White; background-color:#2E9AFE; width:80px;"  />
                   ...
                   <tr>
                    ...
                    <tr>
                         <td>
                            <div style="text-align:center; padding:5px;">                                   
                                    <div style="text-align:center;float:right">
                                        <asp:Button runat="server" ID="btnClose_ViewJobDesc" Text="Close" OnClientClick="return Close_ViewDesc();" style=" padding:3px; border:none; color:White; background-color:Red; width:80px;"  />
                                    </div>
                            </div>
                         </td>
                    </tr>
