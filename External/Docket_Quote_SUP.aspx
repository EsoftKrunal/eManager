        ...
        <td style=" text-align :left; vertical-align : top;" > 
                                                            ...
                                                            <td align="left" >
                                                                <div>
                                                                    ...
                                                                    <div style=" float:right; padding-right:10px;">
                                                                        <a href="#" style="font-size:10px; color:blue; text-decoration:italc;" onclick="View_More(this);" RFQId='<%#Eval("RFQId")%>' DocketSubJobId='<%#Eval("DocketSubJobId")%>' DocketJobId='<%#Eval("DocketJobId")%>' DocketId='<%#Eval("DocketId")%>' title='View Job Details..' >View More..</a>
                                                                    </div>
                                                                </div>
         ...
         <div style="text-align:right; padding:3px; background-color:#ADD6FF; font-weight:bold;">
          ...
          <tr>
            ...
            <td style="text-align:left;width:120px; ">&nbsp;<asp:DropDownList runat="server" ID="ddlCurrency" Width="100px" AutoPostBack="true" OnSelectedIndexChanged="ddlCurrency_OnSelectedIndexChanged"></asp:DropDownList></td>
