...
<body style="margin:0px; padding-bottom:160px;">
    ...
    <asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server"></asp:ToolkitScriptManager>
      ...
      <div style="border:none; background-color : #ADD6FF; padding:0px; position:fixed; bottom:0px;width:100%; height:165px; vertical-align:top;">
      <div style="height:25px;">
                <table cellspacing='0' rules='all' border='1' bordercolor='black' cellpadding='0' style='border-collapse:collapse; width:100%; height:25px; background-color:orange;'>
                    <tr>
      ...
      <table cellspacing='2' rules='all' border='0' bordercolor='black' cellpadding='3' style='border-collapse:collapse; width:100%; font-size:14px;'>
        ...
        <td style='text-align:right; background-color:#B2F0FF;'>&nbsp;<asp:TextBox runat="server" Font-Bold="true" ID="txtFinalDiscount" AutoPostBack="true" OnTextChanged="txtFinalDiscount_OnTextChanged" class="newinput" style="text-align:right; width:95%;" ></asp:TextBox></td>
        <td colspan="2"></td>
        </tr>
        <tr>
        <td colspan="2"></td>
