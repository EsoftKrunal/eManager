...
{
    public class ProcessSelectCrewMemberExperienceDetails : IBusinessLogic
    {
        private DataSet _resultset;
        private ExperienceDetails _experiencedetails;

        public ProcessSelectCrewMemberExperienceDetails()
        {
        }
        public void Invoke()
        {
            CrewMemberExperienceDetailsSelectData experienceselectdata = new CrewMemberExperienceDetailsSelectData();
