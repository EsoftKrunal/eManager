...
{
   public class ProcessGetDocumentDetailsinGrid:IBusinessLogic
    {
       private DataSet _resultset;
       private TravelDocumentDetails _documentdetails;
       public ProcessGetDocumentDetailsinGrid()
       {
       }
       public void Invoke()
       {
           DocumentDetailsSelectDataInGrid documentdetailsselectdataingrid = new DocumentDetailsSelectDataInGrid();
