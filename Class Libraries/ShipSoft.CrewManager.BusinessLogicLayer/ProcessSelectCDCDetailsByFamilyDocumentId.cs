...
{
   public class ProcessSelectCDCDetailsByFamilyDocumentId : IBusinessLogic
    {
       private CrewFamilyDocumentDetails _crewFamilyDocumentDetails;
        private DataSet _result;

       public ProcessSelectCDCDetailsByFamilyDocumentId()
    {
 
    }
        public void Invoke()
        {
            CDCDetailsSelectDataByFamilyDocumentId cdcDetailsSelectDataByFamilyDocumentId = new CDCDetailsSelectDataByFamilyDocumentId();
            cdcDetailsSelectDataByFamilyDocumentId.CrewFamilyDocumentDetails = CrewFamilyDocumentDetails;
            ResultSet = cdcDetailsSelectDataByFamilyDocumentId.Get();
            ...
            CrewFamilyDocumentDetails.DocumentName = ResultSet.Tables[0].Rows[0]["DocumentName"].ToString();
            CrewFamilyDocumentDetails.Issuedate=Convert.ToDateTime(ResultSet.Tables[0].Rows[0]["IssueDate"].ToString()).ToString("MM/dd/yyyy") ;
            CrewFamilyDocumentDetails.Expirydate = Convert.ToDateTime(ResultSet.Tables[0].Rows[0]["ExpiryDate"].ToString()).ToString("MM/dd/yyyy") ;
