...
{
   public class TravelDocumentDetailsSelectDataInGrid:DataAccessBase
    {
       private TravelDocumentDetails _documentdetails;
       public TravelDocumentDetailsSelectDataInGrid()
       {
          StoredProcedureName = StoredProcedure.Name.selecttraveldocumentdetailsingrid.ToString();
       }
       public DataSet Get()
       {
           DataSet ds;
