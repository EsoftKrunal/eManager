<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VslDocManagement.aspx.cs" Inherits="VslDocManagement" %>
                            ...
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td style="width:30px; text-align:center">   
                                        <asp:ImageButton ID="imgDel" runat="server" ImageUrl="~/Images/delete.png" OnClick="imgDel_OnClick" OnClientClick="return confirm('Are you sure to delete?')" CommandArgument='<%#Eval("TableID")%>' Height="12px" Visible='<%#(Eval("VesselCode").ToString()!="")%>' />
                                        <asp:HiddenField ID="hfFileName" runat="server" Value='<%#Eval("UpFileName")%>' />
                                    </td>
                                    <td>&nbsp;<%#Eval("Descr")%></td>
                                    <td style="width:150px;">
                                        <a href='UploadFiles/<%#((Eval("VesselCode").ToString().Trim()=="")?"AttachmentForm/":Session["VC"].ToString()+"/")+ Eval("UpFileName").ToString()%>' target="_blank" ><%#Eval("UpFileName")%> </a>
                                    </td>    
                                </tr>
                            </ItemTemplate>
                        </asp:Repeater>
