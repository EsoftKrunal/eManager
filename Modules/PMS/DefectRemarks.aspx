<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DefectRemarks.aspx.cs" Inherits="DefectRemarks" %>
        ...
        <table cellpadding="2" cellspacing="" border="0" width="100%">
            <tr >
                <td class="text headerband">
                  <b> Defect Remarks :&nbsp;<asp:Label ID="lblDefectNo" runat="server"></asp:Label></b>
                </td>
            </tr>
            <tr>
                <td>
