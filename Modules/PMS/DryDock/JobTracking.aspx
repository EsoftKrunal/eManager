<%@ Page Language="C#" AutoEventWireup="true" CodeFile="JobTracking.aspx.cs" Inherits="Docket_JobTracking" %>
...
<body>
    ...
    <div style="position:absolute; top:87px; padding-bottom:50px">
    <asp:Literal runat="server" ID="litData"></asp:Literal>
    </div>
    <div style="position:fixed;bottom:0px; width:100%; z-index:100; text-align:center; padding:5px; background-color:#FFFFCC; border-top:solid 1px #c2c2c2; text-align:right">
     ...
     <%-- Update Remarks --%>
        ...
        function ShowHistory(ctl) {
            ...
            //$("#dv_Start").show();
            window.open('JobTrackingHistory.aspx?DocketId=' + <%=DocketId.ToString()%> + '&RFQId=' + <%=RFQId.ToString()%> + '&CatId=' + <%=ddlJObCat.SelectedValue%> +  '&DocketJobId=' + $(ctl).attr('docketjobid'), '');
        }
