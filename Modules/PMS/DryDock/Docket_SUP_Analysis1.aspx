<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Docket_SUP_Analysis1.aspx.cs" Inherits="Docket_SUP_Analysis1" %>
...
<body>
    ...
    <div style="background-color:#1947A3;color:White; text-align:center; padding:3px; font-size:15px; "><b>SUPTD. QUOTE ANALYSIS</b></div>
    ...
    <div>
    <span style="float:left;color:Red; font-size:14px;"><b>Please click Notify to GM/DGM once docket specs is ready.</b></span>
    <center>
    <asp:Button runat="server" ID="btnPrint" Text="Print Comparison" OnClick="btnAskPrint_Click" CommandArgument="3" CssClass='btn' Width="130px"/>
    <asp:Button runat="server" ID="btnNotifyToGM" Text="Notify to GM/DGM" OnClick="btnNotifyGM_Click"  Width="130px" OnClientClick="return ConfirmNotify(this);" CommandArgument="4" CssClass='btn'/>
                            ...
                            <div style="position: relative; width: 700px; padding: 3px; text-align: center;background: white; z-index: 150; top: 100px; border: solid 10px black;">
                               <asp:UpdatePanel runat="server" id="UpdatePanel221411">
                                ...
                                <div style="text-align:center;">
                                    <asp:Button runat="server" ID="Button1" Text="Print" OnClick="btnPrint_Click" style=" padding:3px; border:none; color:White; background-color:#2E9AFE; width:80px;"  />
