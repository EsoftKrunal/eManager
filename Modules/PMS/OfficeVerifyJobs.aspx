<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OfficeVerifyJobs.aspx.cs" Inherits="OfficeVerifyJobs" %>
            ...
            <tr>
                <td>
                    <table style="background-color:#f9f9f9" border="0" cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <table  cellpadding="0" cellspacing="2" width="100%">
                            <tr>
                               <td style="text-align:left; padding-left:2px"><asp:DropDownList ID="ddlYear" CssClass="cddlYear" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlYear_OnSelectedIndexChanged" Width="125px">
                                </asp:DropDownList></td>
                        ...
                        <td style="text-align:left" >
                           ...
                           <tr>
                              <td style="text-align:left">
                            <asp:RadioButton ID="chkC" runat="server" AutoPostBack="true" OnCheckedChanged="btnTemp_OnClick" GroupName="g1" Text="Critical Jobs" />
                                        <asp:RadioButton ID="chkNC" runat="server" AutoPostBack="true" OnCheckedChanged="btnTemp_OnClick" GroupName="g1" Text="Non Critical Jobs" />
                                        <asp:RadioButton ID="chkAll" runat="server" AutoPostBack="true" OnCheckedChanged="btnTemp_OnClick" GroupName="g1" Text="All Jobs" Checked="true" />
                              </td>                        
                           </tr>
                          </table>
                        </td>
                                        ...
                                        <asp:Repeater ID="rptRepeterFleet" runat="server">
                                            ...
                                            <table width="100%" cellspacing="0" cellpadding="0" border="0">
                                                ...
                                                <tr style="">
                                                    ...
                                                    <td style="cursor:pointer">
                                                        <span class="SpanFollowup" vessel='<%#Eval("VesselCode")%>'><%#Eval("Followup")%></span>                                                        
                                                    </td>
                                                </tr>
                                                </table>
                    ...
                    <div style="height: 600px; overflow-y: scroll; overflow-x: hidden;">
                        <table cellspacing="0" class="withborder" border="1" cellpadding="2" style="width: 100%;border-collapse: collapse; font-size: 13px; color:#777;">
                            ...
                            <asp:Repeater ID="rptComponentUnits" runat="server">
                                <ItemTemplate>
                                    <%--<tr class='myrow <%#((Eval("Verified_OFF").ToString()=="True")?"verified":"notverified")%> '>--%>
                                    <tr class='myrow'>
                                        <td style="text-align: center; padding-top: 5px;">
                                            <img onclick="opendetails(this);" src="Images/magnifier.png" style="height: 12px;cursor: pointer;" hid='<%#Eval("HistoryId")%>' vsl='<%#Eval("VesselCode")%>' act='<%#Eval("Action")%>' />
                                        </td>
                                        <td align="left">
                                            <%#Eval("ComponentCode")%>
                                        </td>
                                        ...
                                        <td align="left">
                                            <b><%#Eval("JobCode")%></b>-<%#Eval("DescrSh")%><span runat="server" visible='<%#(Eval("CriticalType").ToString()=="C")%>' 
                                            style="float: right;background-color: Red; color: White; display: inline-block; padding: 0px 3px 0px 3px; height:15px;">C</span>
                                        </td>
                                        <td align="center">
                                            <%#Eval("Interval")%>-<%#Eval("IntervalName")%></td>
                                        <td align="center"><%#Common.ToDateString(Eval("lastduedate"))%></td>
                                         <td align="left">
                                        ...
                                        <td align="left">
                                            <%#Eval("DoneBy_Code")%>-<%#Eval("DoneBy_Name")%></td>
                                        <td style="text-align: left">
                                            <%#Eval("Verifiedby_OFF")%>
                                            /
                                            <%#DateString(Eval("VerifiedOn_OFF"))%>
                                            <img src="Images/icon_comment.gif" onclick="ShowComments('<%#Eval("Comments")%>')"
                                                style='cursor: pointer; float: right; padding-right: 5px; display: <%#((Eval("Verified_OFF").ToString()=="True")?"block":"none") %>' />
                                        </td>
                                        <%--<td align="center">
                                             <%#Eval("AppInDays")%>
                                            </td>--%>
