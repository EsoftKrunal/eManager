<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UpdateJobInterval1.aspx.cs" Inherits="UpdateJobInterval1" %>
...
<body style="margin-top:117px;margin-bottom:40px;">
    ...
    <asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server"></asp:ToolkitScriptManager>
        ...
        <%-----------------------------------%>                
        <div id="dvScroll"  onscroll="SetScrollPos(this)" style="margin-top:130px;" class="scrollbox" >                        
                            <table cellspacing="0" border="0" cellpadding="4" style="width:100%;border-collapse:collapse;" class="bordered">
                                <colgroup>                                     
                                    <col style="text-align :left" width="60px" />                                 
                                    <col style="text-align :left" />
                                    <col style="text-align :left" width="80px" />                                                            
                                ...
                                <ItemTemplate>
                                    <tr >
                                        ...
                                        <td><%#Eval("Interval") %></td>
                                        <td style="text-align:center" class='cls_<%#Eval("Status")%>'><%#(Eval("Status").ToString()=="A")?"Active":"InActive"%></td>
                                    </tr>
                                </ItemTemplate>
                            </asp:Repeater>                                 
                              </table>
