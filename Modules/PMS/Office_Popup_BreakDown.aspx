<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Office_Popup_BreakDown.aspx.cs"
    Inherits="Office_Popup_BreakDown" %>
...
<body>
    ...
    <div style="text-align: center">
        ...
        <div id="divTab1" runat="server">
            ...
            <div class="myheading1">Attachments</div>
             <table border="0" cellpadding="4" cellspacing="0" style="width: 100%;border-collapse: collapse;" class="bordered">
                            ...
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <%if (Session["UserType"].ToString().Trim() == "S")
                                      {%>
                                    <td>
                                        <asp:ImageButton runat="server" ID="btnDelAttachment" ImageUrl="~/Modules/HRD/Images/delete.png" Height="12px" OnClick="DeleteAttachment_OnClick" title='Delete Attachment' CommandArgument='<%#Eval("AttachmentId")%>'                                            OnClientClick="javascript:confirm('Are you sure to remove this attachment?');" />
                                    </td>
                                    <% }%>
                                </tr>
                            </ItemTemplate>
                ...
                <span style="float:left; margin-top:3px;">Office Remarks :</span>
                <span style="float:left">
                    <asp:ImageButton ID="btnAddRemarks" runat="server" CssClass="style5" OnClick="btnAddRemarks_Click" Text="Add Remarks" ImageUrl="~/Modules/HRD/Images/add_16.gif" />                
                </span>
            </div>
            <div>
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td style="text-align:left;"><%#Eval("Remarks")%></td>
                         <td>
                          <%--  <a runat="server" id="a1" href='<%# ProjectCommon.getLinkFolder(DateTime.Parse(txtReportDt.Text.Trim())) + Eval("FileName").ToString()  %>' target="_blank" visible='<%# Eval("FileName").ToString() != "" %>' title="Attachment">
                                <img src="Images/paperclip.gif" style="border: none" />
                            </a>--%>
                            <asp:ImageButton ID="btnAttachment" CommandArgument='<%#Eval("DefectRemarkId")%>' ToolTip="Show Attachment" ImageUrl="~/Modules/HRD/Images/paperclip.gif" OnClick="btnAttachment_Click" Visible='<%#Eval("FileName").ToString() != "" %>' runat="server" />
                        </td>
                        <td style="width:175px;"><%#Eval("EnteredByON")%></td>    
                            ...
                            <tr>
                                <td colspan="2">
                                        <div class="myheading1">Defect Closure :</div>
       ...
       <div style="position:absolute;top:0px;left:0px; height :100%; width:100%;z-index:100;" runat="server" id="dvOfficeComments" visible="false" >
            ...
            <center>
                <div style="padding :3px; text-align :center; width:80%; border:solid 5px black; background : white; z-index:150;top:100px;opacity:1;filter:alpha(opacity=100)">
                <iframe runat="server" id="frame1" width="100%" height="500" frameborder="0">

                </iframe>
                </div>
                </center>
                <div style="padding:5px">
                 <asp:Button ID="btnClose" OnClick="btnClose_Click" runat="server" CssClass="btn" Text="Close" Width="150px"/>
                 </div>
            </div>
       ...
       <div style="padding:5px; text-align:center;">
                ...
                <asp:Button ID="btnPrint" runat="server"  OnClick="btnPrint_Click" Text="Print" Visible="false" Width="100px" CssClass="btn" />
                <asp:Button ID="btnReduceImage" runat="server"  OnClick="btn_Reduce_Image_Click" Text=" Reduce Image " Width="100px" CssClass="btn" />
