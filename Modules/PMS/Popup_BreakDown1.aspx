<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Popup_BreakDown1.aspx.cs" Inherits="Popup_BreakDown1" %>
...
<body>
    ...
    <div style="text-align: center">
         ...
         <table cellpadding="3" cellspacing="0" style="width: 100%; border-collapse: collapse;" border="0" class="bordered">
                    ...
                    <td style="width: 50%; text-align: left;">
                            ...
                            TextMode="MultiLine" Width="99%"></asp:TextBox>
                              ...
                              <tr id="trCompStatus" runat="server">
                                ...
                                <td style="text-align: left; font-weight: bold;">
                                    <asp:DropDownList ID="ddlCompStatus" runat="server" Width="250px" Enabled="false">
                                        <asp:ListItem Text="&lt;Select&gt;" Value="0"></asp:ListItem>
                                        <asp:ListItem Text="Equipment Working" Value="1"></asp:ListItem>
                                        <asp:ListItem Text="Equipment Not Working" Value="2" Selected="True"></asp:ListItem>
                                    </asp:DropDownList>
                                </td>
                            </tr>
                           <tr>
                                ...
                                <td style="text-align: left;">
                                 <table cellpadding="3" cellspacing="0" border="1" style="width: 100%; border-collapse: collapse;">
                                    <tr>
                                        <td></td>
                                        <td colspan="2" style="text-align:center"><b>MTM</b></td>
                                                ...
                                                <ContentTemplate>
                                                    <table id="taddspates" runat="server" cellpadding="2" cellspacing="0" width="100%">
                                                        <tr>
                                                            ...
                                                            <asp:ImageButton ID="imgAddSpare" runat="server" ImageUrl="~/Images/wc-upload.png" OnClick="imgAddSpare_Click" />
                                                            </td>
                                                        ...
                                                        <ItemTemplate>
                                                            <tr visible='<%#Eval("SpareId").ToString() != "" %>'>
                                                                 <td align="center">
                                                                        ...
                                                                        <%{ %>
                                                                            <asp:ImageButton ID="ImageButton1" runat="server" CommandArgument='<%#Eval("RowId") %>' Height="12px" ImageUrl="~/Images/delete.png" OnClick="imgDeleteSpare_OnClick" OnClientClick="javascript:return confirm('Are you sure to delete?');" />
                                                                        <%} %>
                                                                        <% if (Request.QueryString["DN"] == null)
                                                                           { %>
                                                                            <asp:ImageButton ID="imgDel" runat="server" CommandArgument='<%#Eval("RowId") %>' Height="12px" ImageUrl="~/Images/delete.png" OnClick="imgDel_OnClick" OnClientClick="javascript:return confirm('Are you sure to delete?');" />
                                                                        <%} %>
                                                                </td>
                                                                <td align="left">
                                                                    <%#Eval("SpareName")%>
            ...
            <div id="trAttachments" visible="false" runat="server">
                <div id="divAttachment" onscroll="SetScrollPos(this)" class="scrollbox" style="overflow-y: scroll;overflow-x: hidden;height: 100px; text-align: center;">
                            ...
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <%if (Session["UserType"].ToString().Trim() == "S")
                                      {%>
                                    <td>
                                        <asp:ImageButton runat="server" ID="btnDelAttachment" Visible="<%#!closed%>" ImageUrl="~/Images/delete.png" Height="12px" OnClick="DeleteAttachment_OnClick" title='Delete Attachment' CommandArgument='<%#Eval("AttachmentId")%>'                                            OnClientClick="javascript:confirm('Are you sure to remove this attachment?');" />
                                    </td>
                                    <% }%>
                                  <td style="width:17px">
                                </td>
                  ...
                  <asp:Panel runat="server" ID="pnlofficecomments" Visible="false">
            <div class="myheading1">Office Comments :</div>
            <div>
              <table border="1" cellpadding="4" style="width: 100%; border-collapse: collapse;font-size:12px;" runat="server">
                             <tr>
                                 ...
                                 <td style="text-align:left;width:100px;">Download : </td>
                                 <td style="text-align:left"><asp:LinkButton runat="server" ID="lblRCAFile" OnClick="lblRCAFile_Click"></asp:LinkButton></td>
                             </tr>
                             <%--<tr>
        ...
        <div style="padding:5px; text-align:center;">
            <asp:Button ID="btnAddRemarks" runat="server" CssClass="style5" OnClick="btnAddRemarks_Click" Text="Add Remarks" Width="150px" />                
            <asp:Button ID="btnSave" runat="server" CssClass="style5" OnClick="btnSave_Click" Text="Save Breakdown" Width="150px" />
            <asp:Button ID="btnOpenPopupCloseDefect" runat="server" CssClass="style5" OnClick="btnOpenPopupCloseDefect_Click" Text="Closure" Visible="false" Width="150px" />
            <asp:Button ID="btnExport" runat="server" OnClick="btnExport_OnClick" Text="Export To Office" Width="139px" Visible="false"/>
            <asp:Button ID="btnExportAttachments" runat="server" OnClick="btnSendAttachment_OnClick" Text="Export Attachments" Width="139px" Visible="false"/>
        ...
        <div style="position:absolute;top:0px;left:0px; height :100%; width:100%;z-index:100; " runat="server" id="dvCloseDefect" visible="false" >
            <center>
                <div style="position:fixed;top:0px;left:0px; right:0px; bottom:0px; border:0px; background-color :Gray;z-index:100; opacity:0.4;filter:alpha(opacity=40)"></div>
                <div style="position :relative; width:1100px;padding :20px; text-align :center; border :solid 1px Red; background : white; z-index:150;top:100px;opacity:1;filter:alpha(opacity=100)">
                    ...
                    <tr>
                        ...
                        <tr>
                            <td colspan="2"  style="text-align:left;">
                                <asp:TextBox ID="txtRepairsCarriedout_CloseDefect" runat="server" Height="200px" MaxLength="1000" TextMode="MultiLine" Width="99%"></asp:TextBox>
                            </td>
                        </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <asp:Button ID="btnClosureSave" runat="server" CssClass="btn" OnClick="btnClosureSave_Click" Text="Close Breakdown" Width="140px" />
                        <asp:Button ID="btnCloseDefect" Text="Close" CssClass="btn" OnClick="btnCloseDefect_Click" runat="server"  Width="140px" />
                    </td>
                    </tr>
            </table>
                            </td>
                                                ...
                                                <ContentTemplate>--%>
                                                    <table id="taddspates_Pop" runat="server" cellpadding="2" cellspacing="0" width="100%">
                                                        <tr>
                                                            ...
                                                            <td style="text-align:left; width:40px">
                                                            <asp:ImageButton ID="imgAddSpare_Pop" runat="server" ImageUrl="~/Images/add.png" OnClick="imgAddSpare_Pop_Click" />
                                                            </td>
                                                            <td style="text-align: right; vertical-align: middle;width:110px;">
                                                                Qty(Consumed) :&nbsp;
                                                            </td>
                                                            ...
                                                            <td style="vertical-align: middle;width:120px;">
                                                                <asp:Button ID="btnAddSpare_Pop" runat="server" CssClass="btnorange" OnClick="btnAddSpare_Pop_Click" style="width: 110px; float: right;" Text=" + Add Spare" />
                                                                ...
                                                                <td align="center">
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <asp:ImageButton ID="imgDel" runat="server" CommandArgument='<%#Eval("RowId") %>'
                                                                            Height="12px" ImageUrl="~/Images/delete.png" OnClick="imgDel_OnClick" OnClientClick="javascript:return confirm('Are you sure to delete?');" />
                                                                        <%} %>
                                                                    </td>
