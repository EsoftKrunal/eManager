<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Office_CriticalEqpShutdownReq.aspx.cs" Inherits="Office_CriticalEqpShutdownReq" %>
...
<body>
    ...
    <center>
        <div style="text-align: center; width:85%; border:solid 1px black;">
    <asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server"></asp:ToolkitScriptManager>
    <asp:UpdatePanel ID="up" runat="server">
    <ContentTemplate>
        <table cellpadding="0" cellspacing="0" border="0" style="background-color:#f9f9f9; " width="100%">
         <tr style=" vertical-align:middle;" class="text headerband">
          ...
          <td style="text-align:center; padding:5px; font-weight:bold; width: 65%; font-size: 14px;">
               ...
               Vessel :&nbsp;<asp:Label ID="lblSd_VesselCode" runat="server"></asp:Label>
                ...
                <td style="text-align:left; padding:5px;">
                    <b>&nbsp;Note: Please ensure following are included in your Risk Assessment. Send the PMS update to office along with completed RA.</b>
                      ...
                      <table cellpadding="2" cellspacing="2" width="100%">
                          <tr>
                              ...
                              <td style="text-align:left;" colspan="3">
                                  <asp:Label ID="lblParent" runat="server" style="color :Blue;font-size:12px; font-style:italic;"></asp:Label>
                              </td>
                          </tr>
                          <tr>
                              <td style="text-align:right;">
                          ...
                          <tr>
                              <td style="text-align:right;">
                                  Occasion :</td>
                              <td style="text-align:left;">
                                  <asp:Label ID="lblOccassion" runat="server"></asp:Label>
                              </td>
                              <td style="text-align:right;">
                                  <span ID="sp_Defect" runat="server" visible="false">Defect No :</span>&nbsp;
                              </td>
                              <td style="text-align:left;">
                                  <asp:TextBox ID="txtDefectNo" runat="server" MaxLength="15" required="yes" 
                          ...
                          <tr>
                              ...
                              <td colspan="3" style="text-align:left;">
                                  <asp:Label ID="lblJobDefect" runat="server" Width="100%"></asp:Label>
                              </td>
                          </tr>
                      </table>
                  </fieldset>
               ...
               <fieldset>
                    ...
                    <ContentTemplate>
                     ...
                     <tr>
                         ...
                         <td style="text-align:left;">
                            <asp:Label ID="lblSd_PlannedSDHrs" runat="server"></asp:Label>    
                         </td>
                      </tr>
                      <tr>
                         <td style="text-align:right;">
                         ...
                         <td style="text-align:left;">
                                <asp:Label ID="lblSd_PlannedFromDate" runat="server"></asp:Label> 
                                <asp:Label ID="lblSd_PlannedFromTime" runat="server"></asp:Label> [HRS]
                             <%--<asp:DropDownList ID="ddlSd_PlannedFromHr" Width="40px" runat="server" ></asp:DropDownList>
                             <asp:DropDownList ID="ddlSd_PlannedFromMin" Width="40px" runat="server" ></asp:DropDownList>--%>
                         </td>
                     </tr>
                     <tr>
                         <td style="text-align:right;">
                         ...
                         <td style="text-align:left;">
                             <asp:Label ID="lblSd_PlannedToDate" runat="server" ></asp:Label>
                             <asp:Label ID="lblSd_PlannedToTime" runat="server" ></asp:Label> [HRS]
                          ...
                          <td style="padding:10px">
                            ...
                            <td style="text-align:left;">
                               <b>Approval (For Office use only)</b>
                                       ...
                                       <tr>
                                        <td style="text-align: right;">
                                            Do you want any change in this shutdown request from the ship ? :
                                        </td>
                                        <td style="text-align: left;">
                                       ...
                                       <tr>
                                           ...
                                           <td style="text-align: left;">
                                               <asp:TextBox ID="txtSd_ApproverRemarks" runat="server" Height="74px" 
                                                   MaxLength="5000" required="yes" TextMode="MultiLine" Width="600px"></asp:TextBox>
                                           </td>
                                       </tr>
                                       <tr>
                                           <td style="text-align:right;width:350px;">
                                               Comment by :</td>
                                           <td style="text-align:left;">
                                               <asp:Label ID="txtSd_ApproverName" runat="server" ></asp:Label>
                                           </td>
                                       </tr>
                                       <tr runat="server" visible="false">
                                           <td style="text-align:right;">
                                               Position :</td>
                                           <td style="text-align:left;">
                                               <asp:Label ID="txtSd_ApproverPosition" runat="server" ></asp:Label>
                                           </td>
                                       </tr>
                                       <tr>
                                           <td style="text-align: right;">
                                       ...
                                       <tr>
                                           <td colspan="2" 
                                               ...
                                               <asp:Button ID="btnApprove" runat="server" CssClass="btn" 
                                                   onclick="btnApprove_Click" Text="Save" Width="100px" />
                                           </td>
                                       </tr>
                                   </table>
                               </fieldset>
                             ...
                             <fieldset>
                                 ...
                                 <table cellpadding="2" cellspacing="2" width="100%">
                                      <tr>
                                         ...
                                         <td style="text-align:left;">
                                             <asp:Label ID="txtSd_MCommencedDate" runat="server" ></asp:Label>
                                             <asp:Label ID="txtSd_MCommencedTime" runat="server" ></asp:Label>
                                             [HRS]
                                             <%--&nbsp;/&nbsp;<asp:DropDownList ID="ddlSd_MCommencedHr" runat="server" Width="40px"></asp:DropDownList>
                                             &nbsp;:&nbsp;                                             
                                             <asp:DropDownList ID="ddlSd_MCommencedMin" runat="server" Width="40px"></asp:DropDownList>--%>
                                     ...
                                     <tr>
                                         ...
                                         <td style="text-align:left;">
                                             <asp:Label ID="txtSd_CompletedDate" runat="server" ></asp:Label>
                                             <asp:Label ID="txtSd_CompletedTime" runat="server" ></asp:Label>
                                              [HRS]
                                             <%--&nbsp;/&nbsp;<asp:DropDownList ID="ddlSd_MCompletedHr" runat="server" Width="40px"></asp:DropDownList>
                                             &nbsp;:&nbsp;
                                             <asp:DropDownList ID="ddlSd_MCompletedMin" runat="server" Width="40px"></asp:DropDownList>
                                             [HRS]
                                     ...
                                     <tr>
                                         <td style="text-align:right;">
                                             Remarks :&nbsp;</td>
                                         <td style="text-align:left;">
                                             <asp:Label ID="txtSd_MaintenanceRemarks" runat="server" Height="74px" 
                                                 MaxLength="5000" required="yes" TextMode="MultiLine" Width="600px"></asp:Label>
                                         </td>
                                     </tr>
                                     <tr>
                                         <td colspan="2" 
                                             ...
                                             <asp:Button ID="btnClosure" runat="server" CssClass="btn" 
                                                 onclick="btnClosure_Click" Text="Save" Visible="false" />
                                         </td>
                                     </tr>
                                 </table>
                             </fieldset>
         ...
         <div style="position:absolute;top:0px;left:0px; height :510px; width:100%;z-index:100;" runat="server" id="dvExtensions" visible="false" >
            <center>
            <div style="position:absolute;top:0px;left:0px; height :1100px; width:100%; background-color :Gray;z-index:100; opacity:0.4;filter:alpha(opacity=40)"></div>
         ...
         <div style="position:absolute;top:0px;left:0px; height :510px; width:100%;z-index:100;" runat="server" id="dvApprovals" visible="false" >
            <center>
            ...
            <div style="position :relative; width:550px; height:200px; padding :3px; text-align :center; border :solid 1px Red; background : white; z-index:150;top:100px;  ;opacity:1;filter:alpha(opacity=100)">
                ...
                <ContentTemplate>
                    <table cellpadding="2" cellspacing="2" width="100%">
                        <tr>
                            <td colspan="2" class="text headerband" style=" font-size: 14px; font-weight: bold; height: 25px; vertical-align: middle; text-align: center;">
                                Approve Extensions
                            </td>
                        </tr>
                        <tr>
                            <td style="text-align:right; width:25%;">Approver’s Remark :</td>
                            <td style="text-align:left;">
                            <asp:TextBox ID="txt_ApproversRemarks" TextMode="MultiLine" runat="server" required='yes' MaxLength="5000" 
                                    Height="74px" Width="99%"></asp:TextBox>
                            </td>

                        </tr>
                        <tr>
                            <td style="text-align:right;">Approver Name :</td>
                            <td style="text-align:left;">
                            <asp:TextBox ID="txt_ApproverName" required='yes'  runat="server"></asp:TextBox>
                            </td>

                        </tr>
                        <tr>
                            <td style="text-align:right;">Approver Position :</td>
                            <td style="text-align:left;">
                            <asp:TextBox ID="txt_ApproverPosition" required='yes'  runat="server"></asp:TextBox>
                            </td>

                        </tr>
                        <tr>
                           <td colspan="2" style="text-align: right; padding-right: 5px; padding-left: 5px;">
                               <asp:Button ID="btn_ApproveExtensions" Text="Approve" CssClass="btn" runat="server" Width="100px"
                                   onclick="btn_ApproveExtensions_Click" />&nbsp;
                               <asp:Button ID="btnCloseApproveExtension" Text="Close" CssClass="btn" OnClick="btnCloseApproveExtension_Click"  runat="server" />
                           </td>
                       </tr>
                    </table>
                </ContentTemplate>
                <Triggers>
                 <asp:PostBackTrigger ControlID="btnCloseApproveExtension" />
                 </Triggers>
                </asp:UpdatePanel>
            </div> 
            </center>
        ...
        <div>
            ...
            <asp:Button ID="btnExport" runat="server" OnClick="btnExportToShip_OnClick" Text="Export TO Ship" CssClass="btn" Width="139px" />
            <br /> <br />
        </center>
     </div>
     </center>
