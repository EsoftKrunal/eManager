...
function ValidateRadio(control_name, validation_message, message_container, other_control) {
    var result = false;
//    alert('hi'); alert($('input[name="' + control_name + '"]:checked').val());
    if ($('input[name="' + control_name + '"]:checked').val() == undefined) {
        if (other_control == null) {
            $(message_container).html(validation_message);
            result = false;
        }
        else {
            if ($(other_control).val() == '') {
                $(message_container).html(validation_message);
                result = false;
            }
            else {
