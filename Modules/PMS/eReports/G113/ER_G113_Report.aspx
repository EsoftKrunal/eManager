<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ER_G113_Report.aspx.cs" Inherits="CrewAppraisal_ER_G113_Report" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        {       
            ...
            document.getElementById('trAppraiseeComment').style.display='none';
            ...
            {
                document.getElementById('trAppraiseeComment').style.display='block';               
...
<body>
    ...
    <div>
        <div style=" background-color :#7AAAD2;color:White;text-align:center; padding:8px; font-size:18px;">
                ...
                <col />
				    <tr>
                        ...
                        <asp:DropDownList ID="ddlOccasion" runat="server">
                                ...
                                <asp:ListItem Value="101">EOC</asp:ListItem>
				    ...
				    <tr>
					    ...
					    <td>
                            <%--<asp:Label ID="lblAppFrom" runat="server" CssClass="lblData" style="width:80px;"></asp:Label>--%>
                            <asp:TextBox ID="txtAppraisalFromDate" runat="server" CssClass="date_only" style="width:80px;"></asp:TextBox>
					    </td>
					    <td>Appraisal To : </td>
					    <td>
						    <%--<asp:Label ID="lblAppTO" runat="server" CssClass="lblData" style="width:80px;"></asp:Label>--%>
                            <asp:TextBox ID="txtAppraisalToDate" runat="server" CssClass="date_only" style="width:80px;"></asp:TextBox>
					    </td>							    
				    </tr>
				    <tr>
        ...
        <div style="text-align:left;margin:5px; margin-bottom:0px;">
            <asp:UpdatePanel runat="server">
                <ContentTemplate>
                    <asp:Button ID="btnExport" runat="server" Text="Export" CssClass="btn" OnClick="btnExport_OnClick" style="float:right;margin-right:3px;" Visible="false" />
                    <asp:Button ID="btnSaveEvaluation" runat="server" Text="Save" CssClass="btn" OnClick="btnSaveEvaluation_OnClick" style="float:right;margin-right:3px;" Visible="false" />
            ...
            <ul class="menu" style="margin-top:5px; ">
                ...
                <li onclick="ShowMGTDiv(4,this.id);"><a>Remarks</a></li>

                <%--<li onclick="ShowMGTDiv(5,this.id);"><a>Appraisar Remarks</a></li>                    --%>
        ...
        <div id="trPerformance">
            <table cellpadding="5" cellspacing="0" border="0" rules="all">
                <col width="65%" />
                <col />
                <tr>
                    <td valign="top">
                        <table width="95%" cellpadding="4" cellspacing="2" border="0" style="border-collapse:collapse; text-align:left;" class="bordered" >
                            <col width="40%"/>
                            <col width="40px"/>
                            <col />
                                <tr>
                                ...
                                <tr >
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddlPerScale1" runat="server" CssClass="CalPerScale"  >
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtPerAss1" runat="server" CssClass="lable"  TextMode="MultiLine" Width="95%" Height="50px" ></asp:TextBox>
                                    </td>
                                </tr>
                                <tr >
                                    <td >
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddlPerScale2" runat="server" CssClass="CalPerScale"  >
                                            <asp:ListItem Value="" Text="Select" ></asp:ListItem>
                                            <asp:ListItem Value="1" Text="1" ></asp:ListItem>
                                            <asp:ListItem Value="2" Text="2" ></asp:ListItem>
                                            <asp:ListItem Value="3" Text="3" ></asp:ListItem>
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtPerAss2" runat="server" CssClass="lable"   TextMode="MultiLine" Width="95%" Height="50px" ></asp:TextBox>
                                ...
                                <tr id="trPerScale3" runat="server" >
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddlPerScale3" runat="server" CssClass="CalPerScale" >
                                            <asp:ListItem Value="" Text="Select" ></asp:ListItem>
                                            <asp:ListItem Value="1" Text="1" ></asp:ListItem>
                                            <asp:ListItem Value="2" Text="2" ></asp:ListItem>
                                            <asp:ListItem Value="3" Text="3" ></asp:ListItem>
                                    ...
                                    <td>
                                            ...
                                            <asp:TextBox ID="txtPerAss3" runat="server" CssClass="lable"   TextMode="MultiLine" Width="95%" Height="50px" ></asp:TextBox>
                    ...
                    <td>
                        ...
                        <table width="96%" cellpadding="4" cellspacing="2" border="0" style="border-collapse:collapse; text-align:left;" class="bordered" >
                                                                ...
                                                                <tr  style="text-align:center;" class="headercell">
                                                                    <td>Scale</td>
                                                                    <td>Indicates</td>
                                                                    <td>Definition</td>
                                                                </tr>
        ...
        <div id="trAssesment" style="display:none;" > 
            <table width="100%" cellpadding="5" cellspacing="0" border="0" rules="all">
                <col width="65%" />
                <col />
                <tr>
                    <td>
                        <table width="100%" cellpadding="4" cellspacing="2" border="0" style="border-collapse:collapse; text-align:left;" class="bordered" >
                            ...
                            <tr id="trAssScale8" runat="server">
                                ...
                                <td>
                                    <asp:DropDownList ID="ddlAssScale8" runat="server" CssClass="CalAssScale" >
                                        <asp:ListItem Value="" Text=" Select "></asp:ListItem>
                                        <asp:ListItem Value="1" Text="1"></asp:ListItem>
                                        <asp:ListItem Value="2" Text="2"></asp:ListItem>
                                        <asp:ListItem Value="3" Text="3"></asp:ListItem>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddlAssScale1" runat="server" CssClass="CalAssScale"  >
                                          <asp:ListItem Value="" Text=" Select "></asp:ListItem>
                                        <asp:ListItem Value="1" Text="1"></asp:ListItem>
                                        <asp:ListItem Value="2" Text="2"></asp:ListItem>
                                        <asp:ListItem Value="3" Text="3"></asp:ListItem>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddlAssScale2" runat="server" CssClass="CalAssScale" >
                                          <asp:ListItem Value="" Text=" Select "></asp:ListItem>
                                        <asp:ListItem Value="1" Text="1"></asp:ListItem>
                                        <asp:ListItem Value="2" Text="2"></asp:ListItem>
                                        <asp:ListItem Value="3" Text="3"></asp:ListItem>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddlAssScale3" runat="server" CssClass="CalAssScale"  >
                                          <asp:ListItem Value="" Text=" Select "></asp:ListItem>
                                        <asp:ListItem Value="1" Text="1"></asp:ListItem>
                                        <asp:ListItem Value="2" Text="2"></asp:ListItem>
                                        <asp:ListItem Value="3" Text="3"></asp:ListItem>
                            ...
                            <tr >
                                ...
                                <td>
                                    <asp:DropDownList ID="ddlAssScale4" runat="server" CssClass="CalAssScale">
                                          <asp:ListItem Value="" Text=" Select "></asp:ListItem>
                                        <asp:ListItem Value="1" Text="1"></asp:ListItem>
                                        <asp:ListItem Value="2" Text="2"></asp:ListItem>
                                        <asp:ListItem Value="3" Text="3"></asp:ListItem>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddlAssScale5" runat="server" CssClass="CalAssScale"  >
                                          <asp:ListItem Value="" Text=" Select "></asp:ListItem>
                                        <asp:ListItem Value="1" Text="1"></asp:ListItem>
                                        <asp:ListItem Value="2" Text="2"></asp:ListItem>
                                        <asp:ListItem Value="3" Text="3"></asp:ListItem>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddlAssScale6" runat="server" CssClass="CalAssScale" >
                                          <asp:ListItem Value="" Text=" Select "></asp:ListItem>
                                        <asp:ListItem Value="1" Text="1"></asp:ListItem>
                                        <asp:ListItem Value="2" Text="2"></asp:ListItem>
                                        <asp:ListItem Value="3" Text="3"></asp:ListItem>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:DropDownList ID="ddlAssScale7" runat="server" CssClass="CalAssScale"  >
                                          <asp:ListItem Value="" Text=" Select "></asp:ListItem>
                                        <asp:ListItem Value="1" Text="1"></asp:ListItem>
                                        <asp:ListItem Value="2" Text="2"></asp:ListItem>
                                        <asp:ListItem Value="3" Text="3"></asp:ListItem>
                    ...
                    <td >
                       <b> A. What additional responsibilities is he capable of taking beyond the normal job functions?</b><br />
                        <div id="divPotSecA1" runat="server" style="margin-left:15px; min-height:60px;  padding:3px;" class="lable">
                            <asp:TextBox ID="txtPotSecA1" runat="server" TextMode="MultiLine" Width="95%" Height="50px"></asp:TextBox>
                        </div>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td >
                        ...
                        <div id="divPotSecB1" runat="server" style="margin-left:15px;min-height:60px; padding:3px;" class="lable">
                            <asp:TextBox ID="txtPotSecB1" runat="server"  TextMode="MultiLine" Width="95%" Height="50px"></asp:TextBox>
                        </div>
                    </td>
                </tr>
                <tr>
                    ...
                    <td >
                       <b> C. Identify training needs:</b> <br /><br />
                        ...
                        <div id="divPotSecC1" runat="server" style="margin-left:15px;min-height:60px; padding:3px;" class="lable">
                            <asp:TextBox ID="txtPotSecC1" runat="server" TextMode="MultiLine" Width="95%" Height="50px"></asp:TextBox>
                        </div>
                        ...
                        <div id="divPotSecC2" runat="server" style="margin-left:15px; min-height:60px;" class="lable">
                            <asp:TextBox ID="txtPotSecC2" runat="server" TextMode="MultiLine" Width="95%" Height="50px"></asp:TextBox>
                        </div>
                    </td>
                </tr>
            </table>
        ...
        <div id="trAppraiseeComment" style="display:none;">
            <table width="100%" border="0" cellpadding="5" cellspacing="0">
                <col width="50%" />
                <col />
                <tr>
                    <td>
                        <table width="100%" border="0" rules="none" cellpadding="5" cellspacing="0"  style="border:solid 1px #7AAAD2;">
                                <tr class="TblHeading">
                                    <td colspan="4"  style="background-color:#7AAAD2;"><b> Appraisee Remarks:</b></td>
                                </tr>
                                <tr>
                                    <td colspan="4">
                                        <asp:TextBox runat="server" id="txtManAppAppraiseeRem" style="width:99%; height:70px;" rows="4" TextMode="MultiLine"></asp:TextBox>        
                                    </td>
                                </tr>
                                <tr>
                                    <td><b>Name:</b> </td>
                                    <td>
                                        <asp:TextBox runat="server" id="txtManAppAppraiseeName" type="text" maxlength="50" Enabled="false"></asp:TextBox>
                                    </td>
                                    <td> <b>Crew#.:</b></td>
                                    <td>
                                        <asp:TextBox runat="server" id="txtManAppAppraiseeCrewNo" type="text" maxlength="6"  Enabled="false"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr>
                                    <td><b>Rank:</b></td>
                                    <td>
                                        <asp:TextBox runat="server" id="txtManAppAppraiseeRank" type="text" maxlength="6"  Enabled="false"></asp:TextBox>
                                    </td>
                                    <td><b>Date:</b> </td>
                                    <td>
                                        <asp:TextBox runat="server" id="txtManAppAppraiseeDate"  type="text" maxlength="11" style="width:80px;background-color:#B5EAAA;" CssClass="date_only"></asp:TextBox>
                    ...
                    <td>
                        <table width="100%" border="0" rules="none" cellpadding="5" cellspacing="0" style="border:solid 1px #7AAAD2;">
                            <tr class="TblHeading">
                                                        <td colspan="4" style="background-color:#7AAAD2;"><b>Appraiser Remarks:</b></td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="4">
                                                            <asp:TextBox runat="server" id="txtManAppAppraiserRem" style="width:99%; height:70px;" rows="4"  TextMode="MultiLine"></asp:TextBox>        
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td><b>Name:</b></td>
                                                        <td>
                                                            <asp:TextBox runat="server" id="txtManAppAppraiserName" type="text" maxlength="50"></asp:TextBox>
                                                        </td>
                                                        <td><b>Crew#.:</b></td>
                                                        <td>
                                                            <asp:TextBox runat="server" id="txtManAppAppraiserCrewNo" type="text" maxlength="6" onblur="CheckCrewFormat(this)"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td><b>Rank:</b></td>
                                                        <td>
                                                            <asp:TextBox runat="server" id="txtManAppAppraiserRank" type="text" maxlength="6" ></asp:TextBox>
                                                        </td>
                                                        <td><b>Date:</b></td>
                                                        <td>
                                                            <asp:TextBox runat="server" id="txtManAppAppraiserDate"  type="text" maxlength="11"  style="width:80px;background-color:#B5EAAA;"  CssClass="date_only"></asp:TextBox>
                                                        </td>
                                                    </tr>
                        </table>
                    </td>
                ...
                <tr>
                    <td >
                        <table width="99%" cellpadding="4" cellspacing="2" border="0" rules="none" style="border-collapse:collapse; text-align:left;border:solid 1px #7AAAD2;margin:0px auto;" class=""   >
                                                    <col width="120px" />
                                                    <col width="200px" />
                                                    <col width="120px" />
                                                    <col  />
                                                    ...
                                                    <tr class="TblHeading">
                                                        <td colspan="4"  style="background-color:#7AAAD2;"><b>Master’s Remarks:</b><br />
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="4">
                                                            <asp:TextBox runat="server" id="txtManAppMasterRem" style="width:700px; height:70px;" TextMode="MultiLine"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td><b>Name:</b></td>
                                                        <td>
                                                            <asp:TextBox runat="server" id="txtManAppMasterName" type="text" maxlength="50"></asp:TextBox>
                                                        </td>
                                                        <td></td>
                                                        <td></td>
                                                    </tr>
                                                    <tr>
                                                        <td><b>Crew#:</b></td>
                                                        <td>
                                                            <asp:TextBox runat="server" id="txtManAppMasterCrewNo" type="text" maxlength="6" onblur="CheckCrewFormat(this)"></asp:TextBox>
                                                        </td>
                                                        <td><b>Date:</b> </td>
                                                        <td>
                                                            <asp:TextBox runat="server" id="txtManAppMasterDate"  type="text" maxlength="11" style="width:80px;background-color:#B5EAAA;"  CssClass="date_only"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                            ...
                            <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <asp:ImageButton ID="ImageButton5" runat="server" CausesValidation="false" ImageUrl="~/Images/Calendar.gif" />
                                   ...
                                   <td style="text-align:right;">
                                            <asp:Button ID="btn_Save_PlanTraining" runat="server" CssClass="btn" Text="Add" Width="50px" TabIndex="9" ValidationGroup="v789" OnClick="btn_Save_PlanTraining_Click" style="margin-right:10px;" Visible="false"/>
                                        </td>
                                    </tr>                                
                            </table>
                            ...
                            <asp:Repeater ID="rptTraining" runat="server" OnItemDataBound="rptTraining_OnItemDataBound" >
                                <ItemTemplate>
                                    <tr class="lable">    
                                        ...
                                        <td><asp:ImageButton ID="imgDel" runat="server" OnClick="imgDel_OnClick" ImageUrl="~/Modules/PMS/Images/delete1.gif" OnClientClick="return confirm('Are you sure to delete?')"  /></td>
                                    </tr>
                                </ItemTemplate>
                            </asp:Repeater>
                            </table>
