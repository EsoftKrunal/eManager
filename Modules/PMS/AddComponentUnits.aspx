<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddComponentUnits.aspx.cs" Inherits="AddComponentUnits" %>
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="border: #4371a5 1px solid; text-align:center" width="100%">
            ...
            <tr>
                <td>
                    ...
                    <colgroup>
                        <col style=" text-align:left;width:480px;" />
                        ...
                        <tr align="left" class= "headerstylegrid">
                           ...
                           <div id="dvScroll"  onscroll="SetScrollPos(this)" style="OVERFLOW-Y: scroll; OVERFLOW-X: hidden; WIDTH: 100%; HEIGHT: 300px ; text-align:center;" class="scrollbox">
                           <table cellspacing="0" rules="all" border="1" cellpadding="4" style="width:100%;border-collapse:collapse;">
                                <colgroup>
                                    <col style=" text-align:left;width:480px;" />
                                    <%--<col style="width:150px;" />--%>
                        ...
                        <tr><td colspan="2" align="right"><asp:Button ID="btnAddCompUnits" Text="Save" runat="server" OnClientClick="javascript:return confirm('This will add given units with existing.\nAre You Sure to Add Units?');" onclick="btnAddCompUnits_Click" />
                        </td>
                        </tr>
