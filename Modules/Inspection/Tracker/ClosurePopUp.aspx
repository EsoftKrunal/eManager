<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ClosurePopUp.aspx.cs" Inherits="FormReporting_ClosurePopUp" %>
           ...
           <tr>
            ...
            <tr>
                ...
                <td style="text-align: left" colspan="3">
                    ...
                    <asp:HiddenField ID="HiddenField_InspDoneDt" runat="server" />
                    <asp:HiddenField ID="HiddenField_Def" runat="server" />
                    <asp:HiddenField ID="HiddenField_Corr" runat="server" />
