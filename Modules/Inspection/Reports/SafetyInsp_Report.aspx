<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SafetyInsp_Report.aspx.cs" Inherits="Reports_SafetyInsp_Report" Title="Inspection Report" %>
         ...
         <table border="0" cellpadding="0" cellspacing="0" style="border-right: #4371a5 1px solid;
          ...
          <tr>
           ...
           <td style="padding-left: 20px; text-align: left">
            <%--<CR:CrystalReportViewer ToolbarStyle-CssClass="FixedHeaderPopUp" ID="CrystalReportViewer1" runat="server" DisplayGroupTree="False" />--%>
           </td>
          </tr>
         </table>
