<%@ Page Title="EMANAGER" Language="C#"  AutoEventWireup="true" CodeFile="AddEditVesselContract.aspx.cs" Inherits="Modules_Inspection_AddEditInspection" MasterPageFile="~/MasterPage.master" %>
                                ...
                                <table width="100%">
                                    <tr>
                                        ...
                                        <td width="20%" style="text-align:right;padding-right:10px;width:20%;">
                                             <div >
                                    <asp:LinkButton ID="btnBack" runat="server" Text="Back to Contract Search" style="color: red;font-family:Arial;font-size:14px;font-weight:bold;" OnClick="btnBack_Click" />
                                </div>
                                        </td>
                                    </tr>
                                </table>
...
<iframe runat="server" src="~/Modules/REVENUE/VesselContract.aspx" id="frm" frameborder="0" width="100%" height="600px" scrolling="no"></iframe>
</div>
