...
<body>
    ...
    <table width="100%">
        ...
        <div style='padding:5px; background:#4DB8FF; color:White; text-align:center; font-size:14px;'>Briefing</div>
          <table id="Table1" runat="server" width="100%" cellpadding="5" cellspacing ="0" border="0">
                ...
                <td style='text-align:left'>
                 ...
                 <td style="text-align:left" colspan="2">
                  ...
                  <tr>
                <td style='text-align:left'>
                    <asp:Label runat="server" ID="lblNotifiedon" Font-Size="12px" ForeColor="Green"></asp:Label>
                 </td>
                 <td style="text-align:left" colspan="2">
                     <asp:Label runat="server" ID="lblTakeOverOn" Font-Size="12px" ForeColor="gray"></asp:Label>
                 </td>
                </tr>
                <tr>
          ...
          <asp:Panel runat="server" ID="pnlBriefing" Visible="true" style="padding:5px;">
                 <table cellpadding="2" cellspacing="0" border="0" width="100%">
                    ...
                    <tr>
                        <td>
                            <asp:TextBox ID="txtBriefingRemarks" runat="server" Width="99%" TextMode="MultiLine" Height="180px" ></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
        ...
        <div style='padding:5px; background:#4DB8FF; color:White; text-align:center; font-size:14px;'>Debriefing</div>
            <table id="Table2" runat="server" width="100%" cellpadding="5" cellspacing ="0" border="0">
                <tr>
                <td style='text-align:left'>
                    <asp:Label runat="server" ID="lblLocation1" Font-Size="12px" ForeColor="Green"></asp:Label> - 
                    <asp:Label runat="server" ID="lblPurpose1" Font-Size="12px" ForeColor="orange"></asp:Label>
                 </td>
                 <td style="text-align:left"><asp:Label runat="server" ID="lblPeriod1" Font-Size="12px" ForeColor="gray"></asp:Label> </td>
                 <td style="text-align:right">
                     <asp:Label runat="server" ID="lblHalfDay1" Font-Size="12px" ForeColor="purple"></asp:Label>
                 </td>
                </tr>
                 <tr>
                <td style='text-align:left'>
                    <asp:Label runat="server" ID="lblVesselName1" Font-Size="12px" ForeColor="Green"></asp:Label>
                 </td>
                 <td style="text-align:left" colspan="2">
                     <asp:Label runat="server" ID="lblPlannedInspections1" Font-Size="12px" ForeColor="gray"></asp:Label>
                 </td>
                </tr>
                  <tr>
                <td style='text-align:left'>
                    <asp:Label runat="server" ID="lblNotifiedon1" Font-Size="12px" ForeColor="Green"></asp:Label>
                 </td>
                 <td style="text-align:left" colspan="2">
                     <asp:Label runat="server" ID="lblTakeOverOn1" Font-Size="12px" ForeColor="gray"></asp:Label>
                 </td>
                </tr>
                <tr>
                <td style='text-align:left; background:#FFFFF0; border:solid 1px #eeeeee' colspan="3">
            ...
            <asp:Panel runat="server" ID="pnlDeBriefing" style="padding:5px;">
               <table cellpadding="2" cellspacing="0" border="0" width="100%">
                    <tr>
                        <td style="font-weight:bold; font-size:12px;"> De-Briefing remarks</td>
                    </tr>
                    <tr>
                        <td>
                            <asp:TextBox ID="txtDebriefingRemarks" runat="server" Width="100%" TextMode="MultiLine" Height="180px" ></asp:TextBox>
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align:center;" >
        ...
        <div style="padding:2px; ">
           ...
           <asp:Button ID="btnSaveBriefing" runat="server" Text=" Save " OnClick="btnSaveBriefing_OnClick" CssClass="btn" Width="80px" />
