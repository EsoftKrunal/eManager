<%@ Page Language="C#" AutoEventWireup="true" CodeFile="KPI_Result.aspx.cs" Inherits="emtm_kpi_result" EnableEventValidation="false" %>
                                        ...
                                        <div class="panel">
                                            ...
                                            <div class="content">
                                                ...
                                                <div class="margin1x" style="text-align:center;">
                                                    ...
                                                    <table style="font-size:14px;width:100%; margin-top:10px;cellpadding="6">
                                                        <tr>
                                                            <td style="text-align:right">Name : </td>
                                                            <td style="text-align:left"><asp:Label runat="server" ID="lblUserName" Font-Bold="true"></asp:Label></td>
                                                            <td style="text-align:right">Department : </td>
                                                            <td style="text-align:left"><asp:Label runat="server" ID="lblDepartment" Font-Bold="true"></asp:Label></td>
                                                 ...
                                                 <table width="98%" border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse; margin-left:30px;" class="bordered">
                                                    <thead>
                                                        ...
                                                        <th style="width:250px;text-align:left">Position</th>
                                                        <th style="width:250px;text-align:center">Vessel Assignment Period</th>                                                        
                                                    ...
                                                    <div style="height:250px; overflow-y:scroll;overflow-x:hidden" class="ScrollAutoReset" id="fsfafdfaf_01">
                                                  <table width="98%" border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse; margin-left:30px;" class="bordered">
                                                     <tbody>
                                                    ...
                                                    <ItemTemplate>
                                                     <tr>
                                                            <td>
                                                                <asp:LinkButton runat="server" ID="lnkVessel" OnClick="lnkVessel_Click" Text='<%#Eval("VesselName")%>' posid='<%#Eval("vpid")%>' vesselid='<%#Eval("vesselid")%>' CssClass='<%#Common.ToDateString(Eval("EffDate"))%>'></asp:LinkButton>
                                                            </td>
                                                            <td style="width:250px;"><%#Eval("PositionName")%></td>
                                                            <td style="width:250px;text-align:center"><%#Common.ToDateString(Eval("EffDate"))%> - <%#Common.ToDateString(Eval("LastDate"))%></td>
