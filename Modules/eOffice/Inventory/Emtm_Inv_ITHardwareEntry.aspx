<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Emtm_Inv_ITHardwareEntry.aspx.cs" Inherits="emtm_Inventory_Emtm_Inv_ITHardwareEntry" %>
                                ...
                                <table cellpadding="0" cellspacing="0" width="500px" >
                                    <tr>
                                        <td class="dottedscrollbox" style=" text-align :center; font-size :14px; background-color:#4371a5; color :White; padding :3px; font-weight: bold;">
                                           <asp:Label ID="lblPageHeader" Text="Add /Edit Items - [ IT -> Hardware ]" runat="server"></asp:Label>    
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <asp:UpdatePanel ID="up12" runat="server" >
                                                <ContentTemplate>                                                
                                                       <asp:Label ID="lblMsg" runat="server" ForeColor="Red" Text="sdf sadf af sdafsd"></asp:Label>
                                                </ContentTemplate>
                                            </asp:UpdatePanel>
                                        </td>
                                    </tr> 
                                        ...
                                        <td style="vertical-align:top; padding-top:5px;" >
                                            <table cellpadding="4" cellspacing="4" border="0" style="border-collapse: collapse;" width="800px;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: left">
                                                        <asp:TextBox ID="txtAssetCode" required="yes" MaxLength="50" runat="server"></asp:TextBox>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: left">
                                                        <asp:TextBox ID="txtVendorName" MaxLength="100" runat="server" Width="300px" ></asp:TextBox>
                                                 ...
                                                 <tr>   
                                                    ...
                                                    <td style="text-align: left">
                                                         <asp:TextBox ID="txtMaker" MaxLength="100" runat="server" Width="300px" ></asp:TextBox>
                                                         <ajaxToolkit:AutoCompleteExtender id="AutoCompleteExtender2" runat="server" TargetControlID="txtMaker" ServicePath="~/WebService.asmx" ServiceMethod="GetMakerHardware" MinimumPrefixLength="1" Enabled="True" DelimiterCharacters="" CompletionListCssClass="CList"  CompletionListItemCssClass="CListItem" CompletionListHighlightedItemCssClass="CListItemH"></ajaxToolkit:AutoCompleteExtender>
                                                    </td>
                                                 ...
                                                 <tr>   
                                                    ...
                                                    <td style="text-align: left">
                                                        <asp:TextBox ID="txtModelNo" MaxLength="50" runat="server"></asp:TextBox>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: left">
                                                        <asp:TextBox ID="txtSrNo" MaxLength="50" runat="server"></asp:TextBox>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: left">
                                                        <asp:TextBox ID="txtWarrentyExp" MaxLength="50" runat="server"></asp:TextBox>
                                                        ...
                                                        <ajaxToolkit:CalendarExtender ID="CalendarExtender3" runat="server" Format="dd-MMM-yyyy"
                                                                        PopupButtonID="ImageButton3" TargetControlID="txtWarrentyExp" PopupPosition="TopRight">
                                            ...
                                            <table cellpadding="4" cellspacing="4" border="0" style="border-collapse: collapse;" width="800px;">
                                                <tr>
                                                                ...
                                                                <td style="text-align: left">
                                                                    <asp:TextBox ID="txtPurchaseDt" MaxLength="12" runat="server" OnTextChanged="txtPrice_TextChanged" AutoPostBack="true"></asp:TextBox>
                                                                    <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl="~/Modules/HRD/Images/Calendar.gif"
                                                                        CausesValidation="false" />
                                                                    <ajaxToolkit:CalendarExtender ID="CalendarExtender1" runat="server" Format="dd-MMM-yyyy"
                                                                        PopupButtonID="ImageButton1" TargetControlID="txtPurchaseDt" PopupPosition="TopRight">
                                                                    </ajaxToolkit:CalendarExtender>
                                                                </td>
                                                                <td style="text-align: right;width :200px;">
                                                                    &nbsp;</td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="text-align: left">
                                                                    <asp:TextBox ID="txtPrice" runat="server" AutoPostBack="True" MaxLength="50" onkeypress="fncInputNumericValuesOnly(this)" OnTextChanged="txtPrice_TextChanged"></asp:TextBox>
                                                                </td>
                                                                <td style="text-align: right">
                                                                    &nbsp;</td>
                                                                <td style="text-align: left">
                                                            ...
                                                            <tr>
                                                                <td style="text-align: right">
                                                                    Dep. Value (As On Date) :&nbsp;
                                                                </td>
                                                                <td style="text-align: left">
                                                                    <asp:Label ID="txtDepVal" runat="server" MaxLength="50" ></asp:Label>
                                                                </td>
                                                                <td style="text-align: right">
                                                                    &nbsp;</td>
                                                                <td style="text-align: left">
                                                             ...
                                                             <tr>
                                                                ...
                                                                <td style="text-align: left">
                                                                    <asp:DropDownList ID="ddlOffice" runat="server" AutoPostBack="True" 
                                                                        onselectedindexchanged="ddlOffice_SelectedIndexChanged"></asp:DropDownList>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="text-align: left">
                                                                    <asp:TextBox ID="txtCreatedOn" MaxLength="12" runat="server"></asp:TextBox>
                                                                    <asp:ImageButton ID="ImageButton2" runat="server" ImageUrl="~/Modules/HRD/Images/Calendar.gif"
                                                                        CausesValidation="false" />
                                                                    <ajaxToolkit:CalendarExtender ID="CalendarExtender2" runat="server" Format="dd-MMM-yyyy"
                                                                        PopupButtonID="ImageButton2" TargetControlID="txtCreatedOn" PopupPosition="TopRight">
                                                                    </ajaxToolkit:CalendarExtender>
                                                                </td>
                                                                <td style="text-align: right">
                                                                    &nbsp;</td>
