<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Emtm_Inve_MinCategory.aspx.cs" Inherits="Emtm_Inve_MinCategory"%>
                                                    ...
                                                    <td colspan="2">
                                                       <div class="scrollbox" style="OVERFLOW-Y: scroll; OVERFLOW-X: hidden; WIDTH: 100%; HEIGHT: 26px ; text-align:center; border-bottom:none;"> 
                                                        <table cellpadding="2" cellspacing="1" width="100%" rules="all" height="26px">
                                                            <colgroup>
                                                                ...
                                                                <tr class="blueheader">
                                                                    ...
                                                                    <td style="text-align :left">Min Category</td>
                                                                    <td>&nbsp;
                                                                    </td>
                                                                </tr>
                                                            </colgroup>
                                                        ...
                                                        <div class="scrollbox" style="OVERFLOW-Y: scroll; OVERFLOW-X: hidden; WIDTH: 100%; HEIGHT: 270px; text-align:center;">
                                                            ...
                                                            <asp:Repeater ID="rptMinCategory" runat="server">
                                                                <ItemTemplate>
                                                                    <tr>
                                                                        <td>
                                                                            <asp:ImageButton ID="imgEdit" runat="server" 
                                                                                CommandArgument='<%# (Eval("MidCatId").ToString() + " : " + Eval("MinCatId").ToString()) %>' ImageUrl="~/Modules/HRD/Images/edit.jpg" 
                                                                                OnClick="imgEdit_OnClick" />
                                                                        </td>
                                                                        <td>
                                                                            <asp:ImageButton ID="imgDel" runat="server" 
                                                                                CommandArgument='<%#Eval("MinCatId")%>' ImageUrl="~/Modules/HRD/Images/delete.jpg" 
                                                                        ...
                                                                        <td align="left">  
                                                                        <asp:Label ID="lblMinCategory" runat="server" Text='<%#Eval("MinCatName")%>'></asp:Label>
                                                                        </td>
                                                                        <td>&nbsp;</td>
                                                                    </tr>
                                                                </ItemTemplate>
                                                ...
                                                <tr>
                                                    <td colspan="2">
                                                        <fieldset style="padding :10px;">
                                                            <legend style="color: Black; font-size: 12px; font-family: Arial;">Min Category</legend>
                                                            <div id="divAdd" runat="server" style="text-align: right; padding-right: 5px;">
                                                                <asp:Button ID="btnAdd" Text="Add Min Category" CssClass="btn" runat="server" Width="120px"
                                                                    OnClick="btnAdd_Click" />
                                                            </div>
                                                            <table id="tblAddEdit" visible="false" runat="server" cellpadding="0" cellspacing="0"
                                                                width="100%">
                                                                <tr>
                                                                    ...
                                                                    <td style="text-align: left">
                                                                        <asp:DropDownList ID="ddlMidCat" runat="server" required="yes" Width="250px">
                                                                        </asp:DropDownList>
                                                                    </td>
                                                                    <td style="text-align: right">
                                                                        Min Category :&nbsp;
                                                                    ...
                                                                    <td style="text-align: left">
                                                                        <asp:TextBox ID="txtMinCategory" runat="server" required="yes" Width="300px" MaxLength="50"></asp:TextBox>
                                                                    </td>
                                                                    <td align="right">
                                                                        <asp:Button ID="btnSave" runat="server" Text="Save" CssClass="btn" Width="60px" OnClick="btnSave_OnClick" />
                                                                        <asp:Button ID="btnCancel" runat="server" Text="Cancel" CssClass="btn" Width="60px"
