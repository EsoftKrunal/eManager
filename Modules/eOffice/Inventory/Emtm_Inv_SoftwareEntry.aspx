<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Emtm_Inv_SoftwareEntry.aspx.cs" Inherits="emtm_Inventory_Emtm_Inv_Software" %>
                                ...
                                <table cellpadding="0" cellspacing="0" width="500px" >
                                    <tr>
                                        <td class="dottedscrollbox" style=" text-align :center; font-size :14px; background-color:#4371a5; color :White; padding :3px; font-weight: bold;">
                                          <asp:Label ID="lblPageHeader" Text="Add /Edit Items - [ IT -> Software ]" runat="server"></asp:Label>
                                        </td>
                                    </tr>
                                    <tr><td>
                                        ...
                                        <td style="vertical-align:top; padding-top:5px;" >
                                            <table cellpadding="4" cellspacing="4" border="0" style="border-collapse: collapse;" width="800px;">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: left">
                                                        <asp:TextBox ID="txtDescr" required="yes" MaxLength="500" runat="server" Width="300px" ></asp:TextBox>
                                                    </td>
                                                ...
                                                <tr>
                                                 ...
                                                 <tr>   
                                                    ...
                                                    <td style="text-align: left">
                                                         <asp:TextBox ID="txtAuthNo" MaxLength="50" runat="server" ></asp:TextBox>
                                                    </td>
                                                 ...
                                                 <tr>   
                                                    ...
                                                    <td style="text-align: left">
                                                        <asp:TextBox ID="txtLicQty" MaxLength="15" onkeypress="fncInputNumericValuesOnly(this)" runat="server"></asp:TextBox>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: left">
                                                        <asp:TextBox ID="txtLicVal" MaxLength="12" runat="server"></asp:TextBox>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: left">
                                                        <asp:TextBox ID="txtLicVendor" MaxLength="500" Width="300" runat="server"></asp:TextBox>
                                                        <ajaxToolkit:AutoCompleteExtender id="AutoCompleteExtender1" runat="server" TargetControlID="txtLicVendor" ServicePath="~/WebService.asmx" ServiceMethod="GetVendorSoftware_license" MinimumPrefixLength="1" Enabled="True" DelimiterCharacters="" CompletionListCssClass="CList"  CompletionListItemCssClass="CListItem" CompletionListHighlightedItemCssClass="CListItemH"></ajaxToolkit:AutoCompleteExtender>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: left">
                                                        <asp:TextBox ID="txtLicPartner" MaxLength="500" Width="300" runat="server"></asp:TextBox>
                                                        <ajaxToolkit:AutoCompleteExtender id="AutoCompleteExtender2" runat="server" TargetControlID="txtLicPartner" ServicePath="~/WebService.asmx" ServiceMethod="GetVendorPartner" MinimumPrefixLength="1" Enabled="True" DelimiterCharacters="" CompletionListCssClass="CList"  CompletionListItemCssClass="CListItem" CompletionListHighlightedItemCssClass="CListItemH"></ajaxToolkit:AutoCompleteExtender>
                                                    </td>
