<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Profile_LeavesBetweenDateReport.aspx.cs" Inherits="emtm_MyProfile_Emtm_Profile_LeavesBetweenDateReport" %>
...
<body onclick="document.getElementById('btnprnt').style.display='';">
    ...
    <div>                   
                            <center> <h3>Leave Status as on [<asp:Label id="lblCurrentDate" runat="server"></asp:Label>] </h3></center>
                            <br />
