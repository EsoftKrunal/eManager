<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Profile_SeamanBook.aspx.cs" Inherits="Emtm_Profile_SeamanBook" EnableEventValidation="false" MasterPageFile="~/Modules/eOffice/MyProfile/MyProfile.master" %>
                               ...
                               <colgroup>
                                   ...
                                   <tr>
                                       ...
                                       <td style="text-align :right">
                                           Seaman Book# :</td>
                                       <td style="text-align :left">
                                           <asp:TextBox ID="txtSeamanBookNo" runat="server" MaxLength="100" required="yes"></asp:TextBox>
                                           <asp:RequiredFieldValidator ID="RfvPlaceofissue0" runat="server" 
                                               ControlToValidate="txtSeamanBookNo" ErrorMessage="*"></asp:RequiredFieldValidator>
                                       </td>
                                   </tr>
                                   <tr>
                                       <td style="text-align :right">
