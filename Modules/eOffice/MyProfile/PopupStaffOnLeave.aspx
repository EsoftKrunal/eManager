<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PopupStaffOnLeave.aspx.cs" Inherits="emtm_MyProfile_Emtm_PopupStaffOnLeave" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">   
    <title>Staffs on leave</title>
                ...
                <asp:UpdatePanel ID="UpdatePanel2"  runat="server" UpdateMode="Conditional">
                                ...
                                <div id="div1" runat="server">
                                       <%-- <table border="0" cellpadding="2" cellspacing="0" rules="all" style="width:100%;border-collapse:collapse;">
                                        ...
                                        <div id="div2" runat="server" class="scrollbox" style="OVERFLOW-Y: scroll; OVERFLOW-X: hidden; WIDTH: 100%; HEIGHT: 475px; text-align:center;">
                                        <table border="1" cellpadding="2" cellspacing="0" rules="all" style="width:100%;border-collapse:collapse;">
                                            <colgroup>
                                                <col style="width:170px;" />
                                                <col style="width:150px;" />
