<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PopUpLeaveApproval.aspx.cs" Inherits="emtm_Emtm_PopUpLeaveApproval" Async="true" %>
    ...
    <div>
            ...
            <td valign="top" style="border:solid 1px #4371a5; height:100px;">
                ...
                <!-- POPUP DIV -->
                        ...
                        <div style="position :relative; width:750px; height:230px; padding :10px; text-align :center; border :solid 1px #4371a5; background : white; z-index:150;top:30px;opacity:1;filter:alpha(opacity=100)">
                            ...
                            <div style="float:right; height:150px; width:500px; border:solid 1px #d2d2d2;text-align:right;padding:5px;">
                                ...
                                <asp:RequiredFieldValidator runat="server" ErrorMessage="*" ControlToValidate="TextBox1" ValidationGroup="vg"></asp:RequiredFieldValidator> 
                            </div>
                ...
                <table cellpadding="2" cellspacing ="0" border="0" width ="100%">
                            ...
                            <asp:Button ID="btnClose" runat="server" CssClass="btn" Text="Close" OnClientClick="CloseWindow();" CausesValidation="false"  ValidationGroup="vg" />  
                                 </td>
                            </tr>
                </table>  
            </td>
