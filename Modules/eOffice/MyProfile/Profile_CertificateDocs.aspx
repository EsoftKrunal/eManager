<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Profile_CertificateDocs.aspx.cs" Inherits="Emtm_Profile_CertificateDocs" EnableEventValidation="false" MasterPageFile="~/Modules/eOffice/MyProfile/MyProfile.master" %>
                    ...
                    <td valign="top" style="border:solid 1px #4371a5; height:500px;">
                        ...
                        <table border="1" cellpadding="2" cellspacing="0" rules="all" style="width:100%;border-collapse:collapse;">
                            ...
                            <asp:Repeater ID="RptTravelDoc" runat="server">
                                <ItemTemplate>
                                    <tr class='<%# (Common.CastAsInt32(Eval("CertificateDocId"))==SelectedId)?"selectedrow":"row"%>'>
                                        <td align="center">
                                            <asp:ImageButton ID="btndocView" runat="server" CausesValidation="false" 
                                                CommandArgument='<%# Eval("CertificateDocId") %>' ImageUrl="~/Modules/HRD/Images/HourGlass.gif" 
                                                OnClick="btndocView_Click" ToolTip="View" />
                                        </td>
                                        <td align="center">
                                            <asp:ImageButton ID="btndocedit" runat="server" CausesValidation="false" 
                                                CommandArgument='<%# Eval("CertificateDocId") %>' Visible="<%#auth.IsUpdate%>" ImageUrl="~/Modules/HRD/Images/edit.jpg" 
                                                OnClick="btndocedit_Click" ToolTip="Edit" />
                                        </td>
                                        <td align="center">
                                            <asp:ImageButton ID="btndocDelete" runat="server" CausesValidation="false" 
                                            CommandArgument='<%# Eval("CertificateDocId") %>' Visible="<%#auth.IsDelete%>" ImageUrl="~/Modules/HRD/Images/delete.jpg" 
                                            OnClientClick="javascript:return window.confirm('Are you sure to delete?');"  
                                            OnClick="btndocDelete_Click" ToolTip="Delete" />
                                         </td>
                                        <td align="left">
                                            <%#Eval("CertificateName")%></td>
                                        <td align="left">
                                            <%#Eval("CertificateNo")%></td>
                                        <td align="center">
                                            <%#Eval("IssueDate")%></td>
                                        <td align="center">
                                            <%#Eval("ExpiryDate")%></td>
                                        <td align="left">
                                            <a ID="ancFile" runat="server" 
                                                href='<%#"PopupAttachment.aspx?CertifctDocId=" + Eval("CertificateDocId").ToString() %>' 
                               ...
                               <colgroup>
                                   ...
                                   <tr>
                                       ...
                                       <td style="text-align :left">
                                           <asp:TextBox ID="txtCertificateName" runat="server" MaxLength="100" required="yes"></asp:TextBox>
                                           <asp:RequiredFieldValidator ID="RfvDocno0" runat="server" 
                                               ControlToValidate="txtCertificateName" ErrorMessage="*"></asp:RequiredFieldValidator>
                                       </td>
                                       <td style="text-align :right">
                                           Certificate# :</td>
                                       <td style="text-align :left">
                                           <asp:TextBox ID="txtCertificateNo" runat="server" MaxLength="25" required="yes"></asp:TextBox>
                                           <asp:RequiredFieldValidator ID="RfvPlaceofissue0" runat="server" 
                                               ControlToValidate="txtCertificateNo" ErrorMessage="*"></asp:RequiredFieldValidator>
                                       </td>
                                   </tr>
                                   <tr>
                                       <td style="text-align :right">
