<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Public_HOD_LeaveApproval.aspx.cs" Inherits="emtm_MyProfile_Public_HOD_LeaveApproval" %>
...
<body>
    ...
    <div>
     <div style='padding:10px; background:#4DB8FF; color:White; text-align:center; font-size:18px;'>OK To Board Request</div>
        ...
        <table width="100%" cellspacing ="0" cellpadding="5" border="0">
            <tr>
                <td style="text-align:left; " valign="top">
                    ...
                    <asp:TextBox ID="txtAppRejRemarks" runat="server" TextMode="MultiLine" Height="150px" Width="100%"></asp:TextBox> 
                </td>
            </tr>
        </table> 
