<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CB_Details.aspx.cs" Inherits="emtm_MyProfile_Emtm_CB_Details" MasterPageFile="~/Modules/eOffice/MyProfile/MyProfile.master" %>
     ...
     <link rel="stylesheet" type="text/css" href="../../HRD/Styles/StyleSheet.css" />
        ...
        <%--<div style="padding:6px; font-size:20px; text-align:center">
             <asp:Button ID="btnUpdateRevisionPopup" runat="server" Text="Edit Revision" CssClass="btn" OnClick="btnUpdateRevisionPopup_OnClick" Visible="false" />
                ...
                <td valign="top">
                    <div style="padding:6px; font-size:20px; background-color:#37afeb"">Pay Slip</div>
                    <div style="padding:6px; font-size:20px;text-align:right;padding-right:20px;">
                        <asp:DropDownList ID="ddlYear_Payslip" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlYear_Payslip_OnSelectedIndexChanged" Width="100px"></asp:DropDownList>
                    </div>
                                        ...
                                        <tr>
                                            <td align="center">
                                              <asp:ImageButton ID="btnPrint" runat="server" ImageUrl="~/Modules/HRD/Images/print_16.png" ToolTip="Print" OnClick="btnPrint_OnClick" />
                                                <asp:HiddenField ID="hfOfficeID" runat="server" Value='<%#Eval("Office")%>' />
                                                <asp:HiddenField ID="hfsal_month" runat="server" Value='<%#Eval("sal_month")%>' />
                                                
                                            </td>
                                            <td align="left">
                                                <%#Common.ToDateString(Eval("SalaryDate")).Substring(3)%></td>
                                            <td align="right">
                                                <%#Eval("TotalEncome")%></td>
                                            <td align="right">
                                                <%#Eval("TotalDeduction")%></td>
                                            <td align="right"><%#Eval("NetAmount")%></td>
                                            <td align="right"><%# Common.CastAsDecimal(Eval("GrossAmount"))%></td>
