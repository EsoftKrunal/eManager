<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Profile_VisaDocs.aspx.cs" Inherits="Emtm_Profile_VisaDocs" EnableEventValidation="false" MasterPageFile="~/Modules/eOffice/MyProfile/MyProfile.master" %>
             ...
             <table width="100%">
                <tr>
                    ...
                    <td valign="top" style="border:solid 1px #4371a5; height:500px;">
                        ...
                        <div class="dottedscrollbox">
                            <uc2:Profile_TravelDocumentHeader ID="Emtm_Profile_TravelDocumentHeader1" runat="server" />
                        </div> 
                        ...
                        <table border="1" cellpadding="2" cellspacing="0" rules="all" style="width:100%;border-collapse:collapse;">
                            ...
                            <asp:Repeater ID="RptTravelVisa" runat="server">
                                <ItemTemplate>
                               ...
                               <colgroup>
                                   ...
                                   <tr>
                                       ...
                                       <td style="text-align :left">
                                           <asp:DropDownList ID="ddlcountry" runat="server" required="yes"></asp:DropDownList> 
                                       ...
                                       <td style="text-align :right">
                                           VisaType:</td>
                                       <td style="text-align :left">
                                           <asp:TextBox ID="txtVisaType" runat="server" MaxLength="15" required="yes"></asp:TextBox>
                                           <asp:RequiredFieldValidator ID="RfvVisaType" runat="server" 
                                               ControlToValidate="txtVisaType" ErrorMessage="*"></asp:RequiredFieldValidator>
                                       </td>
                                   </tr>
                                   <tr>
                                       <td style="text-align :right">
                                   ...
                                   <tr>
                                       <td style="text-align :right">
                                           Visa # :</td>
                                       <td style="text-align :left">
                                           <asp:TextBox ID="txtVisano" runat="server" MaxLength="15" required="yes"></asp:TextBox>
                                           <asp:RequiredFieldValidator ID="RfvDocno0" runat="server" 
                                               ControlToValidate="txtVisano" ErrorMessage="*"></asp:RequiredFieldValidator>
                                       </td>
                                       <td style="text-align :right">
                                           Place of Issue :</td>
                                       <td style="text-align :left">
                                           <asp:TextBox ID="txtPlaceofissue" runat="server" MaxLength="100" required="yes"></asp:TextBox>
                                           <asp:RequiredFieldValidator ID="RfvPlaceofissue" runat="server" 
