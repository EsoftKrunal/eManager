<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Profile_LeaveHistory.aspx.cs" Inherits="emtm_MyProfile_Emtm_Profile_LeaveHistory" %>
...
<head runat="server">
    ...
    <script type="text/javascript" >
        ...
        function PopUPLeaveStatusPrintWindow(CurrentYear, EmpId) {
            winref = window.open('../StaffAdmin/Emtm_HR_LeaveStatusOnDateReport.aspx?CurrentYear=' + CurrentYear + '&EmpId=' + EmpId, '', 'title=no,toolbars=no,scrollbars=yes,left=150,top=150,addressbar=no,resizable=1,status=0');
            return false;
        }
    </script>
</head>
                    ...
                    <td valign="top" style="border:solid 1px #4371a5; height:500px;">
                        ...
                        <tr>
                            ...
                            <asp:Button ID="btnback1" runat="server" CausesValidation="false" 
                                         CssClass="btn" Text="Close" Width="50px" OnClientClick="javascript:window.close();"/>
                            </td>
                        </tr>
                        </table>
                        </div>
                        <div class="dottedscrollbox">
                         ...
                         <div>
                            <table id="Table1" runat="server" visible="false" width="100%" cellpadding="5" cellspacing ="0" border="0">
                                <tr class="differRow">
                        ...
                        <table border="0" cellpadding="2" cellspacing="0" width="100%">
                             <tr>
                                 <td align="right">
                                     ...
                                     <asp:Button ID="btnBack" runat="server" CausesValidation="false"  OnClientClick="javascript:window.close();" 
                                         CssClass="btn" Text="Close" Width="70px"/>
                                 </td>
                             </tr>
                         </table> 
                            </div>
