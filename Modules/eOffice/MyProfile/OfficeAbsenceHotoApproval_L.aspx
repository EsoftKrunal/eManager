<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OfficeAbsenceHotoApproval_L.aspx.cs" Inherits="Emtm_OfficeAbsenceHotoApproval_L" %>
...
<body>
    ...
    <table width="100%">
        ...
        <tr>
            ...
            <td><asp:Label ID="lblPeriod" runat="server"></asp:Label>
            </td>
