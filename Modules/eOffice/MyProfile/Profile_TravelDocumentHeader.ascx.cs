...
public partial class Emtm_Profile_TravelDocumentHeader : System.Web.UI.UserControl
{
    ...
    public void RedirectToPage()
    {
        switch (Common.CastAsInt32(Session["CurrentPage"]))
        {
            case 1:
                btntraveldoc.ImageUrl = btntraveldoc.ImageUrl.Replace("_g", "_b");
                Response.Redirect("Profile_TravelDocs.aspx?var=xxx");
                break;
            case 2:
                btntravelvisa.ImageUrl = btntravelvisa.ImageUrl.Replace("_g", "_b");
                Response.Redirect("Profile_VisaDocs.aspx");
                break;
            case 3:
                btntravelseaman.ImageUrl = btntravelseaman.ImageUrl.Replace("_g", "_b");
                Response.Redirect("Profile_SeamanBook.aspx");
                break;
            case 4:
                btnFinNric.ImageUrl = btnFinNric.ImageUrl.Replace("_g", "_b");
                Response.Redirect("Profile_FinNricDetails.aspx");
                break;
            default:
                break;
        }
