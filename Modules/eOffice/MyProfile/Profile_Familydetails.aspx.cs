...
public partial class Emtm_Profile_Familydetails : System.Web.UI.Page
{
    ...
    protected void BindGrid()
    {
        ...
        if (EmpId > 0)
        {
            ...
            "case when a.gender='M' then 'Male' else 'Female' end as gender, b.RelationName " +
        ...
        if (EmpId > 0)
        {
            ...
            if (dt != null)
                if (dt.Rows.Count > 0)
                {
                    ...
                    imgbtnPassport.Visible = dr["PstFileName"].ToString().Trim()!="";   
                    ...
                    imgbtnFin.Visible = dr["FinFileName"].ToString().Trim() != "";   
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        int chpageauth = UserPageRelation.CheckUserPageAuthority(Convert.ToInt32(Session["loginid"].ToString()), 257);
        if (chpageauth <= 0)
        {
            Response.Redirect("../AuthorityError.aspx");
        }
        //*******************
        auth = new AuthenticationManager(257, Common.CastAsInt32(Session["loginid"]), ObjectType.Page);
