<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Profile_MedicalCertificateDocs.aspx.cs" Inherits="Emtm_Profile_MedicalCertificateDocs" EnableEventValidation="false" MasterPageFile="~/Modules/eOffice/MyProfile/MyProfile.master" %>
                    ...
                    <td valign="top" style="border:solid 1px #4371a5; height:500px;">
                        ...
                        <table border="1" cellpadding="2" cellspacing="0" rules="all" style="width:100%;border-collapse:collapse;">
                            ...
                            <asp:Repeater ID="RptMedicalDoc" runat="server">
                                <ItemTemplate>
                                    <tr class='<%# (Common.CastAsInt32(Eval("MedicalDocId"))==SelectedId)?"selectedrow":"row"%>'>
                                        <td align="center">
                                            <asp:ImageButton ID="btndocView" runat="server" CausesValidation="false" 
                                                CommandArgument='<%# Eval("MedicalDocId") %>' ImageUrl="~/Modules/HRD/Images/HourGlass.gif" 
                                                OnClick="btndocView_Click" ToolTip="View" />
                                        </td>
                                        <td align="center">
                                            <asp:ImageButton ID="btndocedit" runat="server" CausesValidation="false" 
                                                CommandArgument='<%# Eval("MedicalDocId") %>' Visible="<%#auth.IsUpdate%>" ImageUrl="~/Modules/HRD/Images/edit.jpg" 
                                                OnClick="btndocedit_Click" ToolTip="Edit" />
                                        </td>
                                        <td align="center">
                                            <asp:ImageButton ID="btndocDelete" runat="server" CausesValidation="false" 
                                            CommandArgument='<%# Eval("MedicalDocId") %>' Visible="<%#auth.IsDelete%>" ImageUrl="~/Modules/HRD/Images/delete.jpg" 
                                        ...
                                        <td align="left">
                                            <a ID="ancFile" runat="server" 
                                                href='<%#"PopupAttachment.aspx?MedicalDocId=" + Eval("MedicalDocId").ToString() %>' 
                               ...
                               <colgroup>
                                   ...
                                   <tr>
                                       ...
                                       <td style="text-align :left">
                                           ...
                                           <asp:RequiredFieldValidator ID="RfvDocName" runat="server" 
                                               ControlToValidate="ddlMedicalDocName" ErrorMessage="*"></asp:RequiredFieldValidator>
                                               
                                           </td>
                                       <td style="text-align :right">
                                           Document # :</td>
                                       <td style="text-align :left">
                                           <asp:TextBox ID="txtDocumentNo" runat="server" MaxLength="30" required="yes"></asp:TextBox>
                                   ...
                                   <tr>
                                       <td style="text-align :right">
                                           Place Of Issue :</td>
                                       <td style="text-align :left">
                                           <asp:TextBox ID="txtPlaceOfIssue" runat="server" MaxLength="100"></asp:TextBox>
                                       </td>
                                       <td style="text-align :right">
                                           Attach Document :</td>
                                       <td>
