<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Hr_HolidayMaster.aspx.cs" Inherits="emtm_StaffAdmin_Emtm_Hr_HolidayMaster" MasterPageFile="~/Modules/eOffice/StaffAdmin/StaffAdmin.master"  %>
...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
    ...
    <script language="javascript" type="text/ecmascript">
        ...
        {
            winref = window.open('../StaffAdmin/PopupHolidayMaster.aspx?HolidayId=' + obj.getAttribute("RowId") + ' &Mode=' + Mode ,'', 'title=no,toolbars=no,scrollbars=yes,width=720,height=230,left=250,top=150,addressbar=no,resizable=1,status=0');
            return false;
        }
        //-----------------------
        function PopUPWindowAdd(obj, Mode, Office ,Year)
        {
            winref = window.open('../StaffAdmin/PopupHolidayMaster.aspx?HolidayId=0&Mode=' + Mode + ' &Office=' + Office + ' &Year=' + Year, '', 'title=no,toolbars=no,scrollbars=yes,width=720,height=230,left=250,top=150,addressbar=no,resizable=1,status=0');
            return false;
        }
        //-----------------------
    </script>
                ...
                <td valign="top" style="border:solid 1px #4371a5; height:500px;">
                    ...
                    <table border="1" cellpadding="2" cellspacing="0" rules="all" style="width:100%;border-collapse:collapse;">
                        ...
                        <asp:Repeater ID="rptHolidayMaster" runat="server"> 
                            <ItemTemplate>
                                <tr class='<%# (Common.CastAsInt32(Eval("HolidayId"))==SelectedId)?"selectedrow":"row"%>'>
                                    <td align="center">
                                        <asp:ImageButton ID="btnView" runat="server" CausesValidation="false"  
                                            ...
                                            RowId='<%# Eval("HolidayId") %>' ToolTip="View" />
                                    </td>
                                    <td align="center">
                                    ...
                                    <td align="center">
                                            ...
                                            CommandArgument='<%# Eval("HolidayId") %>' ImageUrl="~/Modules/HRD/Images/delete.jpg" 
