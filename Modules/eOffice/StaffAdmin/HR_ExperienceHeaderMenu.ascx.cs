...
public partial class StaffAdmin_HR_ExperienceHeaderMenu : System.Web.UI.UserControl
{
    ...
    public void RedirectToPage()
    {
        switch (Common.CastAsInt32(Session["CurrentPage"]))
        {
            case 1:
                btnshoreexp.ImageUrl = btnshoreexp.ImageUrl.Replace("_g", "_b");
                Response.Redirect("HR_Experiance.aspx");
                break;
            case 2:
                btnvesselexp.ImageUrl = btnvesselexp.ImageUrl.Replace("_g", "_b");
                Response.Redirect("HR_ShipExperience.aspx");
                break;
            default:
                break;
        }
