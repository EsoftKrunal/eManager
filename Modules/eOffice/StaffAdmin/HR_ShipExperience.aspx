<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HR_ShipExperience.aspx.cs" Inherits="emtm_Emtm_TravelDocs" EnableEventValidation="false" %>


<%--<%@ Register src="Emtm_HR_TravelDocumentHeader.ascx" tagname="Emtm_HR_TravelDocumentHeader" tagprefix="uc2" %>
<%@ Register src="Emtm_HR_TravelDocument.ascx" tagname="Emtm_HR_TravelDocument" tagprefix="uc3" %>
<%@ Register src="Emtm_HR_ExperienceHeaderMenu.ascx" tagname="Emtm_HR_ExperienceHeaderMenu" tagprefix="uc4" %>--%>
<%@ Register src="HR_PersonalHeaderMenu.ascx" tagname="HR_PersonalHeaderMenu" tagprefix="uc5" %>


<%@ Register src="HR_ExperienceHeaderMenu.ascx" tagname="Profile_ExperienceHeaderMenu" tagprefix="uc4" %>
<%--<%@ Register src="~/emtm/MyProfile/Emtm_Profile_PersonalHeaderMenu.ascx" tagname="Emtm_HR_PersonalHeaderMenu" tagprefix="uc5" %>--%>

<%--<%@ Register src="~/emtm/MyProfile/Emtm_Profile_ExperienceHeaderMenu.ascx" tagname="Emtm_Profile_ExperienceHeaderMenu" tagprefix="uc4" %>
<%@ Register src="Emtm_HR_PersonalHeaderMenu.ascx" tagname="Emtm_Profile_PersonalHeaderMenu" tagprefix="uc5" %>--%>
                ...
                <tr>
                    ...
                    <td valign="top" style="border:solid 1px #4371a5; height:500px;">
                        <div class="dottedscrollbox" style=" text-align :left; font-size :14px; background-color:#4371a5; color :White; padding :3px; font-weight: bold;">
                            ...
                            <uc5:HR_PersonalHeaderMenu ID="Emtm_Profile_PersonalHeaderMenu1" 
                                runat="server" />
