...
public partial class emtm_Emtm_HR_TravelDocument : System.Web.UI.UserControl
{
    ...
    public void RefreshMenu()
    {
        ...
        switch (Common.CastAsInt32(Session["CurrentModule"]))
        {
            ...
            case 3:
                ...
                break;
            case 4:
                btnOtherDocuments.ImageUrl = btnOtherDocuments.ImageUrl.Replace("_g", "_b");
                break;
            default:
                break;
        }
    ...
    public void RedirectToPage()
    {
        switch (Common.CastAsInt32(Session["CurrentModule"]))
        {
            ...
            case 4:
                btnOtherDocuments.ImageUrl = btnOtherDocuments.ImageUrl.Replace("_g", "_b");
                Response.Redirect("Emtm_HR_OtherDocs.aspx");
                break;
            default:
                break;
        }
