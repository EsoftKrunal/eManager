<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HR_FinNricDetails.aspx.cs" Inherits="emtm_Emtm_TravelDocs" EnableEventValidation="false" %>
             ...
             <table width="100%">
                <tr>
                    ...
                    <td valign="top" style="border:solid 1px #4371a5; height:500px;">
                        ...
                        <div id="divTraveldoc" runat="server" class="scrollbox" style="OVERFLOW-Y: scroll; OVERFLOW-X: hidden; WIDTH: 100%; HEIGHT: 365px; text-align:center;">
                                       ...
                                       { %>
                                        ...
                                        <td align="left">
                                            <a ID="ancFile" runat="server" 
                                                href='<%#"PopupAttachment.aspx?FinNricDocID=" + Eval("FinNricId").ToString() %>' 
                               ...
                               <colgroup>
                                   ...
                                   <tr>
                                        ...
                                        <td style="text-align :right">
                                            Attach Document :</td>
                                        <td style="text-align :left">
                                            <asp:FileUpload ID="flFinNricdocument" runat="server" Width="215px" />
                                        </td>
                                   </tr>
                                   <tr>
                                       <td valign="top">
