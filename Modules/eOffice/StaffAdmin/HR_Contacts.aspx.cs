...
public partial class emtm_Emtm_Contacts : System.Web.UI.Page
{
    ...
    #region Events
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            int chpageauth = UserPageRelation.CheckUserPageAuthority(Convert.ToInt32(Session["loginid"].ToString()), 246);
            if (chpageauth <= 0)
            {
                Response.Redirect("../AuthorityError.aspx");
            }
            //*******************
            auth = new AuthenticationManager(246, Common.CastAsInt32(Session["loginid"]), ObjectType.Page);
        ...
        protected void btnsave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Common.Set_Parameters(new MyParameter("@ContactId", SelectedId),
                                       ...
                                       new MyParameter("@pmt_EmpId", Session["EmpId"]),
