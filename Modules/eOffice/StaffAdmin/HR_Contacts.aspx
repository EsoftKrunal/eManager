<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HR_Contacts.aspx.cs" Inherits="emtm_Emtm_Contacts" %>
                             ...
                             <table  width="100%" cellpadding="2" cellspacing ="0" border="0">
                                 <tr>
                                     ...
                                     <td valign="top" >
                                         ...
                                         <asp:Button ID="brncancel" CssClass="btn"  runat="server" Text="Cancel" PostBackUrl="~/emtm/StaffAdmin/HR_Contacts.aspx" CausesValidation="false"></asp:Button>
                                         </div>
                                     </td>
                                 </tr>
                             </table>
