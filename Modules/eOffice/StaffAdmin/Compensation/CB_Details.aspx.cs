...
public partial class emtm_StaffAdmin_Emtm_CB_Details : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            if (Session["SelectedEmpID_CB"] != null)
                EmpID = Common.CastAsInt32(Session["SelectedEmpID_CB"]);
            else
                return;
    ...
    protected void btnSaveRevisedSalary_Click(object sender, EventArgs e)
    {
        int RevisionID = 0;
        //Data validation
        DataTable DtRevisionDate = Common.Execute_Procedures_Select_ByQueryCMS("select * from EMTM_CB_Master where EmpID="+EmpID.ToString()+ " and RevisionDate>='15-" + ddlMonth.SelectedItem.Text + "-" + ddlYear.SelectedValue + "'  ");
    ...
    protected void BindEmployeeHeadValue()
    {
        ...
        if (tmprevid > 0)
        {
            ...
            DataTable dt12 = Common.Execute_Procedures_Select_ByQueryCMS("SELECT TOP 1 REVISIONdate FROM EMTM_CB_Master WHERE EMPID = " + EmpID + " and REVISIONID=" + tmprevid);
