<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PoCommitmentReport.aspx.cs" Inherits="PoCommitmentReportReport"  %>
    ...
    <div style="font-family:Arial;font-size:12px;">
        ...
        <tr>
            <td>
               ...
               <%-- <tr>
                   <td class="text headerband" style=" padding:4px;"  colspan="5" >PO Commitment Report</td>
                </tr>--%>
                <tr>
                    <td>
                            ...
                            <col /></colgroup>
                                ...
                                <tr style="text-align:center;">
                                    ...
                                    <td style="text-align:right;">
                                        <%--<img src="../Images/showreport.jpg" onclick="ShowVARReport()" />--%>
                                        <asp:Button ID="imgPrint" runat="server" Text="Show Report" CssClass="btn"  onclick="imgPrint_Click" />
                                    </td>
