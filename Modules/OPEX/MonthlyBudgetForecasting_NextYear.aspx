<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MonthlyBudgetForecasting_NextYear.aspx.cs" Inherits="MonthlyBudgetForecasting_NextYear" %>
...
<body>
    ...
    <div style ="height:520px;width:350px; z-index : 50; filter: alpha(opacity = 50);position : absolute; top:0px;left:0px;background-color:#C2C2C2" runat="server" id="dbAskMonth" visible="false" >
    ...
    <tr class="text headerband">
        <td style="padding:5px;font-size:16px;font-weight:bold;">
              Budget Forecast -  <asp:Label ID="lblfyear" runat="server" ></asp:Label>
    ...
    <td>
       ...
       <tr>
            ...
            <td><asp:TextBox ID="txtMonth1" runat="server" Width="120px" MaxLength="20" style="text-align:right;" AutoPostBack="true" OnTextChanged="Amount_OnTextChanged" onkeypress="fncInputNumericValuesOnly(event)" ></asp:TextBox></td>
       </tr>
       <tr>    
            ...
            <td><asp:TextBox ID="txtMonth2" runat="server" Width="120px" MaxLength="20" style="text-align:right;" AutoPostBack="true" OnTextChanged="Amount_OnTextChanged" onkeypress="fncInputNumericValuesOnly(event)"></asp:TextBox></td>
       </tr>
       <tr> 
            ...
            <td><asp:TextBox ID="txtMonth3" runat="server" Width="120px" MaxLength="20" style="text-align:right;" AutoPostBack="true" OnTextChanged="Amount_OnTextChanged" onkeypress="fncInputNumericValuesOnly(event)" ></asp:TextBox></td>
       </tr>
       <tr>   
            ...
            <td><asp:TextBox ID="txtMonth4" runat="server" Width="120px" MaxLength="20" style="text-align:right;" AutoPostBack="true" OnTextChanged="Amount_OnTextChanged" onkeypress="fncInputNumericValuesOnly(event)" ></asp:TextBox></td>
       </tr>
       <tr>
            
            <td>
                <asp:Label ID="lblMonth5"  runat="server"></asp:Label>
            </td>
            <td><asp:TextBox ID="txtMonth5" runat="server" Width="120px" MaxLength="20" style="text-align:right;" AutoPostBack="true" OnTextChanged="Amount_OnTextChanged" onkeypress="fncInputNumericValuesOnly(event)" ></asp:TextBox></td>
       </tr>
       <tr>
            
            <td>
                <asp:Label ID="lblMonth6"  runat="server"></asp:Label>
            </td>
            <td><asp:TextBox ID="txtMonth6" runat="server" Width="120px" MaxLength="20" style="text-align:right;" AutoPostBack="true" OnTextChanged="Amount_OnTextChanged" onkeypress="fncInputNumericValuesOnly(event)" ></asp:TextBox></td>
        </tr>
        <tr>
            
            <td>
                <asp:Label ID="lblMonth7"  runat="server"></asp:Label>
            </td>
            <td><asp:TextBox ID="txtMonth7" runat="server" Width="120px" MaxLength="20" style="text-align:right;" AutoPostBack="true" OnTextChanged="Amount_OnTextChanged" onkeypress="fncInputNumericValuesOnly(event)" ></asp:TextBox></td>
       </tr>
       <tr>
            
            <td>
                <asp:Label ID="lblMonth8"  runat="server"></asp:Label>
            </td>
            <td><asp:TextBox ID="txtMonth8" runat="server" Width="120px" MaxLength="20" style="text-align:right;" AutoPostBack="true" OnTextChanged="Amount_OnTextChanged" onkeypress="fncInputNumericValuesOnly(event)" ></asp:TextBox></td>
       </tr>
       <tr>
            
            <td>
                <asp:Label ID="lblMonth9"  runat="server"></asp:Label>
            </td>
            <td><asp:TextBox ID="txtMonth9" runat="server" Width="120px" MaxLength="20" style="text-align:right;" AutoPostBack="true" OnTextChanged="Amount_OnTextChanged" onkeypress="fncInputNumericValuesOnly(event)" ></asp:TextBox></td>
       </tr>
       <tr>
           
            <td>
                <asp:Label ID="lblMonth10"  runat="server"></asp:Label>
            </td>
            <td><asp:TextBox ID="txtMonth10" runat="server" Width="120px" MaxLength="20" style="text-align:right;" AutoPostBack="true" OnTextChanged="Amount_OnTextChanged" onkeypress="fncInputNumericValuesOnly(event)"  ></asp:TextBox></td>
       </tr>
       <tr>
           
            <td>
               <asp:Label ID="lblMonth11"  runat="server"></asp:Label>
            </td>
            <td><asp:TextBox ID="txtMonth11" runat="server" Width="120px" MaxLength="20" style="text-align:right;" AutoPostBack="true" OnTextChanged="Amount_OnTextChanged" onkeypress="fncInputNumericValuesOnly(event)" ></asp:TextBox></td>
       </tr>
       <tr>
            
            <td>    
                <asp:Label ID="lblMonth12"  runat="server"></asp:Label>
            </td>
            <td><asp:TextBox ID="txtMonth12" runat="server" Width="120px" MaxLength="20" style="text-align:right;" AutoPostBack="true" OnTextChanged="Amount_OnTextChanged" onkeypress="fncInputNumericValuesOnly(event)" ></asp:TextBox></td>
        </tr>
                   ...
                   <div style="font-size:13px;font-weight:bold;background-color:#bdf9fb;color:#272323;padding:4px; height:25px;">
                     <asp:UpdatePanel ID="upControls" runat="server">
                       ...
                       <div style="margin:0px;padding:0px;float:left;"> 
                           <asp:ImageButton ID="btnExportTaskPopup" runat="server"  ToolTip="Import Budget Distribution" OnClick="btnExportTaskPopup_OnClick" ImageUrl="~/Modules/HRD/Images/export.png"  OnClientClick="return confirm('This will delete the existing records.Are you sure to import?');"/>
                           &nbsp;
            ...
            <center>
                <div style="font-size:15px;font-weight:bold;padding:4px;" class="header">
                    ...
                    <asp:ImageButton ID="btnCloseAddTrackingTaskPopup" runat="server" OnClick="btnCloseAddTrackingTaskPopup_OnClick"  ImageUrl="~/Modules/HRD/Images/Close.gif" style="float:right;"/>
                           <table cellpadding="5" cellspacing="0" width="100%" border="0" style="border-collapse:collapse; text-align:left; border-collapse:collapse;">
                               <colgroup>
                                   ...
                                   <tr>
                                       <td>
                                           <asp:DropDownList ID="ddlTaskType" runat="server" AutoPostBack="true" Enabled="false" OnSelectedIndexChanged="ddlTaskType_OnSelectedIndexChanged">
                                               <asp:ListItem Text="Select" Value=""></asp:ListItem>
                                               <asp:ListItem Selected="True" Text="Budgeted" Value="1"></asp:ListItem>
                                               <asp:ListItem Text="Unbudgeted" Value="2"></asp:ListItem>
                                           </asp:DropDownList>
                                       </td>
                                   </tr>
                                   <tr>
                                       <td><b>Allocation Description :</b> </td>
                                   </tr>
                                   <tr>
                                       <td>
                                           <asp:TextBox ID="txtTtDescription" runat="server" Height="70px" TextMode="MultiLine" Width="99%"></asp:TextBox>
                                       </td>
                                   </tr>
                                   <tr>
                                       <td><b>Budget Amount :</b><br /> </td>
                                   </tr>
                                   <tr>
                                       <td>
                    ...
                    <div style="text-align:center;padding:5px;">
                        <asp:Button ID="btnSaveTrackingTask" runat="server" Text="Save" OnClick="btnSaveTrackingTask_OnClick" />
                    </div>
                    <div style="text-align:center;padding:5px;">
                                ...
                                <center>
                                    ...
                                    <table cellpadding="5" cellspacing="5" border="0" width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:Button ID="btnExport" runat="server"  Text="Import" OnClick="btnExport_OnClick" CssClass="btn"/>
                                            </td>
                                        </tr>
                                        <tr>
