<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UpdateBudget_CY.aspx.cs" Inherits="UpdateBudget_CY" %>
...
//row.setAttribute("className", row.getAttribute("oldclassName"));
    ...
    <script type="text/javascript" >
        ...
        function ViewPrintRPT() 
        {
            ...
            var EndDate = document.getElementById('txtEndDate').value;
            var YearDays = document.getElementById('lblDays').innerText;
            var CurrFinancialYr = document.getElementById('hdnCurrFinYr').value;
            var PreFinancialYr = document.getElementById('hdnPreFinYr').value;
            var Total = document.getElementById('lblTotal').value;
            window.open("Print.aspx?CYBudget=true&Comp=" + Co + "&Vessel=" + Vess + "&BType=" + BType + "&StartDate=" + StartDate + "&EndDate=" + EndDate + "&year=" + year + "&YearDays=" + YearDays + "&MajCatID=" + MajCatID + "&CurrFinYr=" + CurrFinancialYr + "&PreFinYr=" + PreFinancialYr + "", "", "");  //height=490,width=350,
        }
    </script>
</head>
<body>
    <form id="form1" runat="server">
        ...
        <tr>
            ...
            <asp:HiddenField ID="hdnCurrFinYr" runat="server" Value=""  />
            <asp:HiddenField ID="hdnPreFinYr" runat="server" Value=""  />
                <table cellpadding="1" cellspacing="0" width="100%" border="0" style="border-collapse:collapse;font-family:Arial;font-size:12px;">
                <tr>
                      <td>
                        <table cellpadding="4" cellspacing="0" width="100%" border="1" style="border-collapse:collapse;font-family:Arial;font-size:12px;" >
                            <col  width="260px"/>
                            <col  width="260px"/>
                            <col  width="90px"/>
                            <col  width="90px"/>
                            ...
                            <tr style="text-align:center;background-color:#F5FAFF;">
                                ...
                                <td>
                                    <asp:DropDownList ID="ddlMidCategory" runat="server" Width="150px"  AutoPostBack="true" OnSelectedIndexChanged="ddlMidCategory_SelectedIndexChanged"     ></asp:DropDownList>
                                </td>
                            </tr>
                        </table> 
                      </td>
                ...
                <tr>
                    <td style="padding:2px; ">
                     ...
                     <div style="height:25px; overflow-y:scroll;overflow-x:hidden;">
                      <table cellpadding="0" cellspacing="0" width='100%'  border='1' style='border-collapse:collapse; height:25px;font-family:Arial;font-size:12px;' bordercolor="white">
                    <thead>
                            <tr class= "headerstylegrid">
                                ...
                                <td style="vertical-align:middle;width:120px;" >CFY Amt(US$)</td>
                                <%--<td style="vertical-align:middle;" >Comments</td>--%>
                            </tr>
                            </thead>
                            </table>
                     </div> 
                        <div id="dvscroll_BF" class='ScrollAutoReset'  style="HEIGHT: 260px;">
                                ...
                                <ItemTemplate>
                                    <tr onmouseover="">
                                        ...
                                        <td style="text-align:left;vertical-align:middle;" valign ="middle">
                                            &nbsp;<%#Eval("AccountName1")%><asp:HiddenField ID="hfAccID" runat="server" Value='<%#Eval("AcctID")%>' />
                ...
                <asp:UpdatePanel  runat="server" ID="up1" >
                        <ContentTemplate >
                        <div style="overflow-y:hidden;overflow-x:hidden;font-family:Arial;font-size:12px;">
                    <table cellpadding="0" cellspacing="0" width='100%'  border='1' style='border-collapse:collapse;font-family:Arial;font-size:12px;' >
                    <tfoot>
                                ...
                                <tr style="height:35px;">
                                    <td colspan="7" style="text-align:right;vertical-align:middle;">
                                      ...
                                      <%--  <asp:Button ID="imgImport" runat="server" 
                                             OnClick="imgImport_OnClick" Text="Export" style='border:none;padding:5px;' 
                                            OnClientClick="return confirm('Are you sure to import budget for selected vessel?');" CssClass="btn" />--%>
                                        <asp:Button ID="imgLockBudget" runat="server" 
                                             OnClick="LockBudget_OnClick" 
                                            OnClientClick="return confirm('Are you sure to lock budget ?');" Text="Lock Budget" CssClass="btn"/>
                                        <asp:Button ID="imgSave" Visible="false" runat="server" Text="Save" CssClass="btn"
                                            OnClick="imgSave_OnClick" />
                                        <asp:Button ID="Print" runat="server" Text="Print" CssClass="btn" 
                                            OnClientClick="ViewPrintRPT();"/>
                                            <div style="float :right; padding-right:5px;" >
                                            <asp:UpdatePanel ID="UpdatePanel1" runat="server" >
                                                <ContentTemplate>
                                                    <asp:Button ID="imgbtnPublish" runat="server" Text="Publish" CssClass="btn" onclick="imgbtnPublish_Click" OnClientClick="return confirm('Are you sure to publish?')" Visible="false" />
                                                </ContentTemplate>
                                            </asp:UpdatePanel>
                                            </div>&nbsp;
                                    </td>
