<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SMS_ManualMaster.aspx.cs" Inherits="SMS_ManualMaster" %>
        ...
        <table cellpadding="0" cellspacing="0" width="100%">
            ...
            <td style="text-align: center; border-top:solid 1px black;">
                <table cellpadding="0" cellspacing="0" style="width:100%">
                    ...
                    <td style="padding:3px;" >
                        ...
                        <col />
                        <col width="100px" />
                            <asp:Repeater ID="GridView_Manuals" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <asp:HiddenField ID="Hidden_SubChapterId" runat="server" Value='<%# Eval("ManualId") %>' /><%#Eval("ManualName")%>
                                        </td>
                                        <td style="text-align:center;"> <%#Eval("VersionNo")%> </td>
         ...
         <tr>
            ...
            <asp:Panel runat="server" ID="p1" Visible="false">
                ...
                <tr>
                    <td style="width:100px; text-align:left">Manual Name</td>
                    <td style="text-align:left; width:380px;">:&nbsp;<asp:TextBox runat="server" ID="txtManualName" MaxLength="100" Width="300px" CssClass="required_box"></asp:TextBox>
                    </td>
                ...
                <tr>
                    <td colspan="4">
                        <asp:RequiredFieldValidator runat="server" ID="r1" ControlToValidate="txtManualName" ErrorMessage="Required."></asp:RequiredFieldValidator>
