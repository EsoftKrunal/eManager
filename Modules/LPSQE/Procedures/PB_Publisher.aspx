<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PB_Publisher.aspx.cs" Inherits="PB_Publisher"  %>
...
<body>
    ...
    <div style="padding:5px; text-align:right">
        <asp:Button runat="server" id="btnAdd" Text="Add Publisher" OnClick="btnAdd_Click" style="padding:2px ; background-color:#FFADD6 "/>
    </div>
    ...
    <table width="100%" cellpadding="2" style="text-align:center; border-collapse:collapse;text-align:left;" border="1"> 
        ...
        <asp:Repeater ID="rptData" runat="server">
            <ItemTemplate>
                <tr>
                    <td style="text-align:center;"> 
                        <asp:LinkButton ID="lnkEdit" runat="server" Text="Edit" OnClick="lnlEdit_OnClick" CommandArgument='<%#Eval("PublisherId")%>' ForeColor="Blue"></asp:LinkButton>
                    </td>
                    <td style="text-align:center;"> 
                        <asp:LinkButton ID="lnkDelete" runat="server" Text="Delete" OnClick="lnlDelete_OnClick" CommandArgument='<%#Eval("PublisherId")%>' ForeColor="Red" OnClientClick="return window.confirm('Are you sure to delete?');"></asp:LinkButton>
                    </td>
    ...
    <div style="position:absolute;top:0px;left:0px; height :470px; width:100%;" id="dvPopUp" runat="server" visible="false">
        <center>
            ...
            <div style="position :relative; width:540px; height:120px; padding :5px; text-align :center; border :solid 0px #FFADD6; background : white; z-index:150;top:100px;opacity:1;filter:alpha(opacity=100)">
                 <div>
                 <div style="padding:4px; background-color:#66E0FF; color:White;"> Add / Edit Publisher</div>
                 <div style="border:solid 1px #66E0FF; height:93px;">
                    ...
                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                        ...
                        <td style="text-align:left"> 
                            <asp:TextBox runat="server" ID="txtPublisher" Width="250px" MaxLength="50" style=" background-color:#FFFFC2"></asp:TextBox> 
                            <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator1" ErrorMessage="*" ControlToValidate="txtPublisher"></asp:RequiredFieldValidator>
                        </td>
                        </tr>
                    </table>
                    <br />
