             ...
             <table cellpadding="2" cellspacing="0" rules="rows" style="text-align:left; border-collapse:collapse;" width="100%" border="1">
                ...
                <asp:Repeater ID="rptForms" runat="server">
                    <ItemTemplate>
                        <tr>
                            <td>
                                  <asp:ImageButton ID="imgEdit" runat="server" ImageUrl="~/images/editX12.jpg" CausesValidation="false" OnClick="imgEdit_OnClick" Visible='<%#Auth.IsUpdate %>' CommandArgument='<%#Eval("FormId")%>' />
                            </td>
