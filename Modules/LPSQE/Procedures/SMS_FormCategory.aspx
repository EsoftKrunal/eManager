<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SMS_FormCategory.aspx.cs" Inherits="Modules_LPSQE_Procedures_SMS_FormCategory" %>
        ...
        <table cellpadding="0" cellspacing="0" width="100%">
                ...
                <table cellpadding="0" cellspacing="0" style="width:100%">
                    ...
                    <td style="padding:3px;" >
                        ...
                        <col />
                            ...
                            <asp:Repeater ID="RptFormsCategory" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        <td>
                                            <asp:ImageButton ID="btnEdit" OnClick="btnEdit_OnClick" runat="server" CausesValidation="False" CommandName="Edit" ImageUrl="~/Modules/HRD/Images/edit.jpg" ToolTip="Edit" Visible='<%#Auth.IsUpdate %>'/>                                            
                                        </td>
                                        <td>
                                            <asp:HiddenField ID="hdnFormsCatId" runat="server" Value='<%# Eval("FormsCatId") %>' /><%#Eval("FormsCatName")%>
                                        </td>
                    ...
                    <td style="vertical-align:top;">                        
                            <div style="width:100%;overflow-y:hidden;overflow-x:hidden;" id="divFormsCatVesselGrid" runat="server" visible="false">                                
                                ...
                                <asp:Button ID="btnEditVessels" runat="server" Text=" Modify Vessel List" CssClass="btn" OnClick="btnEditVessels_OnClick" />
                                </div>
         ...
         <tr>
            ...
            <asp:Panel runat="server" ID="p1" Visible="false">
                ...
                <tr>
                    <td style="width:100px; text-align:left">Forms Category Name</td>
                    <td style="text-align:left; width:380px;">:&nbsp;<asp:TextBox runat="server" ID="txtFormsCatName" MaxLength="100" Width="300px" CssClass="required_box"></asp:TextBox>
                    </td>
                   <%-- <td style="width:100px; text-align:left">Version #</td>
                    <td style="text-align:left">:&nbsp;<asp:TextBox runat="server" ID="txtversion" MaxLength="50" Width="300px" CssClass="required_box" Enabled="false" ></asp:TextBox>
                    </td>--%>
                </tr>
                <tr>
                    <td colspan="2">
                        <asp:RequiredFieldValidator runat="server" ID="r1" ControlToValidate="txtFormsCatName" ErrorMessage="Required."></asp:RequiredFieldValidator>
                       <%-- <asp:RequiredFieldValidator runat="server" ID="RequiredFieldValidator1" ControlToValidate="txtversion" ErrorMessage="Required."></asp:RequiredFieldValidator>--%>
                    </td>
                </tr>
                </table>
                </td>
           ...
           <%-- <asp:Button runat="server" ID="btnReleaseNewVersion" onclick="btnReleaseNewVersion_Click" Text="Release New Version" CssClass="btn" OnClientClick="return confirm('Are you sure to release new version?');" Visible="false" />&nbsp;--%>
    ...
    <div style="position:absolute;top:0px;left:0px; height :470px; width:100%;" id="dvPopupEditVessel" runat="server" visible="false">
        ...
        <div style="position :relative; width:500px; height:320px; padding :3px; text-align :center; border :solid 1px #4371a5; background : white; z-index:150;top:60px;opacity:1;filter:alpha(opacity=100)">
            <div style="margin:5px;">
                ...
                <div class="text headerband" style="width:100%;text-align:center;" > <b> Select Vessel </b></div>
                ...
                <div style="width:100%; height:230px; overflow-x:hidden;overflow-y:scroll;text-align:left;border:solid 1px #c2c2c2;">
                    <asp:CheckBoxList runat="server" RepeatDirection="Vertical" RepeatColumns="1" ID="chkVType" DataValueField="VesselID" DataTextField="VesselName"></asp:CheckBoxList>
                </div>
            </div>
