    ...
    <td style="width:375px;vertical-align:top;border:solid 1px black; border-top:none; overflow:hidden;"> 
     <div style="width:375px; height:455px;"> 
        ...
        <ContentTemplate>
            ...
            <tr>
                <td>
                    <div style="width:100%; background-color:#4371a5;border:solid 1px gray; border-top:none; border-right:none;width:375px;  height:25px;overflow-x:hidden; overflow-y:hidden; color:White;">
                        ...
                        <div style="padding-top:5px;Width:175px;">&nbsp;<asp:DropDownList ID="ddlManualCategories" Width="150px" runat="server" AutoPostBack="True" onselectedindexchanged="ddlManualCategories_SelectedIndexChanged"></asp:DropDownList> </div>
                        </div>
