<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReadViewRanks.aspx.cs" Inherits="ReadViewRanks" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Open Applied Ranks</title>
...
<body >
    <form id="form1" runat="server">
        <table style="width:100%; text-align:left" border="0" cellpadding="5" cellspacing="5">
            <tr>
                <td style="text-align:left;" colspan="2">Applied Ranks: <hr /></td>
            </tr>
        </table>
        <center>
        ...
        <tr>
            ...
            <asp:Repeater runat="server" ID="rptLinkedRanks">
                ...
                <div style="height:15px; padding:5px; border-bottom:solid 1px #c2c2c2">
                    ...
                    <%#Eval("Sno")%>. 
                    <asp:LinkButton ID="lnkLink" runat="server" CommandArgument='<%#Eval("RankID")%>' Text='<%# Eval("RankCode")%>'  OnClick="btnDownLoadFile" ></asp:LinkButton>  
