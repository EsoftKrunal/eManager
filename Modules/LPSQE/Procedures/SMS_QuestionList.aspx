<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SMS_QuestionList.aspx.cs"    Inherits="SMS_QuestionList" %>
    ...
    <asp:UpdatePanel ID="upMList" runat="server" UpdateMode="Conditional">
        ...
        <%--<div style="border:solid 1px red; height:450px;">--%>
            <div style=" padding:3px;  text-align:center;" class="text headerband">
                <b style=" font-family:Arial; font-size:17px;">
                    <asp:Label ID="lblManualNameHeading" runat="server" style="font-size:20px;font-weight:bold;" ></asp:Label></b>
                </div>
                <%----------------------------------------------------------------------------------------%>
            ...
            <div id="DivShowQuestion" runat="server"   >
                ...
                <table width="100%" border="0" cellpadding="7" cellspacing="0">
                    <tr style="background-color:#e2e2e2; font-weight:bold;" runat="server" id="trCopy" visible="false">
                        <td align="left">
                            Copy questions to manual <asp:DropDownList runat="server" ID="dllCopyManual"></asp:DropDownList>                            
                            <asp:Button ID="btnCopyQuestion" runat="server" Text="Copy" OnClick="btnCopyQuestion_OnClick" OnClientClick="return confirm('Are you sure to copy selected questions?');" style=" padding:4px; width:80px;" CssClass="btn" />
            ...
            <table width="100%" border="0">
                ...
                <tr>
                    <td> 
                        <asp:Button ID="btnSaveQuestionair" runat="server" OnClick="btnSaveQuestionair_OnClick" Text="Save" CssClass="btn"/> 
                                    
                    </td>
                    <td>
                        <asp:Button ID="btnCancelSaveQuestion" runat="server" OnClick="btnCancelSaveQuestion_OnClick" Text="Close" CssClass="btn" />     
