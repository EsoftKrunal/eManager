<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ViewManualSection_PopUp.aspx.cs" Inherits="ViewManualSection_PopUp" %>
        ...
        <div style="padding:5px; padding-left:5px;width:100%; border-bottom:solid 1px black; background-color:#e2e2e2; padding-bottom:7px;">
            ...
            <div style="text-align:left; padding:3px;">
                <div runat="server" id="dvForms" class="abtn" title="Open Linked Forms.">   
                    <div><a target="comm" href="ReadViewForms.aspx?ManualId=<%=ob_Section.ManualId.ToString()%>&SectionId=<%=ob_Section.SectionId%>" ><img src="Images/form.png" /></a></div>
                </div>
                ...
                <div runat="server" id="dvPopUpWithNoHeader" class="abtn" title="Maximize this window.">   
