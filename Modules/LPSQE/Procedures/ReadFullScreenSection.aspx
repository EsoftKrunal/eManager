<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReadFullScreenSection.aspx.cs" Inherits="SMS_ReadFullScreenSection" %>
    ...
    <div style="width:99%">
        <div id="dvHeader" runat="server" style="padding:5px; padding-left:5px;background-color:#e2e2e2;width:100%; border-bottom:solid 1px black; padding-bottom:7px;">
            <div style="text-align:left;">
                ...
                <asp:LinkButton ID="lnkSMSReview" Font-Bold="true" style="padding-left:1100px;" OnClick="lnkSMSReview_Click" runat="server" Text="SMS Review" ></asp:LinkButton><br />
                <asp:Label runat="server" ID="lblMVersion" Font-Bold="true" style="float:right"></asp:Label> 
