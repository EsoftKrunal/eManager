<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SMS_AddNewQuestion.aspx.cs" Inherits="SMS_SMS_AddNewQuestion" %>
                ...
                <td>
                    ...
                    <tr>
                        <td style="text-align:left">
                            <asp:Button ID="btnSaveQuestionair" runat="server" CssClass="btn" 
                                OnClick="btnSaveQuestionair_OnClick" Text="Save" />
                            &nbsp;
                            <asp:Button ID="btnCancelSaveQuestion" runat="server" CssClass="btn" Text="Close" OnClientClick="javascript:window.close();" />
                        </td>
                        <td style="text-align:left">
