<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReadManualSection1.aspx.cs" Inherits="ReadManualSection1" %>
        ...
        <div style="padding:5px; padding-left:5px;width:100%; border-bottom:solid 1px black; background-color:#e2e2e2; padding-bottom:7px; ">
            ...
            <div style="text-align:left; padding:3px;">
                <div runat="server" id="dvForms" class="abtn" title="Open Linked Forms.">   
                    <div><a target="comm" href="ReadViewForms.aspx?ManualId=<%=ob_Section.ManualId.ToString()%>&SectionId=<%=ob_Section.SectionId%>" ><img src="../../HRD/Images/form.png" /></a></div>
                </div>

                <div runat="server" id="divRanks" class="abtn" title="Open Applied Ranks.">   
                    <div><a target="comm" href="ReadViewRanks.aspx?ManualId=<%=ob_Section.ManualId.ToString()%>&SectionId=<%=ob_Section.SectionId%>" ><img src="../../HRD/Images/form.png" /></a></div>
                </div>


                <div runat="server" id="dvPopUp" class="abtn" title="Maximize this window." >   
                    <div><a href="#" onclick="openwindow();"><img src="../../HRD/Images/maximize.png" title="Maximize this window." /></a></div>
                </div>

                <div runat="server" id="dvdvPopUpWithNoHeader" class="abtn" title="Maximize this window." >   
                    <div><a href="#" onclick="openwindowWithNoHeader();"><img src="../../HRD/Images/book_open.png" title="Open with Original Program." /></a></div>
                </div>
                <div runat="server" id="dvEnterComment" class="abtn" title="Comment" >   
                    <div><a target="comm" href="OfficeComments.aspx?ManualId=<%=ob_Section.ManualId.ToString()%>&SectionId=<%=ob_Section.SectionId%>&ManVersion=<%=mb.VersionNo %>&SecVersion=<%=ob_Section.Version%>"><img src="../../HRD/Images/icon_comment.gif" title="SMS Review" /></a></div>
                </div>

                <%--<div runat="server" id="Div1" style="width:100px;display:inline;">   
                    <div><a href="ViewManualCommentsHistory.aspx?ManualId=<%=ob_Section.ManualId.ToString()%>&SectionId=<%=ob_Section.SectionId%>&ManVersion=<%=mb.VersionNo %>&SecVersion=<%=ob_Section.Version%>&RMS=Yes" > Comments </a></div>
                </div>--%>
            </div>
        </div>
