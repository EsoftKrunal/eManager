<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReadManuals.aspx.cs" Inherits="ReadManuals"  %>
...
; ">Manuals</td>
    <td style="width:275px;height:20px; border-right: solid 1px black; font-weight:bold; vertical-align:middle; text-align:center; color:#ffffff; background-color:#9999FF
; ">Index</td>
    <td style="height:20px; border-right: solid 1px black; font-weight:bold; vertical-align:middle; text-align:center; color:#ffffff; background-color:#9999FF; ">View</td>
    </tr>--%>
    <tr>
    <td style="width:375px;vertical-align:top;border:solid 1px black; border-top:none;overflow:hidden ">
     <div style="width:375px; height:455px; ">
        ...
        <ContentTemplate>
            ...
            <tr>
                <td>
                    <div style="width:100%; border:solid 1px gray; border-right:none; border-top:none;width:375px;  height:25px;overflow-x:hidden; overflow-y:hidden; ">
                        ...
                        <div style="padding-top:2px;Width:200px;">&nbsp;<asp:DropDownList ID="ddlManualCategories" Width="175px" runat="server" AutoPostBack="True" onselectedindexchanged="ddlManualCategories_SelectedIndexChanged"></asp:DropDownList> </div>
        ...
        <td style="width:380px;vertical-align:top; border:solid 1px black; border-top:none;">
        ...
        <ContentTemplate>
           ...
           <%-- <div style="height: 450px; overflow-x: hidden; overflow-y: scroll;" id="dvscroll_Order"
                onscroll="SetScrollPos(this)">--%>
        ...
        <ContentTemplate>
            <iframe width="100%" height="455px" src="" runat="server" id="frmSection" frameborder="0" scrolling="yes"></iframe>        
        </ContentTemplate>
        </asp:UpdatePanel>
        </td>
    </tr>
               ...
               <tr>
                ...
                <tr>
                    <td colspan="2" style="text-align:right; padding-right:50px;">
                            <asp:Button runat="server" ID="btnSearch" Text="Search" OnClick="SearchManual" CssClass="btn"  />
