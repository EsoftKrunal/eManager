...
<div style="background-color:#ffffff; text-align:center;padding-bottom:0px; text-align:left; padding:5px; padding-bottom:0px;">
    ...
    <asp:Button runat="server" ID="btnSMSAdmin" OnClick="btnSMSAdmin_Click"  Text="SMS ADMIN " CssClass="btn1" BorderWidth="0" style="padding:8px 10px 2px 10px;" Visible="false"/>
    ...
    <asp:Button runat="server" ID="btn_SMSReview" OnClick="btn_SMSReview_Click"  Text="SMS REVIEW" CssClass="btn1" BorderWidth="0" style="padding:8px 10px 2px 10px;" Visible="false"/>
	<asp:Button runat="server" ID="btnAPPROVAL"  OnClick="btnAPPROVAL_OnClick" BorderWidth="0" Text=" Approval  " CssClass="btn1"  style="padding:8px 10px 2px 10px; " Visible="false"/>
	<asp:Button runat="server" ID="btnComm"  OnClick="btnComm_OnClick" BorderWidth="0" Text=" Communication " CssClass="btn1"  style="padding:8px 10px 2px 10px;  " Visible="false"/>
