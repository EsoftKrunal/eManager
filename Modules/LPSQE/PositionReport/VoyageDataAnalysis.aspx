<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VoyageDataAnalysis.aspx.cs" Inherits="VPR_VoyageDataAnalysis" %>
...
<head runat="server">
   ...
   <link rel="stylesheet" type="text/css" href="../../HRD/Styles/StyleSheet.css" />
    ...
    <script type="text/javascript">
        function SetHeader() {
            document.getElementById("dh").scrollLeft = document.getElementById("dd").scrollLeft;
...
<style type="text/css">
    ...
    <div style="float:left;display:none;" >
        <asp:Button ID="btnVDA" runat="server" Text="Voyage Data Analysis" OnClick="btnVDA_OnClick" CssClass="btn" style=" border-bottom:none" />
        <asp:Button ID="btnEEOI" runat="server" Text="EEOI" OnClick="btnEEOI_OnClick" CssClass="btn"/>
    </div>
    
    </div>
    <table width="100%" cellpadding="0" cellspacing="1" border="1" style="border:solid 1px #4371a5;text-align :center; border-collapse:collapse;" >
...
<ContentTemplate>
<div runat="server" id="trVessel" style="padding:6px; text-align:center; " class="text headerband" >
       <span style="font-size:20px; font-weight:bold;">
           Voyage Data Analysis Report ( <%=Page.Request.QueryString["VessleName"].ToString() %> )</span> </span> 
</div>


<div runat="server" id="dvFilter">
    <table cellpadding="2" cellspacing="0" width="100%" border="1">
        ...
        <colgroup>
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="ddlReprotType" runat="server">
                ...
                <td style="text-align:left"><b>Period :</b></td>
                <td style="text-align:left">
                    <asp:TextBox ID="txtFromDate" runat="server" onfocus="showCalendar('',this,this,'','holder1',5,22,1)" Width="80px"></asp:TextBox>
                    <asp:TextBox ID="txtToDate" runat="server" onfocus="showCalendar('',this,this,'','holder1',5,22,1)" Width="80px"></asp:TextBox>
                </td>
                <td style="text-align:left"><b>Voy. Cond&#39;n :</b></td>
                <td style="text-align:left">
                    <asp:DropDownList ID="ddl_F_VoyCond" runat="server">
                        <asp:ListItem Text="&lt; All &gt; " Value=" "></asp:ListItem>
                        <asp:ListItem Text="Laden" Value=" VoyCondition In ('Laden') "></asp:ListItem>
                        <asp:ListItem Text="Ballast" Value=" VoyCondition In ('Ballast') "></asp:ListItem>
                    </asp:DropDownList>
                </td>
                ...
                <td style="text-align:left">
                    <asp:DropDownList ID="ddlLoc" runat="server">
                        <asp:ListItem Text="&lt; All &gt; " Value=" "></asp:ListItem>
                        <%--<asp:ListItem Text="In Port" Value=" ReportType Not in ('Noon','Arrival') "></asp:ListItem>
<asp:ListItem Text="At Sea" Value=" ReportType in ('Noon','Arrival') "></asp:ListItem>--%>
                        <asp:ListItem Text="In Port" Value=" Location=2 "></asp:ListItem>
                        <asp:ListItem Text="At Sea" Value=" Location=1 "></asp:ListItem>
                    </asp:DropDownList>
                </td>
                <td>
...
<td>&nbsp;</td>
<td>
<asp:CheckBox runat="server" ID="chkAll1" OnCheckedChanged="chkAll1_CheckedChanged" AutoPostBack="true" />
<b>Remove Fields</b></td>
    <td></td>

</tr>
<tr>
<td >
<div id="dvscroll_A" style="overflow-x:hidden;overflow-y:scroll; height:550px" onscroll="SetScrollPos(this)">
    <asp:CheckBoxList runat="server" ID="chkAvlColumns"></asp:CheckBoxList>
</div>
</td>
<td style="text-align:center">
    <asp:Button ID="btnAdd" runat="server" Text="&nbsp;>>&nbsp;" onclick="btnAdd_Click" BackColor="DimGray" Width="40px" Font-Bold="true" ForeColor="White" BorderStyle="Solid" BorderWidth="1"/>
    <br />
    <asp:Button ID="btnRem" runat="server" Text="&nbsp;<<&nbsp;" onclick="btnRem_Click" BackColor="DimGray" Width="40px" Font-Bold="true" ForeColor="White" BorderStyle="Solid" BorderWidth="1"/>
    
</td>
<td > 
    <div id="dvscroll_S" style="overflow-x:hidden;overflow-y:scroll; height:550px" onscroll="SetScrollPos(this)">
    <asp:CheckBoxList ID="chkSelColumns" runat="server"></asp:CheckBoxList>
    </div>
</td>
<td style="vertical-align:top">
<div id="dvscroll_D" style="overflow-x:hidden;overflow-y:scroll; height:550px" onscroll="SetScrollPos(this)">
    <asp:Repeater runat="server" ID="rptFilter" >
    <ItemTemplate>
    <asp:UpdatePanel runat="server" ID="rptup1">
    <ContentTemplate>
        <div class="fieldname">
            <asp:Label Text='<%#Eval("ColumnName")%>' runat="server" ID="lblColumnName"></asp:Label>
            <asp:HiddenField runat="server" ID="hfdPK" Value='<%#Eval("PK")%>' />
            <asp:HiddenField runat="server" ID="hfdColumnName" Value='<%#Eval("ColumnName")%>' />
            <asp:HiddenField runat="server" ID="hfdDataType" Value='<%#Eval("DataType")%>' />
            <asp:HiddenField runat="server" ID="hfdOpearator" Value='<%#Eval("Opearator")%>' />
            <asp:HiddenField runat="server" ID="hfdDDLValue" Value='<%#Eval("DDLValue")%>' />
            <asp:HiddenField runat="server" ID="hfdTXTValue1" Value='<%#Eval("TEXTValues1")%>' />
            <asp:HiddenField runat="server" ID="hfdTXTValue2" Value='<%#Eval("TEXTValues2")%>' />
        </div>
        <div class="operator">
            <asp:DropDownList runat="server" ID="ddlFilterOperators" AutoPostBack="true" DataTextField="Opeartor_Code" DataValueField="Opeartor_SQL" OnSelectedIndexChanged="ddlFilterOperators_SelectedIndexChanged" DataSource='<%#LoadOpeartors(Eval("DataType"))%>'></asp:DropDownList>
        </div>
        <div class="values">
            <asp:DropDownList runat="server" ID="ddlValue1" Visible="false"></asp:DropDownList>
            <asp:TextBox runat="server" ID="txtValue1" Visible="false"></asp:TextBox>
            <asp:TextBox runat="server" ID="txtValue2" Visible="false"></asp:TextBox>
        </div>
    </ContentTemplate>
    </asp:UpdatePanel>
    </ItemTemplate>
...
<div runat="server" visible="false" id="dvGrid">
<center>
<div style="display:none;">
        <asp:Label runat="server" ID="lblSQL" Font-Size="X-Large" ></asp:Label>
</div>
<div style="padding:5px; text-align:center;">
<asp:Button ID="btnDownload" runat="server" Text="&nbsp;Download&nbsp;" onclick="btnDownload_Click" CssClass="btn"/>
<asp:Button ID="btnGoBack" runat="server" Text="&nbsp;< Go Back &nbsp;" onclick="btnGB_Click" CssClass="btn"/>
</div>
<div style="overflow:scroll; border:solid 1px black;overflow-x:hidden;width:1180px;" id="dh">
<asp:Literal runat="server" ID="litHeader"></asp:Literal>
</div>
<div style="overflow:scroll; border:solid 1px black; height:450px;width:1180px;" id="dd" onscroll="SetHeader();">
