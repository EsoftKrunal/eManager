<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NearMiss_List.aspx.cs" Inherits="eReports_S133_S133_List" %>
                           ...
                           <table cellspacing="0" rules="none" border="0" cellpadding="4" style="width:100%;border-collapse:collapse;">
                                ...
                                <asp:Repeater ID="rptReports" runat="server">
                                    <ItemTemplate>
                                            ...
                                            <td style="text-align:center"><a href='<%# "eReport_NearMiss.aspx?Key=" + Eval("ReportId") + "&Type=V&VC=" + Eval("VesselCode")%>' target="_blank"><img src="../../../HRD/Images/magnifier.png" /></a></td>
                                            <td style="text-align:center"><a href='<%# "eReport_NearMiss.aspx?Key=" + Eval("ReportId") +"&Type=E&VC=" + Eval("VesselCode")%>' target="_blank" runat="server" visible='<%#(Eval("Edit_ALLOWED").ToString()=="Y")%>'><img src="../../../HRD/Images/AddPencil.gif"/></a></td>
                                            <td style="text-align:center"><a href='<%# "ER_NearMiss_Report.aspx?Rid=" + Eval("ReportId") + "&VC=" + Eval("VesselCode")%>' target="_blank"><img src="../../../HRD/Images/printer12x12.png" /></a></td>
