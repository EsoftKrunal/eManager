...
public partial class eReports_UploadDocuments : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            VesselName = Request.QueryString["VC"];
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        string savepath = Server.MapPath("~\\HSSQE\\eReports\\" + FormNo + "\\Documents\\Office"); 
        ...
        for (int i = 1; i <= Files; i++)
        {
            ...
            Common.Execute_Procedures_Select_ByQuery("EXEC [DBO].[ER_S115_Insert_ER_Report_Documents_OfficeShip] '" + VesselName + "','" + FormNo +"'," + ReportId.ToString() + ",'" + Request.Form["txt" + (i - 1).ToString()] + "','" + filename + "','" + UserName + "','O'");
            txtNOF.Text = "";
        }
