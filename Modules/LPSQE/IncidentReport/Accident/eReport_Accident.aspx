<%@ Page Language="C#" AutoEventWireup="true" CodeFile="eReport_Accident.aspx.cs" Inherits="eReports_S115_eReport_S115" EnableEventValidation="false" ValidateRequest="false" %>
...
<body>
    ...
    <div style="font-family:Arial;font-size:12px;">
             ...
             <td >
              <table cellpadding="0" cellspacing="0" width="100%">
                 <tr class="text headerband">
                     ...
                     <td style="text-align:right; width:30%" >Form :&nbsp;Accident</td>
                     </tr>
                 <tr >
                     ...
                     <td style="text-align:right; width:30%" class="formname">
                        <div style="float:right; display:none; text-align:center; width:100px; padding:0px; background-color:Red; color:White; PADDING-top:2px;" runat="server" id="dv_Notice">Incomplete</div>
                     </td>
         ...
         <tr style=" ">
             <td>
                 <table cellpadding="0" cellspacing="0" width="100%" class="tbltd">
                 <tr>
                     <td>Name of Port</td>
                     <td>:</td>
                     <td>
             ...
             <tr>
                 ...
                 <div style="float:left; ">
                    ...
                    <asp:button ID="btnCOA" runat="Server" Text="Cause Of Accident" CssClass="color_tab" CommandArgument="Div13" OnClick="btn_Tab_Click" CausesValidation="false"  Width="130px"/>
                    ...
                    <asp:button ID="btnOC" runat="Server" Text="Office Comments" CssClass="color_tab" CommandArgument="Div15" OnClick="btn_Tab_Click" CausesValidation="false"  Width="120px"/>
                    <asp:button ID="btnEmailBlast" runat="Server" Text="Email Blast" CssClass="color_tab" CommandArgument="Div99" OnClick="btn_Tab_Click" CausesValidation="false"  Width="120px"/>
                     <asp:button ID="btnRCA" runat="Server" Text="RCA" CssClass="color_tab" CommandArgument="Div100" OnClick="btn_Tab_Click" CausesValidation="false"  Width="120px"/>
                 </div>                
                 
                 <div style="clear:both"></div>               
                 </div>
                 <div style="width:100%; background-color:#FFCC80; height:4px;"></div>
                 <div style="height:430px; overflow-y:scroll; overflow-x:hidden; position:relative; border:solid 1px #e2e2e2; border-top:none;" >
                    <div id="Div1" runat="server">
                         <div class="text headerband" style="text-align: left;font-size:12px;">Section 1 : Severity & Classification</div>
                         <table cellpadding="0" cellspacing="0" width="100%">
                             <tr>
                                 <td style="width:200px">
                                     <table cellpadding="0" cellspacing="0" width="100%">
                                         ...
                                         <tr>
                                             ...
                                             <td>
                                                 <%--<asp:RequiredFieldValidator ID="rfsec1SOA" runat="server" ForeColor="Red" ErrorMessage="*" ControlToValidate="lblsec1SOA" SetFocusOnError="true" ></asp:RequiredFieldValidator>--%>
                                             </td>
                                         </tr>
                                     </table>
                                 </td>
                         ...
                         <div class="text headerband" style="text-align: left;font-size:12px;">Section 2 : Event Description</div>
                         <table cellpadding="0" cellspacing="0" width="100%">
                             <tr>
                                 <td>
                         ...
                         <div class="text headerband" style="text-align: left;font-size:12px;">Section 3 : General Information</div>
                        <table cellpadding="0" cellspacing="0" width="100%">
                             <tr>
                                 <td>
                                     <table cellpadding="0" cellspacing="0" width="100%">
                     ...
                     <div id="Div4" runat="server" visible="false">
                         <div class="text headerband" style="text-align: left;font-size:12px;">
                             Section 4 : Injury to personnel
                             <asp:ImageButton ID="btnAddInjuredCrew" ImageUrl="~/Modules/HRD/Images/add.png" ToolTip="Add new Crew/Contractor" OnClick="btnAddInjuredCrew_Click" style="padding-top:0px; display:none;" runat="server" />
                             <a href="OCIMF_Injury.pdf" title="OCIMF Guidelines"> <img src="../../../HRD/Images/paperclip12.gif" /> OCIMF Guidelines </a>
                         </div>
                           ...
                           <table cellspacing="0" rules="ROWS" border="0" bordercolor="white" cellpadding="4" style="width:100%;border-collapse:collapse;" class="newformat">
                               <colgroup>
                                ...
                                <asp:Repeater ID="rptSec4" runat="server">
                                    <ItemTemplate>
                                           <tr>
                                           <td><asp:ImageButton ID="btnViewCrew" OnClick="btnViewCrew_Click" runat="server" CommandArgument='<%#Eval("TableId")%>' ImageUrl="~/Modules/HRD/Images/magnifier.png" ToolTip="View" /> </td>                                           
                                           <%--<td><asp:ImageButton ID="btnEditCrew" OnClick="btnEditCrew_Click" runat="server" CommandArgument='<%#Eval("TableId")%>' ImageUrl="~/Images/12-em-pencil.png" ToolTip="Edit" /> </td>                                           
                                           <td><asp:ImageButton ID="btnDeleteCrew" OnClick="btnDeleteCrew_Click" runat="server" CommandArgument='<%#Eval("TableId")%>' OnClientClick="return confirm('Are you sure to delete?');" ImageUrl="~/Images/Delete.png" ToolTip="Delete" Width="12px" /> </td>--%>                                           
                     ...
                     <div id="Div5" runat="server" visible="false">
                         <div class="text headerband" style="text-align: left;font-size:12px;">Section 5 : Cargo </div>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:CheckBoxList runat="server" ID="chklstsec5TankCoating">
                                                                <asp:ListItem Text="Stainless Stee" Value="1"></asp:ListItem>
                     ...
                     <div id="Div9" runat="server" visible="false">
                         <div class="text headerband" style="text-align: left;font-size:12px;">Section 9 : Equipment Failure</div>
                         <asp:UpdatePanel runat="server" ID="UpdatePanel2">
                         <ContentTemplate>
                         <table cellpadding="0" cellspacing="0" width="100%" border="0" style="padding-top:2px">
                             <tr>
                                 <td class='hdng1'>
                                     Is Critical Euipment Effected ?
                                 </td>
                             </tr>
                             <tr>
                                 <td>
                     ...
                     <div id="Div10" runat="server" visible="false">
                         <div class="text headerband" style="text-align: left;font-size:12px;">Section 10 : Damage to Property</div>
                     ...
                     <div id="Div11" runat="server" visible="false">
                            <div class="text headerband" style="text-align: left;font-size:12px;">Section 11 : Fire</div>
                     ...
                     <div id="Div15" runat="server" visible="false">
                         ...
                         <table cellpadding="0" cellspacing="0" width="100%" border="0" style="padding-top:2px">
                            <tr>
                                     ...
                                     <table cellpadding="0" cellspacing="0" width="100%">
                                         <tr>
                                             <td colspan="4" class="hdng1">
                                                 WAS ANY INVESTIGATION DONE BY OFFICE OR EXTERNAL PARTY?&nbsp;&nbsp;&nbsp;<asp:RadioButton ID="radsec15IDyes" runat="server" GroupName="radsec15ID" Text="Yes" OnCheckedChanged="radsec15IDyes_OnCheckedChanged" AutoPostBack="true"/>
                                                 <asp:RadioButton ID="radsec15IDno" runat="server" GroupName="radsec15ID" Text="No" OnCheckedChanged="radsec15IDyes_OnCheckedChanged" AutoPostBack="true"/>
                                             </td>
                                         </tr>
                                         <tr id="trID" runat="server" visible="false">
                                             ...
                                             <td style="width: 15%;">
                                                 <asp:TextBox ID="txtsec15InvDate" runat="server" CssClass="date_only"></asp:TextBox>
                                             </td>
                                             <td style="width: 15%;">
                                                 Name of Person / Organization:
                                             </td>
                                             <td>
                                                 <asp:TextBox ID="txtsec15NameofPerson" Width="350px" runat="server"></asp:TextBox>
                                             </td>
                                         </tr>
                             ...
                             <tr>
                                 <td class="hdng1">
                                     Was the Vessel Delayed?&nbsp;&nbsp;&nbsp;<asp:RadioButton ID="radsec15VDyes" runat="server" GroupName="radsec15VD" Text="Yes" OnCheckedChanged="radsec15VDyes_OnCheckedChanged" AutoPostBack="true"/><asp:RadioButton ID="radsec15VDno" runat="server" GroupName="radsec15VD" Text="No" OnCheckedChanged="radsec15VDyes_OnCheckedChanged" AutoPostBack="true"/>
                                 </td>
                             </tr>
                                 ...
                                 <td>
                                     <table cellpadding="0" cellspacing="0" width="100%">
                                         <tr>
                                             <td>
                                                 Days :
                                                 <asp:TextBox runat="server" ID="txtsec15VDdays" Width="35px" MaxLength="3"></asp:TextBox>&nbsp;Hours
                                                 :
                                                 <asp:TextBox runat="server" ID="txtsec15VDHrs" Width="35px" MaxLength="2"></asp:TextBox>
                                             </td>
                                         </tr>
                                     </table>
                                 </td>
                             ...
                             <tr>
                                 <td>
                                     <asp:RadioButtonList ID="rdosec15PPR" runat="server" RepeatDirection="Horizontal">
                                         <asp:ListItem Text="Very High                  Daily" Value="1"></asp:ListItem>
                                         <asp:ListItem Text="High                       Once per Month" Value="2"></asp:ListItem>
                                         <asp:ListItem Text="Medium                     Twice per Year" Value="3"></asp:ListItem>
                                         <asp:ListItem Text="Low                        Once per Year" Value="4"></asp:ListItem>
                                         <asp:ListItem Text="None                       No past reports" Value="5"></asp:ListItem>
                                     </asp:RadioButtonList>
                                 </td>
                             </tr>
                             <tr>
                                 <td class="hdng1">
                                     CAUSES OF ACCIDENT (as assessed by the office)
                                 </td>
                             </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                 <td class="formname" style="text-align:center;font-size:12px;color:brown;"><b> IMMEDIATE CAUSES - CHECK ALL THAT APPLY </b></td>
                                 <td class="formname" style="text-align:center;font-size:12px;color:brown;"><b> ROOT CAUSES - CHECK ALL THAT APPLY </b></td>
                            </tr>
                            <tr>
                                <td style="vertical-align:top;">
                                    <table cellpadding="0" cellspacing="0" width="100%" border="1">
                                        <tr>
                                            <td style="vertical-align:top;">
                                                <table cellpadding="0" cellspacing="0" width="100%" border="0">
                                                    <tr>
                                                        <td class="hdng2"><b> Human Actions</b></td>
                                                    </tr>
                                                    <tr>
                                                        <td style="vertical-align:top;">
                                                            <asp:CheckBoxList runat="server" ID="chklstsec15HA" >
                                                            </asp:CheckBoxList>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="vertical-align:top;">
                                                            Other (Specify)
                                                            <asp:TextBox runat="server" ID="txtsec15HAOther"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                            <td style="vertical-align:top;">
                                                <table cellpadding="0" cellspacing="0" width="100%" border="0">
                                                    <tr>
                                                        <td class="hdng2"><b>Conditions</b></td>
                                                    </tr>
                                                    <tr>
                                                        <td style="vertical-align:top;">
                                                            <asp:CheckBoxList runat="server" ID="chklstsec15Cond" >
                                                            </asp:CheckBoxList>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="vertical-align:top;">
                                                            Other (Specify)
                                                            <asp:TextBox runat="server" ID="txtsec15CondOther"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                    ...
                                    <table cellpadding="0" cellspacing="0" width="100%" border="1">
                                        <tr>
                                            <td style="vertical-align:top;">
                                                <table cellpadding="0" cellspacing="0" width="100%" border="0">
                                                    <tr>
                                                        <td class="hdng2"><b>Human Factors</b></td>
                                                    </tr>
                                                    <tr>
                                                        <td style="vertical-align:top;">
                                                            <asp:CheckBoxList runat="server" ID="chklstsec15HF" >
                                                            </asp:CheckBoxList>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="vertical-align:top;">
                                                            Other (Specify)
                                                            <asp:TextBox runat="server" ID="txtsec15HFOther"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                            <td style="vertical-align:top;">
                                                <table cellpadding="0" cellspacing="0" width="100%" border="0">
                                                    <tr>
                                                        <td class="hdng2"><b>Job Factors</b></td>
                                                    </tr>
                                                    <tr>
                                                        <td style="vertical-align:top;">
                                                            <asp:CheckBoxList runat="server" ID="chklstsec15JF" >
                                                            </asp:CheckBoxList>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td style="vertical-align:top;">
                                                            Other (Specify)
                                                            <asp:TextBox runat="server" ID="txtsec15JFOther"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                            ...
                            <tr>
                                <td class="hdng1">IS FURTHER FOLLOW UP REQUIRED?&nbsp;&nbsp;&nbsp;<asp:RadioButton ID="radsec15FUyes" runat="server" GroupName="radsec15FU" Text="Yes" OnCheckedChanged="radsec15FUyes_OnCheckedChanged" AutoPostBack="true"/><asp:RadioButton ID="radsec15FUno" runat="server" GroupName="radsec15FU" Text="No" OnCheckedChanged="radsec15FUyes_OnCheckedChanged" AutoPostBack="true"/></td>
                            </tr>
                            <tr id="trFR" runat="server" visible="false">
                                <td>
                                   <table cellpadding="0" cellspacing="0" width="100%" border="0">
                                      <tr>
                                          <td style="width:10%;">Target Date : </td>
                                          <td style="width:8%;"><asp:TextBox ID="txtsec15YesTargetDate" MaxLength="11" runat="server"  CssClass="date_only" ></asp:TextBox></td>
                                          <td style="width:10%;">(details of follow up)</td>
                                          <td><asp:TextBox ID="txtsec15YesDetails" TextMode="MultiLine" Width="98%" Height="50px" MaxLength="500" runat="server"></asp:TextBox></td>
                                      </tr>
                                      <tr>
                                          <td>PIC for follow up :</td>
                                          <td colspan="3"><asp:TextBox ID="txtsec15FUPIC" MaxLength="50" Width="350px" runat="server"></asp:TextBox></td>
                                      </tr>
                                    </table>
                                </td>
                            </tr>
                            <tr>
                                <td class="hdng1">SUGGESTIONS FOR IMPROVEMENT FOR :</td>
                            </tr>
                            <tr>
                                <td>
                                    <table cellpadding="0" cellspacing="0" width="100%" border="0">
                                        <tr>
                                            <td colspan="2">
                                                <asp:CheckBoxList ID="chksec15SFI" RepeatDirection="Horizontal" runat="server">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtsec15Remarks" TextMode="MultiLine" Width="98%" Height="50px" MaxLength="500" runat="server"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                            ...
                            <tr>
                                <td class="hdng1">IS THIS INCIDENT CLOSED?&nbsp;&nbsp;&nbsp;<asp:RadioButton ID="radsec15ICyes" runat="server" GroupName="radsec15IC" Text="Yes" OnCheckedChanged="radsec15ICyes_OnCheckedChanged" AutoPostBack="true"/><asp:RadioButton ID="radsec15ICno" runat="server" GroupName="radsec15IC" Text="No" OnCheckedChanged="radsec15ICyes_OnCheckedChanged" AutoPostBack="true"/></td>
                            </tr>
                         ...
                         <Triggers>
                         <asp:PostBackTrigger ControlID="btnLockUnlock" />
                         </Triggers>
                         </asp:UpdatePanel>
                    </div>
                     <div id="Div16" runat="server" visible="false">
                         <div class="text headerband" style="text-align: left;font-size:12px;">
                             ...
                             <asp:ImageButton ID="imgbtnUploadDocsShowPanel" OnClick="imgbtnUploadDocsShowPanel_Click" ImageUrl="~/Modules/HRD/Images/add.png" ToolTip="Upload Documents" style="padding-top:0px" runat="server" Visible="false" />
                         </div>
                         <table cellpadding="0" cellspacing="0" width="100%" border="0" style="padding-top:2px">
                            <tr>
                            <td>
                           ...
                           <table cellspacing="0" rules="none" border="0" cellpadding="4" style="width:100%;border-collapse:collapse;">
                                ...
                                <asp:Repeater ID="rptReportDocs" runat="server">
                                    <ItemTemplate>
                                            ...
                                            <td>
                                                <asp:ImageButton runat="server" Visible='<%#(Eval("Office_Ship").ToString().Trim()=="Office" && Eval("Edit_Delete").ToString().Trim()=="E")%>' ImageUrl="~/Modules/HRD/Images/cancel.png" ID="btnDelDocument" CommandArgument='<%#Eval("DocId")%>' OnClick="btnDelDocument_Click" OnClientClick="return confirm('Are you sure to delete ?');"/>
                                            </td>
                                            <td><a href='<%# "./Documents/" +Eval("Office_Ship") + "/" + Eval("FileName").ToString()%>' target="_blank"><img src="../../../HRD/Images/paperclip12.gif" /></a></td>
                                            <td style="text-align:left;">&nbsp;<%#Eval("Office_Ship")%></td>
                                            <td align="left">
                                            <%--&nbsp;<asp:ImageButton ID="imgbtnUpdateDocDescr" CommandArgument='<%#Eval("DocId")%>' OnClick="imgbtnUpdateDocDescr_Click" ImageUrl="~/Images/AddPencil.gif" ToolTip="Update Description" style="padding-top:0px" runat="server" Visible='<%#Eval("Office_Ship").ToString().Trim()=="Ship"%>' />--%>
                                            &nbsp;<%#Eval("Descr")%></td>                                            
                     ...
                     <div id="Div99" runat="server" visible="false">
                         <div class="text headerband" style="text-align: left;font-size:12px;">
                             Section 17 : E-mail Blast
                         </div>
                         <table cellpadding="0" cellspacing="0" width="100%" border="0" style="padding-top:2px">
                            <tr>
                            <td>
                           ...
                           <table cellspacing="0" rules="all" border="1" bordercolor="white" cellpadding="4" style="width:100%;border-collapse:collapse; background-color:#FF9933; color: #fff;  height:25px;" >
                                ...
                                <tr class= "headerstylegrid">
                                    <td style="color:White;vertical-align:middle; text-align:center;">Sr#</td>
                                    <td style="color:White;vertical-align:middle; text-align:left;">&nbsp;Vessel</td>
                                    <td style="color:White;vertical-align:middle; text-align:left;">&nbsp;Date Sent</td>
                                    <td style="color:White;vertical-align:middle;text-align:left;">&nbsp;Date Recd.</td>
                                    <td style="color:White;vertical-align:middle;">&nbsp;Can this happen on your vessel</td>
                                    <td style="color:White;vertical-align:middle;">CA/PA Done</td>
                                    <td></td>
                                </tr>
                                </table>
                           </div>
                           ...
                           <table cellspacing="0" rules="none" border="0" cellpadding="4" style="width:100%;border-collapse:collapse;">
                                ...
                                <asp:Repeater ID="rpt_99" runat="server">
                                    <ItemTemplate>
                                            <tr>
                                            <td style="text-align:right"><%#Eval("SrNo")%>.</td>
                                            <td align="left" title='<%#Eval("Comments").ToString().Replace("\"","'").Replace("'","'")%>'>&nbsp;<%#Eval("VesselName")%></td>                                            
                                            <td align="left">&nbsp;<%#Common.ToDateString(Eval("PacketSentDate"))%></td>                                            
                                            <td align="left">&nbsp;<%#Common.ToDateString(Eval("PacketRecievedDate"))%></td>                                            
                                            <td align="left"><%#Eval("CHOYV")%></td>
                                            <td align="left"><%#Eval("CPD")%></td>
                                            <td>&nbsp;</td>
                                           </tr>
                                    </ItemTemplate>       
                                    <AlternatingItemTemplate>
                     ...
                     <div id="Div100" runat="server" visible="false">
                         <iframe src="RCA.aspx?ReportId=<%=ReportId %>&VesselCode=<%=VesselCode %>" frameborder="0" width="100%" height="430px" scrolling="no">
                 ...
                 <div style="border:solid 1px #e2e2e2;padding-bottom:0px; margin-top:3px; background-color:#CCE6FF; height:60px;">
                   <center>
                    <table width="100%" cellpadding="0" cellspacing="0" border="0" >
                        <tr>
                         <td id="tdTabs" runat="server" style="width:480px;padding-right:10px" >
                            ...
                            <asp:Button ID="btnSendDocs" runat="server" Text="Documents Export" CssClass="btn" style="float:left" onclick="btnExportDocsToShip_Click" CausesValidation="true" Width='140px' OnClientClick="confirm('Are you sure to export?');"/>
                        </td>
    ...
    <center>
        ...
        <div style="position:relative;width:1100px;  height:485px;padding :5px; text-align :center;background : white; z-index:150;top:30px; border:solid 0px black;">
            ...
            <div style="text-align:right; position:relative; right:-22px; top:-2px;">
                <asp:Button runat="server" ID="btnClose" Text="Close" onclick="btnClose_Click" CssClass="btn" CausesValidation="false" title='Close this Window !'/>   
            </div>
            </center>
         </div>
         </center>
    ...
    <center>
        ...
        <div style="position:relative;width:1100px;  height:485px;padding :5px; text-align :center;background : white; z-index:150;top:30px; border:solid 0px black;">
            ...
            <div style="text-align:right; position:relative; right:-22px; top:-2px;">
                <asp:Button runat="server" ID="btnCloseDocWindow" Text="Close" onclick="btnCloseDocWindow_Click"  CausesValidation="false" title='Close this Window !' CssClass="btn"/>   
            </div>
            </center>
         </div>
         </center>
    ...
    <center>
        <div style="position:fixed;top:0px;left:0px; min-height :100%; width:100%; background-color :Gray;z-index:100; opacity:0.4;filter:alpha(opacity=40)"></div>
        <div style="position:relative;width:500px;  height:300px;padding :5px; text-align :center;background : white; z-index:150;top:30px; border:solid 0px black;font-family:Arial;font-size:12px;">
            <center >
            <div class='text headerband'>Update Description
            ...
            <div style="text-align:right; position:relative; right:-22px; top:-2px;">
                <asp:ImageButton runat="server" ID="btnCloseDocUpdate" Text="Close" onclick="btnCloseDocUpdate_Click" ImageUrl="~/Images/close-button.png" CausesValidation="false" title='Close this Window !'/>   
            </div>
            </center>
         </div>
         </center>
