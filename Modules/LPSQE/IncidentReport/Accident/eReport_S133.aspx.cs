...
public partial class eReports_S133_eReport_S133 : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            string[] Files = System.IO.Directory.GetFiles(Server.MapPath("~/HSSQE/eReports/S133"), "*.zip");
    ...
    private void BindDetails()
    {
        ...
        string SQL = "SELECT VESSELName FROM [DBO].VesselMaster WHERE VESSELCode ='" + VesselCode + "' ";
    ...
    private void BindRegisters()
    {
        ...
        ProjectCommon.LoadRegisters(chklstsec13HA, "S115", 13);
        ProjectCommon.LoadRegisters(chklstsec13Cond, "S115", 14);
        ProjectCommon.LoadRegisters(chklstsec13HF, "S115", 15);
        ProjectCommon.LoadRegisters(chklstsec13JF, "S115", 16);
    }
    ...
    protected void FinalSave()
    {
        try
        {
            ...
            if (chksec15INMSeveritySignificant.Checked)
            {
            ...
            Common.Set_Parameters(
                ...
                new MyParameter("@NMSEVERITY", (chksec15INMSeveritySignificant.Checked) ? "S" : "M"),
