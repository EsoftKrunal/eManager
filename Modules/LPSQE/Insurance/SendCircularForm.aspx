...
<body>
    ...
    <asp:UpdatePanel ID="UP1"  runat="server" >
        <ContentTemplate>
            ...
            <tr>
                <td style="background-color:#4371a5; height: 23px;text-align :center; font-size:15px;" class="text"  >
                        ...
                        <tr>
                            ...
                            <td valign="top">                                
                                <table width="100%" cellpadding="3" cellspacing="0" border="1" style="border-collapse:collapse; margin-top:20px;" rules="all" >
                                        ...
                                        <tr style="background-color:#DEDEDE; color:White; font-weight:bold;">
                                            <td>Vessel</td>
                                            <td>Sent By</td>
                                            <td>Sent On</td>
                                            <td>Ack Recd</td>
                                            ...
                                            <ItemTemplate>
                                                <tr>
                                                    ...
                                                    <td style="text-align:center;">
                                                        <asp:CheckBox ID="chkAckReceice" runat="server" OnCheckedChanged="chkAckReceice_OnCheckedChanged" AutoPostBack="true" Enabled='<%#Eval("Ack_rec").ToString().Trim()=="true"%>'  style="float:left; padding-left:15px;" ToolTip="Click to Receive Acknowledge" Checked='<%#Eval("Ack_rec").ToString().Trim()!="true"%>'/>   
                                                        <asp:ImageButton ID="imgViewComments" runat="server" ImageUrl="~/Images/magnifier.png"  Visible='<%#Eval("Ack_rec").ToString().Trim()!="true"%>' style="float:right; padding-right:15px;" OnClick="imgViewComments_OnClick" ToolTip="View Comments" />
                                                    </td>
                                                    <td>
                                                        <%#Eval("Ack_by")%>
                                                    </td>
        ...
        <center>
            ...
            <div style="position :relative; width:700px; height:160px; padding :3px; text-align :center; border :solid 1px #4371a5; background : white; z-index:150;top:150px;opacity:1;filter:alpha(opacity=100)">
