<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RestHourEntry.aspx.cs" Inherits="VIMS_RestHourEntry" Trace="false" %>
    ...
    <div style="text-align: center" id="content">
        <table style="margin:0 auto; width:100%;" cellpadding="5" border="1" class="bordered">
            ...
            <tr>
                ...
                <td style="text-align:right"><b> Relief Due Dt :</b></td>
                <td style="text-align:left"><asp:Label runat="server" ID="lblReliefDueDt"  ></asp:Label></td>
            ...
            <asp:DropDownList runat="server" ID="ddlYear" CssClass="control" AutoPostBack="true" OnSelectedIndexChanged="ddlMonthYear_Changed"></asp:DropDownList>
                ...
                <asp:Button ID="btnExport" runat="server" Text="Export" OnClick="btnExport_OnClick" CssClass="btn1" Width="100px" />
            </div>
        ...
        <div style="padding:0px 50px 0px 50px; ">
            ...
            <div>
                <asp:Button runat="server" ID="btnsave" Text=" Save " CssClass="btn1" OnClientClick="return ReadytoSave();" OnClick="btnsave_Click" />
                 ...
                 <input type="button" class="btn2" value="Close" onclick="window.close();"/>
            </div>
        </div>
    </div>
                        ...
                        <div style="border:solid 1px #666767; height:162px;">
                            <table width="100%" cellpadding="8" cellspacing="2" style="background:#666767;color:white;">
                                 ...
                                 <table width="100%" cellpadding="2" cellspacing="2" rules="none">
                                     <tr>
                                         <td>
                                             <asp:TextBox ID="txtRemarks" runat="server" TextMode="MultiLine" Width="99%" Height="80px"></asp:TextBox>
                                         </td>
         ...
         <%----------------------------------------------------------------------------------------------------------------------------------%>
            ...
            <center>
                    <table cellpadding="5" cellspacing="5" border="0" width="100%" style="text-align:center;">
                        <tr>
                            <td  >
                                <span style="font-size:18px;font-weight:bold;color:#333;"> Please enter your date of birth </span>
                            </td>
                        </tr>
                        <tr>
                            <td>
