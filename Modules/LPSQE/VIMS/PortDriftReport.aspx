<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PortDriftReport.aspx.cs" Inherits="PortDriftReport"  Async="true" %>
<%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
<title>Port Drift Report </title>
...
<div style="background-color:#006B8F; color:White;padding:8px; font-size:14px;text-align:center;">Port Drifting Report</div>
            ...
            <td style="background-color:#FFFFFF; border:solid 1px #006B8F;">
                   <table cellpadding="0" cellspacing="3" border="0" width="100%" >
                        ...
                        <tr>
                            ...
                            <td >
                                <asp:TextBox ID="txtArrivalPort" runat="server" MaxLength="50" 
                        ...
                        <tr>
                            ...
                            <td style="width:320px">
                                ...
                                <asp:RequiredFieldValidator runat="server" id="RequiredFieldValidator40" ControlToValidate="txtCdDrifting" ErrorMessage="Comm'd  Drifting is required." Text="*"></asp:RequiredFieldValidator>
                                ...
                                <asp:RequiredFieldValidator runat="server" id="RequiredFieldValidator43" ControlToValidate="ddlCdDriftingHours" ErrorMessage="Comm'd  Drifting Hrs is required." Text="*"></asp:RequiredFieldValidator>
                                ...
                                <asp:RequiredFieldValidator runat="server" id="RequiredFieldValidator44" ControlToValidate="ddlCdDriftingMin" ErrorMessage="Comm'd  Drifting Min is required." Text="*"></asp:RequiredFieldValidator>
