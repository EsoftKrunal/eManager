...
public partial class NoonReport : System.Web.UI.Page
{
    ...
    {
        DataTable dt = Common.Execute_Procedures_Select_ByQuery("SELECT * FROM DBO.VSL_VPRNoonReport WHERE NoonId=" + Key + " And VesselID='" + CurrentVessel + "'");
    ...
    public bool SaveRecord()
    {
        ...
        decimal AvgSpeed = Distance / Time_Hrs;
        //==================================
        ...
        bool res = false;
        Common.Set_Procedures("DBO.SHIP_VPR_InsertUpdate_VPRNoonReport");
        Common.Set_ParameterLength(137);
        Common.Set_Parameters(
        new MyParameter("@NoonID", Key),
    ...
    protected void btnSaveClick(object sender, EventArgs e)
    {
        ...
        if (dt.Rows.Count > 0)
        {
            ...
            {
                ShowMessage("Noon report can be created only after departure report OR noon report.", true);
                return;
            }
