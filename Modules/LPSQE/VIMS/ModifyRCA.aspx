...
<body style="font-family:Calibri; font-size:13px;">
    ...
    <td style="width:50%;">
        <table cellspacing="0" rules="none" border="0" cellpadding="2" style="width:100%;border-collapse:collapse;">
            ...
            <tr>
                <td>
                    <i style="font-size:11px;color:red;">Following Emergency Equipment to be tested and kept standby for use during emeregency situation while this operation is in progress(describe equipment here):</i>
    ...
    <td >
        <table cellspacing="0" rules="none" border="0" cellpadding="2" style="width:100%;border-collapse:collapse;">
            <tr>
                <td style="background-color:#DDDDDD; text-align:left;"><b>Approver Name/ Position :</b>&nbsp;[ 
                    <asp:Label ID="lblApproverName" runat="server"></asp:Label>  
                    
                    ] <asp:Label ID="lblOVMessage" style='color:red' runat="server"></asp:Label></td>
            </tr>
            <tr>
                <td>
