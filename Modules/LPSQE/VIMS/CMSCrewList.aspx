<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CMSCrewList.aspx.cs" Inherits="PMS_UserControls_CMSCrewList" %>
    ...
    <div style="padding:5px; background-color:#FFFFCC; text-align:left; position:fixed;bottom:0px; width:100%;" id="dvfooter">
     ...
     <mtm:footer ID="footer1" runat ="server" />
        ...
        <script type="text/javascript">
            ...
            //    $("#dv_FocusCamp_List").css("margin-top", $("#dvheader").height()+30);
