<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LFI.aspx.cs" Inherits="LFI"  Async="true" %>
...
<td style="text-align:right">
      <asp:Button runat="server" ID="btnShowImport" Text="Import LFI/LET" onclick="btnShowImport_Click" style=" background-color:#00ABE1; color:White; border:solid 1px grey;" />
    </td>
</tr>
</table>
<div style="height:25px; overflow-y:scroll;overflow-x:hidden;border:solid 1px #00ABE1;">
<table width="100%" border="1" cellpadding="3" cellspacing="0" style="background-color:#00ABE1;height:25px;  border-collapse:collapse;" bordercolor="white">
<thead>
<tr style='color:White;height:25px;   '>
        ...
        <td style="width:80px;text-align:center;color:White;"><b>LFI / LET #</b></td>
        <td style="color:White;"><b>Title</b></td>
        <td style="width:80px;color:White;text-align:center;"><b>LFI / LET Dt</b></td>
        <td style="width:200px;color:White;text-align:center;"><b>LFI / LET Categories</b></td>
...
<div style="height:405px; border-bottom:none; border:solid 1px #00ABE1; overflow-x:hidden; overflow-y:scroll;" class='ScrollAutoReset' id='dv_LFI_List'>
...
<tr class='LFI_<%#Eval("Status")%>' onmouseover="">
       <td style="width:70px;text-align:center;">
        <asp:ImageButton runat="server" ID="btndownload" ImageUrl="~/Images/paperclip.gif" OnClick="btnDownloadFile_Click" CommandArgument='<%#Eval("LFIId")%>'/>
      </td>
      <td style="width:70px;text-align:center;">
        <asp:ImageButton runat="server" ID="btnClosure" Visible='<%#(Eval("Closure").ToString().Trim()=="")%>' ImageUrl="~/Images/approved.png" OnClick="btnShowClosure_Click" CommandArgument='<%#Eval("LFIId")%>'/>
      ...
      <td><%#Eval("Title")%></td>
      <td style="width:80px;text-align:center;"><%#Common.ToDateString(Eval("LFIDate"))%></td>
      <td style="width:200px;text-align:left;"><%#Eval("LFICATS")%></td>
      <td style="width:120px;text-align:center;">
      <asp:ImageButton runat="server" ID="btnExport" CssClass='<%#Eval("LFINumber")%>' Visible='<%#(Eval("Closure").ToString().Trim()!="")%>'  ImageUrl="~/Images/icon_zip.gif" OnClick="btnExport_Click" CommandArgument='<%#Eval("LFIId")%>'/>
...
<div style="position:absolute;top:0px;left:0px; height :470px; width:100%; " id="dv_Closure" runat="server" visible="false">
    <center>
        ...
        <div style="position:relative;width:600px;  height:220px;padding :5px; text-align :center;background : white; z-index:150;top:100px; border:solid 0px black;">
            <center >
             <div style="padding:6px; background-color:#00ABE1; font-size:14px; color:#fff;"><b>LFI / LET Closure</b></div>
    ...
    <center>
        ...
        <div style="position:relative;width:600px;  height:120px;padding :5px; text-align :center;background : white; z-index:150;top:100px; border:solid 0px black;">
            <center >
             <div style="padding:6px; background-color:#00ABE1; font-size:14px; color:#fff;"><b>LFI / LET Import</b></div>
