...
<body>
    ...
    <div style="padding:5px; text-align:center;">
                <asp:Button ID="btnAddRemarks" runat="server" CssClass="style5" OnClick="btnAddRemarks_Click" Text="Add Remarks" Width="100px" />
                
                <asp:Button ID="btnSave" runat="server" CssClass="style5" OnClick="btnSave_Click" Text="Save Defect" Width="100px" />
                <asp:Button ID="btnOpenPopupCloseDefect" runat="server" CssClass="style5" OnClick="btnOpenPopupCloseDefect_Click" Text="Close Defect" Width="100px" />
