...
public partial class PortBerthingReport : System.Web.UI.Page
{
    ...
    {
        DataTable dt = Common.Execute_Procedures_Select_ByQuery("SELECT * FROM DBO.VSL_VPRPortBerthingReport WHERE BerthingID=" + Key + " And VesselID='" + CurrentVessel + "'");
    ...
    public bool SaveRecord()
    {
        ...
        bool res = false;
        Common.Set_Procedures("SHIP_VPR_InsertUpdate_VPRPortBerthingReport");
        Common.Set_ParameterLength(70);
        Common.Set_Parameters(
        new MyParameter("@BerthingID", Key),
        ...
        new MyParameter("@ETBDT", DBNull.Value),
        new MyParameter("@ETBHOURS", 0),
        new MyParameter("@ETBMIN", 0),
