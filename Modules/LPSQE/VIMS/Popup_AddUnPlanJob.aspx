...
<body style=" margin:10px;">
    ...
    <asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server"></asp:ToolkitScriptManager>
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="border: gray 1px solid; text-align:center; border-collapse:collapse" width="100%">
            <tr>
                <td align="center" style="height: 23px; text-align :center; padding-top :5px;" class="pagename" >                     
                    Add/Edit Un - Planned Job </td>
            </tr>
            <tr>
                <td align="left">
                            ...
                            <td align="left">
                                <table style="width:100%;">
                                    <tr runat="server" id="trOthers">
                                        ...
                                        <div class="pagename"> Job Execution </div>
                                                          ...
                                                          <table cellpadding="0" cellspacing="0" width="100%" id="tblAddSpareSection" runat="server">
                                                              <tr>
                                                                  <td style="text-align:right; vertical-align:middle;">
                                                                      ...
                                                                      &nbsp;<asp:ImageButton ID="imgAddSpare" runat="server" ImageUrl="~/Images/add.png" 
                                                                  ...
                                                                  <td style="vertical-align:middle;">
                                                                      <asp:Button ID="btmCancelSpareAddSection" runat="server" onclick="btmCancelSpareAddSection_Click" Text="Cancel" CssClass="btnorange"  style="float:right;" />
                                                                      <asp:Button ID="btnAddSpare" runat="server" CssClass="btnorange" onclick="btnAddSpare_Click" style="width:100px;float:right;margin-right:3px;" Text="Add Spare" />
                                                                              ...
                                                                              <% if(Modify)                                                                                  
                                                                                  { %>
                                                                                        <table cellpadding="2" cellspacing="0" border="0">
                                                                                            <tr>
                                                                                                <td>
                                                                                                    <asp:ImageButton ID="imgEdit1" runat="server" CommandArgument='<%#Eval("RowId") %>' Height="12px" ImageUrl="~/Images/edit.png" OnClick="imgEditSpare_OnClick" ToolTip="Edit"  />
                                                                                                </td>
                                                                                                <td>
                                                                                                    <asp:ImageButton ID="imgDel1" runat="server" CommandArgument='<%#Eval("RowId") %>' Height="12px" ImageUrl="~/Images/delete.png" OnClick="imgDel_OnClick"  OnClientClick="javascript:return confirm('Are you sure to delete?');" />
                                                                                                </td>
                                                                                            </tr>
                                                                                        </table>
                                                                                  ...
                                                                                  {%>
                                                                                    ...
                                                                                    <% if (Request.QueryString["DN"] == null)
                                                                                      ...
                                                                                      <table cellpadding="2" cellspacing="0" border="0">
                                                                                        <tr>
                                                                                            <td>
                                                                                                <asp:ImageButton ID="imgEdit" runat="server"  Visible='<%#(Session["UserType"]=="S" && txtDoneDate.Text.Trim()=="")%>' CommandArgument='<%#Eval("RowId") %>' Height="12px" ImageUrl="~/Images/edit.png" OnClick="imgEditSpare_OnClick" ToolTip="Edit"  />
                                                                                            </td>
                                                                                            <td>
                                                                                                  <asp:ImageButton ID="imgDel" runat="server" 
                                                                                                      CommandArgument='<%#Eval("RowId") %>' Height="12px" Visible='<%#(Session["UserType"]=="S" && txtDoneDate.Text.Trim()=="")%>'
                                                                                                      ImageUrl="~/Images/delete.png" OnClick="imgDel_OnClick" 
                                                    ...
                                                    <asp:Repeater ID="rptAttachment" runat="server">
                                                        <ItemTemplate>
                                                            <tr class="row" >
                                                                ...
                                                                <td>
                                                                <asp:ImageButton runat="server" ID="btnDelAttachment" ImageUrl="~/Images/delete.png" Height="12px" Visible='<%#(Session["UserType"]=="S")%>' OnClick="DeleteAttachment_OnClick" title='Delete Attachment' CssClass='<%#Eval("VesselCode")%>' CommandArgument='<%#Eval("TableId")%>' OnClientClick="javascript:confirm('Are you sure to remove this attachment?');" />
                                                                </td>
                                                                <%=(Request.UserAgent.Contains("MSIE 7.0")) ? "<td style='width:17px'></td>" : ""%>
                                                            </tr>
                                                        </ItemTemplate>
