...
public partial class PortAnchoringReport : System.Web.UI.Page
{
    ...
    {
        DataTable dt = Common.Execute_Procedures_Select_ByQuery("SELECT * FROM DBO.VSL_VPRPortAnchorageReport WHERE AnchorageID=" + Key + " And VesselID='" + CurrentVessel + "'");
    ...
    public bool SaveRecord()
    {
        ...
        bool res = false;
        Common.Set_Procedures("SHIP_VPR_InsertUpdate_PortAnchorageReport");
        Common.Set_ParameterLength(65);
        Common.Set_Parameters(
        new MyParameter("@AnchorageID", Key),
