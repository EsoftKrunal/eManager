...
public partial class LFI : System.Web.UI.Page
{
    ...
    protected void Bindgrid()
    {
        ...
        DataTable dt = Common.Execute_Procedures_Select_ByQuery("SELECT LFIID,STATUS,LFINUMBER,LFIDATE,TITLE,ATTACHMENTFILENAME,(SELECT AckOn from LFI_Vessel_Notifications WHERE LFIID=lfi.LFIID AND VESSELCODE='" + CurrentVessel + "') AS CLOSURE,(SELECT dbo.getLFICategories(LFIID)) AS LFICATS from DBO.lfi " + LFICatSQL + " order by LFIDate desc");
