<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PortBerthingReport.aspx.cs" Inherits="PortBerthingReport"  Async="true" %>
<%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
<title>Port Berthing Report </title>
...
<div style="background-color:#006B8F; color:White;padding:8px; font-size:14px;text-align:center;">Port Berthing Report</div>
                   ...
                   <table cellpadding="0" cellspacing="3" border="0" width="100%" >
                        ...
                        <tr>
                            ...
                            <td style="width:320px">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtBerthTerminalName" ErrorMessage="Berth / Terminal name is required." Text="*"></asp:RequiredFieldValidator>
                            </td>
                            ...
                            <td >
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtNoOfTUGSUSED" ErrorMessage="No of TUGS Used is required." Text="*"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="width:320px">
                                ...
                                <asp:RequiredFieldValidator runat="server" id="RequiredFieldValidator40" ControlToValidate="txtFirstLineDate" ErrorMessage="First Line Date is required." Text="*"></asp:RequiredFieldValidator>
                                ...
                                <asp:RequiredFieldValidator runat="server" id="RequiredFieldValidator43" ControlToValidate="ddlFirstLineHH" ErrorMessage="First Line Hrs is required." Text="*"></asp:RequiredFieldValidator>
                                ...
                                <asp:RequiredFieldValidator runat="server" id="RequiredFieldValidator44" ControlToValidate="ddlFirstLineMM" ErrorMessage="First Line Min is required." Text="*"></asp:RequiredFieldValidator>
                            ...
                            <asp:TextBox runat="server" ID="txtAllFastDate" 
                                ...
                                <asp:RequiredFieldValidator runat="server" id="RequiredFieldValidator3" ControlToValidate="txtAllFastDate" ErrorMessage="All Fast Date is required." Text="*"></asp:RequiredFieldValidator>
                        ...
                        <tr>
                            ...
                            <td style="width:320px">
                                ...
                                <asp:RequiredFieldValidator runat="server" id="RequiredFieldValidator41" ControlToValidate="txtETDDateTime" ErrorMessage="ETD Date is required." Text="*"></asp:RequiredFieldValidator>
                            </td>
                            <td style="text-align:right; width:250px">
                                ETD Time :</td>
                            <td >
                                ...
                                <asp:RequiredFieldValidator runat="server" id="RequiredFieldValidator45" ControlToValidate="ddlETDDateTimeHH" ErrorMessage="ETD Hrs is required." Text="*"></asp:RequiredFieldValidator>
                                <span class="unit">( Hrs )</span>
                                ...
                                <asp:RequiredFieldValidator runat="server" id="RequiredFieldValidator46" ControlToValidate="ddlETDDateTimeMM" ErrorMessage="ETD Min is required." Text="*"></asp:RequiredFieldValidator>
                                <span class="unit">( Min )</span> 
                                </td>
                        </tr>
                        </table>
