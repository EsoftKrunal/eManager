<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FC.aspx.cs" Inherits="FC"  Async="true" %>
  ...
  <script type="text/javascript">
      ...
      function Validate_Action() {
          ...
          if (parseInt(val) > 0) {
              ...
              alert("Please select a FocusCamp");
              return false;
          }
      }
      ...
      function OpenProgressWindow(FocusCampid) {
          window.open('FocusCamp_FC_Progress.aspx?Mode=L&Id=' + FocusCampid, '');
      }
</script>
  <style type="text/css">
.accordionHeader {
...
<td width="200px" style="text-align:left">
    <asp:DropDownList runat="server" ID="ddlFocusCampCat" AutoPostBack="true" OnSelectedIndexChanged="Filter_FocusCamp"></asp:DropDownList> 
</td>
<td width="100px" style="text-align:right">From Date :</td>
<td width="120px">
    <asp:TextBox runat="server" id="txtFDate" CssClass="user-input-nopadding" Width="80px" MaxLength="15" AutoPostBack="true" OnTextChanged="Filter_FocusCamp"></asp:TextBox>
...
<td width="120px">
    <asp:TextBox runat="server" id="txtTDate" CssClass="user-input-nopadding" Width="80px" MaxLength="15" AutoPostBack="true" OnTextChanged="Filter_FocusCamp"></asp:TextBox>
...
<td style="text-align:right">
      ...
      <asp:Button runat="server" ID="btnShowImport" Text="Import Focussed Campaign" onclick="btnShowImport_Click" style=" background-color:#00ABE1; color:White; border:solid 1px grey;" />
    </td>
</tr>
</table>
...
<tr style='color:White; height:25px;'>
        ...
        <td style="width:80px;text-align:center;color:White;"><b>FC#</b></td>
        <td style="color:White;"><b>Title</b></td>
        <td style="width:80px;color:White;text-align:center;"><b>FC Date</b></td>
        <td style="width:200px;color:White;text-align:center;"><b>FC Categories</b></td>
...
<table width="100%" border="1" cellpadding="3" cellspacing="0" style="background-color:#F5FCFE; border-collapse:collapse;" class='newformat'>
 <tbody>
<asp:Repeater runat="server" ID="rptFocusCamp">
<ItemTemplate>
<tr class='FocusCamp_<%#Eval("Status")%>' onmouseover="">
       <td style="width:70px;text-align:center;">
        <asp:ImageButton runat="server" ID="btndownload" ImageUrl="~/Images/paperclip.gif" OnClick="btnDownloadFile_Click" CommandArgument='<%#Eval("FocusCampId")%>'/>
      </td>
      <td style="width:70px;text-align:center;">
        <asp:ImageButton runat="server" ID="btnClosure" Visible='<%#(Eval("Closure").ToString().Trim()=="")%>' ImageUrl="~/Images/approved.png" OnClick="btnShowClosure_Click" CommandArgument='<%#Eval("FocusCampID")%>'/>
        <%#(Eval("Closure").ToString().Trim()=="")?"":"Closed"%>
      </td>
      <td style="width:80px;text-align:center;">
          <%#Eval("FocusCampNumber")%>
      </td>
      <td><%#Eval("Title")%></td>
      <td style="width:80px;text-align:center;"><%#Common.ToDateString(Eval("FocusCampDate"))%></td>
      <td style="width:200px;text-align:left;"><%#Eval("FocusCampCATS")%></td>
      <td style="width:120px;text-align:center;">
      <asp:ImageButton runat="server" ID="btnExport" CssClass='<%#Eval("FocusCampNumber")%>' Visible='<%#(Eval("Closure").ToString().Trim()!="")%>'  ImageUrl="~/Images/icon_zip.gif" OnClick="btnExport_Click" CommandArgument='<%#Eval("FocusCampId")%>'/>
...
<div style="position:absolute;top:0px;left:0px; height :470px; width:100%; " id="dv_Closure" runat="server" visible="false">
    <center>
        ...
        <div style="position:relative;width:600px;  height:220px;padding :5px; text-align :center;background : white; z-index:150;top:100px; border:solid 0px black;">
            <center >
             <div style="padding:6px; background-color:#00ABE1; font-size:14px; color:#fff;"><b>Focussed Campaign Closure</b></div>
    ...
    <center>
        ...
        <div style="position:relative;width:600px;  height:120px;padding :5px; text-align :center;background : white; z-index:150;top:100px; border:solid 0px black;">
            <center >
             <div style="padding:6px; background-color:#00ABE1; font-size:14px; color:#fff;"><b>Focussed Campaign Import</b></div>
