<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NoonReport.aspx.cs" Inherits="NoonReport"  Async="true" %>
            ...
            <td style="background-color:#FFFFFF; border:solid 1px #006B8F;">
                   <table cellpadding="0" cellspacing="3" border="0" width="100%" >
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                             <asp:DropDownList runat="server" ID="ddlReportType" Width="300px" AutoPostBack="true" OnSelectedIndexChanged="ddlReportType_OnSelectedIndexChanged" >
                 ...
                 <ContentTemplate>
                   <table cellpadding="0" cellspacing="3" border="0" width="100%" >
                        <tr valign="top">
                            ...
                            <td style="text-align:right; width:250px;"> Stoppage Time :</td>
    ...
    <table cellpadding="4" cellspacing="0" border="0" width="100%" >
                                <col width="170px" />
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox runat="server" onkeypress="FloatValueOnly(this);"  onkeyup="CalTotAuxiliary()" ID="AUX_1_Load" MaxLength="16" style="text-align:right;"></asp:TextBox> 
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox runat="server" onkeypress="FloatValueOnly(this);"  onkeyup="CalTotAuxiliary()" ID="AUX_2_Load" MaxLength="16" style="text-align:right;"></asp:TextBox> 
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox runat="server" onkeypress="FloatValueOnly(this);"  onkeyup="CalTotAuxiliary()" ID="AUX_3_Load" MaxLength="16" style="text-align:right;"></asp:TextBox> 
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox runat="server" onkeypress="FloatValueOnly(this);"  onkeyup="CalTotAuxiliary()" ID="AUX_4_Load" MaxLength="16" style="text-align:right;"></asp:TextBox> 
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox runat="server" onkeypress="FloatValueOnly(this);"  ID="txtA_ENo_1" MaxLength="16" style="text-align:right;"></asp:TextBox>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox runat="server" onkeypress="FloatValueOnly(this);"  ID="txtA_ENo_2" MaxLength="16" style="text-align:right;"></asp:TextBox>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox runat="server" onkeypress="FloatValueOnly(this);"  ID="txtA_ENo_3" MaxLength="16" style="text-align:right;"></asp:TextBox>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox runat="server" onkeypress="FloatValueOnly(this);"  ID="txtA_ENo_4" MaxLength="16" style="text-align:right;"></asp:TextBox>
