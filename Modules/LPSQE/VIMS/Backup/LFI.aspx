...
<td style="text-align:right">
      <asp:Button runat="server" ID="btnShowImport" Text="Import LFI" onclick="btnShowImport_Click" style=" background-color:#00ABE1; color:White; border:solid 1px grey;" />
    </td>
</tr>
</table>
...
<tr style='color:White; height:25px;'>
        ...
        <td style="width:80px;text-align:center;color:White;"><b>LFI#</b></td>
        <td style="color:White;"><b>Title</b></td>
        <td style="width:80px;color:White;text-align:center;"><b>LFI Date</b></td>
        <td style="width:200px;color:White;text-align:center;"><b>LFI Categories</b></td>
...
<div style="position:absolute;top:0px;left:0px; height :470px; width:100%; " id="dv_Closure" runat="server" visible="false">
    ...
    <center>
        ...
        <div style="position:relative;width:600px;  height:120px;padding :5px; text-align :center;background : white; z-index:150;top:100px; border:solid 0px black;">
            <center >
             <div style="padding:6px; background-color:#00ABE1; font-size:14px; color:#fff;"><b>LFI Import</b></div>
