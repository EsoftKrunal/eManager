<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VimsInspections.aspx.cs" Inherits="VIMS_VimsInspections" %>
    ...
    <asp:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server"></asp:ToolkitScriptManager>
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="border: #4371a5 1px solid;" width="100%">
            ...
            <tr>
                ...
                <div style="height:445px; border-right:solid 1px black; width:100%;oveflow-y:scroll; overflow-x:hidden;" class="scrollbox" onscroll="SetScrollPos(this)" id="dv_Inspections">
                ...
                <div style="height:360px; overflow-y:scroll; overflow-x:hidden; border-bottom:solid 1px gray; width:100%;">
