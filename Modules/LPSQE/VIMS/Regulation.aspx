<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Regulation.aspx.cs" Inherits="Regulation"  Async="true" %>
...
<td width="100px" style="text-align:left">
    <asp:DropDownList runat="server" ID="ddlREGCat" AutoPostBack="true" Width="90px" OnSelectedIndexChanged="Filter_LFI"></asp:DropDownList> 
</td>
<td style="text-align:right; width:220px;">Source (Main) :</td>
<td width="110px" style="text-align:left">
    <asp:DropDownList runat="server" ID="ddlMainSource_Filter" AutoPostBack="true" Width="100px" OnSelectedIndexChanged="ddlMainSource_Filter_SelectedIndexChanged"></asp:DropDownList> 
</td>
<td style="text-align:right; width:220px;">Source (Sub) :</td>
<td width="110px" style="text-align:left">
    <asp:DropDownList runat="server" ID="ddlSubSource_Filter" AutoPostBack="true" Width="100px" OnSelectedIndexChanged="Filter_LFI"><asp:ListItem Text="< Select >" Value="0"></asp:ListItem></asp:DropDownList> 
</td>
...
<td width="140px" style="text-align:right">From Date :</td>
<td width="100px">
...
<td style="text-align:right">
      <asp:Button runat="server" ID="btnShowImport" Text="Import Regulation" onclick="btnShowImport_Click" style=" background-color:#00ABE1; color:White; border:solid 1px grey;" />
    </td>
</tr>
</table>
...
<div style="height:390px; border-bottom:none; border:solid 1px #00ABE1; overflow-x:hidden; overflow-y:scroll;" class='ScrollAutoReset' id='dv_LFI_List'>
<table width="100%" border="1" cellpadding="3" cellspacing="0" style="background-color:#F5FCFE; border-collapse:collapse;" class='newformat'>
 <tbody>
<asp:Repeater runat="server" ID="rptREG">
<ItemTemplate>
<tr class='LFI_<%#Eval("Status")%>' onmouseover="">
       <td style="width:70px;text-align:center;">
        <asp:ImageButton runat="server" ID="btndownload" ImageUrl="~/Images/paperclip.gif" OnClick="btnDownloadFile_Click" CommandArgument='<%#Eval("RegId")%>'/>
      </td>
      <td style="width:70px;text-align:center;">
        <asp:ImageButton runat="server" ID="btnClosure" Visible='<%#(Eval("Closure").ToString().Trim()=="")%>' ImageUrl="~/Images/approved.png" OnClick="btnShowClosure_Click" CommandArgument='<%#Eval("RegId")%>'/>
      ...
      <asp:ImageButton runat="server" ID="btnExport" CssClass='<%#Eval("REGNumber")%>' Visible='<%#(Eval("Closure").ToString().Trim()!="")%>'  ImageUrl="~/Images/icon_zip.gif" OnClick="btnExport_Click" CommandArgument='<%#Eval("RegId")%>'/>
...
<div style="position:absolute;top:0px;left:0px; height :470px; width:100%; " id="dv_Closure" runat="server" visible="false">
    <center>
        ...
        <div style="position:relative;width:600px;  height:220px;padding :5px; text-align :center;background : white; z-index:150;top:100px; border:solid 0px black;">
            <center >
             <div style="padding:6px; background-color:#00ABE1; font-size:14px; color:#fff;"><b>Regulation Closure</b></div>
    ...
    <center>
        ...
        <div style="position:relative;width:600px;  height:120px;padding :5px; text-align :center;background : white; z-index:150;top:100px; border:solid 0px black;">
            <center >
             <div style="padding:6px; background-color:#00ABE1; font-size:14px; color:#fff;"><b>Regulation Import</b></div>
