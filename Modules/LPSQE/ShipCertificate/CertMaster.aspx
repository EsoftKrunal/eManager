<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CertMaster.aspx.cs" Inherits="Registers_CertMaster"  %>
                       ...
                       <asp:GridView ID="GridView_CertCat" GridLines="Horizontal" runat="server" 
                         ...
                         <Columns>
                              ...
                              <asp:TemplateField HeaderText="Edit">
                                    ...
                                    <ItemTemplate>
                                    <asp:ImageButton ID="btnEditCert" CausesValidation="false" OnClick="btnEditCert_click"
                                    ImageUrl="~/Modules/HRD/Images/edit.jpg" runat="server" ToolTip="Edit" 
                                    CommandArgument='<%#Eval("CertId")%>' />
                                    <asp:HiddenField ID="hdnCertId" runat="server" Value='<%#Eval("CertId")%>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                               ...
                               <ItemTemplate>  
                                   <asp:Label ID="lblCertCatName" runat="server" Text='<%#Eval("CertName")%>'></asp:Label>
                                   <asp:HiddenField ID="CertCatId" runat="server" Value='<%#Eval("CertId")%>' />
                               </ItemTemplate>
                               </asp:TemplateField>
                               <asp:BoundField DataField="CertCode" HeaderText="Certificate Code"><ItemStyle HorizontalAlign="Left" Width="150px" /></asp:BoundField>
                               <asp:BoundField DataField="CategoryName" HeaderText="Category Name"><ItemStyle HorizontalAlign="Left" Width="150px" /></asp:BoundField>
                               <asp:BoundField DataField="SubCategoryName" HeaderText="Sub Category Name"><ItemStyle HorizontalAlign="Left" Width="150px" /></asp:BoundField>
                          ...
                          <td style="text-align: left; height: 13px;">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="right" style="text-align: right;padding-right:15px">
                                                                    Certificate Code :</td>
                                                                <td style="text-align: left">
                                                                    <asp:TextBox ID="txtCertCatCode" runat="server" CssClass="required_box" 
                                                                        MaxLength="10" TabIndex="1" Width="117px"></asp:TextBox>
                                                                        <asp:CheckBox runat="server" id="chk_NoExpired" Text="No Expiry"  />
                                                                    &nbsp;</td>
                                                            </tr>
                      <tr>
                          ...
                          <td style="text-align: left">
                              <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" 
                                  ControlToValidate="txtCertCatCode" ErrorMessage="Required"></asp:RequiredFieldValidator>
                          </td>
                      </tr>
                                                            <tr>
                                                                <td align="right" style="text-align: right; padding-right:15px">
                                                                    Category :</td>
                                                                <td style="text-align: left">
                                                                    <asp:DropDownList ID="ddlCat" AutoPostBack ="true" runat="server" CssClass="required_box" TabIndex="2" Width="240px" OnSelectedIndexChanged="Cert_OnSelectedIndexChanged">
                                                                    </asp:DropDownList>
                                                                </td>
                                                                <td align="right" style="text-align: right; padding-right:15px">
                                                                    Sub Category :</td>
                                                                <td style="text-align: left">
                                                                    <asp:DropDownList ID="ddlSubCat" runat="server" CssClass="input_box" 
                      ...
                      <tr>
                          ...
                          <td style="text-align: left">
                              <asp:CompareValidator ID="CompareValidator1" runat="server" 
                                  ControlToValidate="ddlCat" ErrorMessage="Required" Operator="NotEqual" 
