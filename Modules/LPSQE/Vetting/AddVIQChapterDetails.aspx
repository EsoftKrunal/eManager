<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddVIQChapterDetails.aspx.cs" Inherits="VIMS_AddVIQChapterDetails" %>
...
<body>
    ...
    <tr>
       ...
       <div style="padding:5px; background-color:#444444; height:35px;" >
            <asp:Button runat="server" ID="btnAddTOVIQ" Text="Add to VIQ Bin" CausesValidation="false" CssClass="Btn1" ValidationGroup="gg" OnClick="btnAddTOVIQ_Click" OnClientClick="DisableMe(this);" style="float:right"/>
