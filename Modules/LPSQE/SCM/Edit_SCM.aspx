<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Edit_SCM.aspx.cs" Inherits="HSSQE_Edit_SCM" Title="Edit SCM" %>
    ...
    <asp:UpdatePanel ID="UP1"  runat="server" >
        <ContentTemplate>
                            ...
                            <tr>
                                <td>
                                    <b>Compliance with Regulations and Standards :  </b>
                                        <%--<asp:Label ID="" runat="server"></asp:Label>--%>
                                        <asp:TextBox ID="txtSUPTD_CompliancewithRegulations" runat="server" TextMode="MultiLine" ReadOnly="true" style="width:100%;" onfocus="javascript:this.style.height='200px';" onblur="javascript:this.style.height='30px';" ></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <b>Deviations from safety procedures and safety routines observed during the visit :  </b>
                                        <%--<asp:Label ID="" runat="server"></asp:Label>--%>
                                        <asp:TextBox ID="txtSUPTD_DeviationsfromSafety" runat="server" TextMode="MultiLine" ReadOnly="true" style="width:100%;" onfocus="javascript:this.style.height='200px';" onblur="javascript:this.style.height='30px';" ></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <b>Details of Training Conducted during the visit. :  </b>
                                        <%--<asp:Label ID="" runat="server"></asp:Label>--%>
                                        <asp:TextBox ID="txtSUPTD_DetailsofTraining" runat="server" TextMode="MultiLine" ReadOnly="true" style="width:100%;" onfocus="javascript:this.style.height='200px';" onblur="javascript:this.style.height='30px';" ></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <b>Health, Safety and Welfare Measures :  </b>
                                        <%--<asp:Label ID="" runat="server"></asp:Label>--%>
                                        <asp:TextBox ID="txtSUPTD_HealthSafetyMeasures" runat="server" TextMode="MultiLine" ReadOnly="true" style="width:100%;" onfocus="javascript:this.style.height='200px';" onblur="javascript:this.style.height='30px';" ></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <b>Suggestions for Improvement :  </b>
                                        <%--<asp:Label ID="" runat="server"></asp:Label>--%>
                                        <asp:TextBox ID="txtSUPTD_Suggestions" runat="server" TextMode="MultiLine" ReadOnly="true" style="width:100%;" onfocus="javascript:this.style.height='200px';" onblur="javascript:this.style.height='30px';" ></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <b>Best Practice Indentified :  </b>
                                        <%--<asp:Label ID="" runat="server"></asp:Label>--%>
                                        <asp:TextBox ID="txtSUPTD_BPI" runat="server" TextMode="MultiLine" ReadOnly="true" style="width:100%;" onfocus="javascript:this.style.height='200px';" onblur="javascript:this.style.height='30px';" ></asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <b>Any other issues :  </b>
                                        <%--<asp:Label ID="" runat="server"></asp:Label>--%>
                                        <asp:TextBox ID="txtSUPTD_AnyOtherTopic" runat="server" TextMode="MultiLine" ReadOnly="true" style="width:100%;" onfocus="javascript:this.style.height='200px';" onblur="javascript:this.style.height='30px';" ></asp:TextBox>
                                </td>
                            </tr>
                        </table>    
                    </div>
            ...
            <div style="padding-right:5px;"> 
                <asp:Button ID="btnModify" runat="server" OnClick="btnModify_OnClick" Text="Modify" style="float:right; padding:5px; margin-top:4px; width:100px;"/>
                </div>
            </center>                 
            </div>        
        </ContentTemplate>
