<%@ Page Language="C#"  AutoEventWireup="true" CodeFile="VesselReportsMapping.aspx.cs" Inherits="LPSQE_Register_VesselReportsMapping" Title="VesselReports" %>
        ...
        <center>
            ...
            <ContentTemplate>
                <table cellpadding="5" cellspacing="0" border="0" width="100%" style="border:solid 1px #c2c2c2">
                    ...
                    <col />
                    <tr>
                        <td class="txt headerband " style="text-align:center;" colspan="2" > <b>Add Report</b> </td>
                    </tr>
                    <tr>
                        <td  style="text-align:center;" colspan="2" > <asp:Label ID="lblMessage2" runat="server" ForeColor="Red" Text=""></asp:Label> </td>
                    </tr>
                    <tr>
                          <td >Group :</td>
                    ...
                    <tr id="trVessels" runat="server" >
                          ...
                          <td style="text-align: left"> 
                              <div class="input_box" style="overflow-y: scroll; overflow-x: hidden;height: 170px; width: 100% ;text-align:left;padding-left: 5px;padding-right:5px;">
                                        <asp:CheckBoxList ID="chklst_Vessel" runat="server" RepeatColumns="2" RepeatDirection="Horizontal" Width="95%" >
                         ...
                         <div style="overflow-x:hidden;overflow-y:hidden; height:190px; width:200px;border :solid 1px #4371a5; float:left;">
                          ...
                          <ul style='margin:0px; padding-left:10px; list-style-type:none;' id="ul_Allvessels">
                              ...
                              <ItemTemplate>
                                <li><%#Eval("VesselName")%>
                                <asp:ImageButton ID="ImageButton1" ImageUrl="~/Modules/HRD/Images/right-arrow_12.png" runat="server" OnClick="Add_Vessel" CommandArgument='<%#Eval("VesselId")%> ' style="float:right;margin:2px;" /></li>
                          ...
                          <div style="overflow-x:hidden;overflow-y:scroll; height:170px; width:100%;">
                              ...
                              <ItemTemplate>
                                <li><%#Eval("VesselName")%> 
                                <asp:ImageButton ImageUrl="~/Modules/HRD/Images/left_24.png" runat="server" OnClick="Delete_Vessel" CommandArgument='<%#Eval("VesselId")%> ' style="float:left;margin:2px;"/></li>
                                <div style="clear:both"></div>
                              </ItemTemplate>
                              </asp:Repeater>
                              </ul>
