...
public partial class Print : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        else if (Page.Request.QueryString["IsVendor"] != null)
        {
            ShowVendorReport();
        }
    ...
    public void ShowVendorReport()
    {
       ...
       // string Active = Page.Request.QueryString["Active"].ToString();
        ...
        string Email = Page.Request.QueryString["Email"].ToString();
        ...
        if (Email != "")
        {
            WhereClause = WhereClause + " and SupplierEmail like '" + Email + "%'";
        }
        ...
        rpt.Load(Server.MapPath("~/Modules/Purchase/Report/Vendor.rpt"));
    ...
    public void ShowCrystalReportForRFQ()
    {
        ...
        CrystalReportViewer1.ReportSource = rpt;
        //rpt.Load(Server.MapPath("~/Report/PrintRFQ.rpt"));
        rpt.Load(Server.MapPath("~/Modules/Purchase/Report/PrintOfficeRFQ.rpt"));
