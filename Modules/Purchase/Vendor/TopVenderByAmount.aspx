<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TopVenderByAmount.aspx.cs" Inherits="TopVenderByAmount" EnableEventValidation="false" %>
...
<head id="Head1" runat="server">
    <title>POS : Top 10 Vendors By No of Amount </title>
...
<div class="header">
        <div style="text-align: center; padding: 8px; background-color: #06203b; color: White; font-size:16px;">
            <b> Top 10 Vendors By No of Amount </b>
        </div>
        ...
        <div class="leftpane">
            ...
            <table width="100%" cellspacing="0" cellpadding="7" border="0" class="bordered">
                            ...
                            <tr style="cursor:pointer" class="trvessel" supplierid='<%#Eval("SupplierID")%>'>
                                ...
                                <td style="text-align:right;padding-right:5px;" class="SpanTotal" > <%#Eval("Amount") %> </td>                                                                            
                            </tr>
                            </ItemTemplate>
                            </asp:Repeater>
                        </table>
