...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function PrintVendor() {
           ...
           // var Active = document.getElementById('ddlType').value;
            var AppType = document.getElementById('ddlType').value;
            var Email = document.getElementById('txtEmail').value;
            window.open('Print.aspx?IsVendor=1&Vendor=' + Vendor + '&AppType=' + AppType + '&Email=' + Email + '', '', '');
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="text headerband">Vendors in Approval / Evaluation Process</div>
        ...
        <div style="width:100% ; height:275px; OVERFLOW-Y: scroll; OVERFLOW-X:hidden ;">
                    ...
                    <ItemTemplate>
                            <tr >
                                ...
                                <td style="text-align:center">
                                   ...
                                   <a target="_blank" href='<%#"ModifyVendorProfile.aspx?KeyId=" + Eval("VRID").ToString()%>'><img src="../../HRD/Images/addpencil.gif" style="height:12px; border:none;"/></a>			 	     			
                                   <asp:ImageButton ID="ImgEmail" runat="server" tooltip="Email to vendor" Width="12px" CommandArgument='<%#Eval("VRID")%>' OnClick="btnEmailToVendor_Click" ImageUrl="~/Modules/HRD/Images/email.png" ></asp:ImageButton>                                 
                                </td>
                                <td>&nbsp;</td>
                            </tr>
                    </ItemTemplate>
