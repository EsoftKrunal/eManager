<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Home.aspx.cs" Inherits="Invoice_Home" MasterPageFile="~/MasterPage.master" %>
...
//             alert(getvalue);
             var hf = document.getElementById("ctl00_ContentMainMaster_hfInvId");
                ...
                <td valign="top" style="border:solid 1px #4371a5; height:477px;">
                    ...
                    <table cellpadding="5" cellspacing="0" width="100%">
                        <tr>
                            ...
                            <td class="text headerband">Invoice Register</td>
                        </tr>
                    </table>
                            ...
                            <tr>
                                ...
                                <td width="40%" style="padding-left :10px;" >
                                     <table width="100%" cellpadding="0" cellspacing ="0" border="0">
                                       ...
                                       <tr >
                                            <td style="text-align :left" valign="top">
                                                <div runat="server" id="trAdd">
                                                    ► <a href="#" id="AddInvoice" onclick="OpenAddWindow();" ><span style="color:#2A5D94; font-size:12px;">Add Invoice</span></a>
                                                    <asp:Button ID="btnAddInvoice" runat="server" style="display:none;" onclick="btnAddInvoice_Click" CausesValidation="false"/>           
                                                </div>
                                       ...
                                       <tr>
                                            <td style="text-align :left" valign="top">
                                                ► <a id="FindInvoice" href="FindInvoice.aspx" target="_blank" ><span style="color:#2A5D94; font-size:12px;">Find Invoice</span></a>
                                                <asp:Button ID="btnFindInvoice" runat="server" style="display:none;" onclick="btnFindInvoice_Click" CausesValidation="false"/>           
                                       ...
                                       <%-- <tr runat="server" id="trAdmin">
                                        ...
                                        <tr runat="server" id="trClaim" visible="false">
                                            <td style="text-align :left" valign="top">
                                                ► <a href="ExpenseClaim.aspx" id="A2" target="_blank"><span style="color:#2A5D94; font-size:12px;">Expense Claim</span></a>
                                                <br />
                                                
                                            </td>
                                           
                                        </tr>
<tr runat="server" id="trNonPoData" visible="false">
                                            <td style="text-align :left" valign="top">
                                                ► <a href="NonPoData.aspx" id="tdNonPoData" target="_blank"><span style="color:#2A5D94; font-size:12px;">Non-PO AP Entry</span></a>
                                                <br />
                                             ...
                                             <td style="vertical-align:top">
                                                 <table width="100%" cellpadding="2" cellspacing ="0" border="0">
                                                      <tr runat="server" id="trRFP">
                                                         <td style="text-align :left" valign="top">
                                                 <div>
                                                    ► <a href="RFPRequestList.aspx" id="AA1" target="_blank"><span style="color:#2A5D94; font-size:12px;">RFP Approval</span></a>
                                                </div>
                                                </td>
                                                     </tr>
                                                 ...
                                                 <div>
                                                    ► <%--<a href="PaymentVoucherList.aspx" id="A1" target="_blank"><span style="color:#2A5D94; font-size:12px;">Payment</span></a>--%>
                                                     <a href="BankDetails.aspx" id="A13" target="_blank"><span style="color:#2A5D94; font-size:12px;">Bank Update</span></a>
                                                       ...
                                                       <tr  runat="server" id="trVendorLedger">
                                            <td style="text-align :left" valign="top">
                                                 <div>
                                                    ► <%--<a href="PaymentVoucherList.aspx" id="A1" target="_blank"><span style="color:#2A5D94; font-size:12px;">Payment</span></a>--%>
                                                     <a href="VendorLedger.aspx" id="A14" target="_blank"><span style="color:#2A5D94; font-size:12px;">Vender Ledger</span></a>
                                                </div>
                                                </td>
                                                     </tr>
                                      ...
                                      <table border="1" bordercolor="#008AE6" cellpadding="4" cellspacing="0" rules="all" style="width:100%; height:60px;  border-collapse:collapse;">
                                            <colgroup>
                                             ...
                                             <col style="width:200px;" />
                                                ...
                                                <td>Status</td>
                                                <td>Stage</td>
                                                <td><asp:CheckBox ID="chkNonPo" runat="server" Text="Non PO" style="float:left;"/> &nbsp;</td>
                                                </tr> 
                                                <tr align="center"  >
                                            ...
                                            <table border="1" bordercolor="#F0F5F5" cellpadding="4" cellspacing="0" style=" text-align: center; border-collapse:collapse; width:100%;">
                                               ...
                                               <%-- <col style="width:11%;" />--%>
                                                ...
                                                <asp:Repeater ID="RptMyInvoices" runat="server">
                                                    <ItemTemplate>
                                                        <tr>
                                                            <td><asp:CheckBox ID="chkpay" CssClass='<%#Eval("InvoiceId")%>' Visible='<%#( Eval("Status").ToString().Trim() == "UnPaid" && Eval("Stage").ToString().Trim() == "3") %>'  runat="server" />
                                                                <a onclick='EditInv(<%#Eval("InvoiceId")%>);'  href="#" style='<%#(EditAllowed && Common.CastAsInt32(Eval("Stage")) <=1 && Eval("Status").ToString().Trim() == "UnPaid" && Eval("EntertedBy").ToString().Trim() == UserId.ToString() ) ? "" : "display:none" %>'  > <img src="../../HRD/Images/AddPencil.gif" title="Edit Invoice" alt="" style="border:none;" /></a>
                                                            </td>
                                                            <%--<td>
                                                          ...
                                                          <%--  <img id="Img1" src="~/Modules/HRD/Images/green_circle.gif" runat="server" visible='<%#((Common.CastAsInt32(Eval("LINKED_COUNT"))<=0)?(Eval("Booked").ToString()=="True"):(Common.CastAsInt32(Eval("LINKED_COUNT"))<=Common.CastAsInt32(Eval("TRAV_COUNT"))))%>'  />--%>
                                                            <img id="Img2" src="~/Modules/HRD/Images/red_circle.png"  runat="server" visible='<%#(Common.CastAsInt32(Eval("IsAdvPayment"))>0 || Common.CastAsInt32(Eval("AdvPayment")) > 0)%>'  />

                                                           <%-- <img id="Img1" src="../Images/green_circle.gif" runat="server" visible='<%#(Common.CastAsInt32(Eval("LINKED_COUNT"))<=Common.CastAsInt32(Eval("TRAV_COUNT")))%>'  />
                                                            <img id="Img2" src="../Images/red_circle.png"  runat="server" visible='<%#(Common.CastAsInt32(Eval("LINKED_COUNT"))>Common.CastAsInt32(Eval("TRAV_COUNT")))%>'  />--%>
                                                            </td>
                                                        </tr>
                                                    </ItemTemplate>
