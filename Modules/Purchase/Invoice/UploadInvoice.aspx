<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UploadInvoice.aspx.cs" Inherits="Invoice_UploadInvoice" %>
...
<body>
    <form id="form1" runat="server">
            ...
            <center >
             <div style="padding:6px; font-size:14px; " class="text headerband"<strong>Update Attachment</strong></div>
