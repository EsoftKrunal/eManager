...
public partial class Invoice_UploadNewDocument : System.Web.UI.Page
{
    ...
    protected void btn_UpdateAttachment_Click(object sender, EventArgs e)
    {
        if (fuAttachment.HasFile)
        {
            ...
            if (fileName != String.Empty)
            {
                ...
                Common.Set_Procedures("Inv_AddDocument");
                ...
                {
                    lbl_inv_Message.Text = "Unable to add document. Error :" + Common.ErrMsg;
                }
