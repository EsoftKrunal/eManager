<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountMajorMaster.aspx.cs" Inherits="AccountMajorMaster" EnableEventValidation="false" MasterPageFile="~/MasterPage.master" %>
   ...
   <asp:UpdatePanel ID="UP1" runat="server" >
    ...
    <td>
      ...
      <table cellspacing="0" rules="all" border="1" cellpadding="4" style="width:100%;border-collapse:collapse;">
            ...
            <asp:Repeater ID="RptMajCat" runat="server">
                <ItemTemplate>
                        <tr id='tr<%#Eval("MajCatID")%>' class='<%#(Convert.ToInt32(Eval("MajCatID"))!=SelectedMajId)?"alternaterow":"selectedrow"%>' onclick='Selectrow(this,<%#Eval("MajCatID")%>);' lastclass='alternaterow'>
                        <td>
                        ...
                        <td>
                            <asp:Label ID="lblMajCatID" runat="server" Text='<%# Eval("MajCatID") %>'></asp:Label>
                            
                        </td>
                        <td style="text-align:left;">
                            <asp:Label ID="lblMajorCat" runat="server" Text='<%# Eval("MajorCat") %>'></asp:Label>
                        </td>
                        <td>
                            <asp:Label ID="lblMajSeqNo" runat="server" Text='<%# Eval("MajSeqNo") %>'></asp:Label>
                        </td>
    ...
    <div style="position:absolute;top:0px;left:0px; height :470px; width:100%; background-color:Gray; z-index:100; opacity:0.4;filter:alpha(opacity=40)"></div>
        <div style="position :relative; width:920px; height:100px; padding :3px; text-align :center; border :solid 1px Red; background : white; z-index:150;top:100px;  ;opacity:1;filter:alpha(opacity=100)">
            ...
            <div id="DivUpdate"  runat="server"  style="width:100%;">  <%--border:2px solid #4371a5;"--%>
             <fieldset>
                <legend style="font-weight:bold;color:#4371a5; font-family:Arial;">Add/Edit Major Category</legend>
             <table cellspacing="3"  border="0" cellpadding="4" style="width:100%;border-collapse:collapse; margin:15px;">
                <tr align="center" >
                    <td >Major Category</td>
                    <td style="text-align:left;">
                        <asp:TextBox ID="txtMajorCat" runat="server" Width="300px" MaxLength="100"  ></asp:TextBox>
                     </td>
                     <td>
                        Major Seq No
                     </td>
                    <td style="text-align:left;">
                        <asp:TextBox ID="txtMajSeqNo" runat="server" MaxLength="5" onkeypress='fncInputNumericValuesOnly(event)'></asp:TextBox>
                    </td>
                    <td>
                        
                        <asp:Button ID="imgUpdate" runat="server" Text="Save" CssClass="btn" OnClick="imgUpdate_OnClick" />
                        <asp:Button ID="imgCalcel" runat="server" Text="Cancel" CssClass="btn" OnClick="imgCalcel_OnClick" />
