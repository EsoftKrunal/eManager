<%@ Control Language="C#" AutoEventWireup="true" CodeFile="StoreRFQ.ascx.cs" Inherits="UserControls_StoreRFQ" %>
...
{        
    //window.open('EditStoreRFQ.aspx?BidId=' + BidId);
...
<div style="OVERFLOW-Y: scroll; OVERFLOW-X: hidden; WIDTH: 100%; HEIGHT: 208px ; text-align:center;" id="tbl_Spares">
<table cellspacing="0" rules="all" border="1" cellpadding="4" style="width:100%;border-collapse:collapse;">
    <colgroup>
        <col style="width:60px;" />
        <col />
...
<div class="header" style="height:25px; padding-top :5px;"><center>Quotations</center></div>
    ...
    <asp:Repeater ID="rptVendors" runat="server">
        <ItemTemplate>
                ...
                <td style="text-align :left">
                    ...
                    <asp:TextBox runat="server" ID="txtEmail" BorderColor="Orange" Width="200px" Text ='<%# Eval("SupplierEmail")%>' Enabled="false"></asp:TextBox>
...
<div style="position:absolute;top:0px;left:0px; height :100%; width:100%;z-index:100;" runat="server" runat="server" id="ModalPopupExtender2" visible="false" >
    <center>
...
<%-----------------------------------------------------------------------------------------------------------------%>
            <div id="dvApprovalLevel" runat="server" visible="true" style="border:solid 1px #C2C2C2;margin:5px;padding:5px;">
...
<%--<asp:ImageButton runat="server" ID="btnSend" ImageUrl="~/Images/sendmail.jpg" onclick="btnSendMail_Click" ValidationGroup="vv"  Enabled="false" style="display:none;"/>--%>
</center> 
        </div> 
    </center>
</div>
