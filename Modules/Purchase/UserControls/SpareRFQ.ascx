<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SpareRFQ.ascx.cs" Inherits="UserControls_SpareRFQ" %>
...
<script type="text/javascript">
    ...
    {        
        //window.open('EditSpareRFQ.aspx?BidId=' + BidId);
...
<td style="width:33%">&nbsp;</td>
    ...
    <asp:Button runat="server" ID="btnSmdPoAnalyzer" Text="Quote Analysis" style="border:none;padding:4px;margin:0px;" CssClass="btn" Visible="false"/>
...
<div class="text headerband" style="height:20px; padding-top :5px;"><center>Quotations</center></div>
<div style="OVERFLOW-Y: scroll; OVERFLOW-X: hidden;HEIGHT: 25px ; text-align:center;">
<table cellspacing="0" rules="all" border="1" cellpadding="4" style="width:100%;border-collapse:collapse;">
<colgroup>
        <col style="width:4%;" />
        <col style="width:4%;" />
...
<div style="OVERFLOW-Y: scroll; OVERFLOW-X: hidden;HEIGHT: 208px ; text-align:center;">
<table cellspacing="0" rules="all" border="1" cellpadding="4" style="width:100%;border-collapse:collapse;">
    <colgroup>
       <col style="width:4%;" />
        <col style="width:4%;" />
    ...
    <asp:Repeater ID="rptRFQList" runat="server">
        <ItemTemplate>
            <tr id='tr<%#Eval("bidid")%>'  title="Double click to view the Quotation." ondblclick='ViewRFQ(<%#Eval("bidid")%>)'>
			...
			<div style="padding:3px;color:Red;" runat="server" visible='<%#Common.CastAsInt32(Eval("ZeroUPCount"))>0%>'>InComplete</div>
               ...
               <td style="text-align:left">
                ...
                <td style="text-align:left">
                    <div runat="server" visible='<%#!PRBidStopped%>'>
                        <asp:ImageButton runat="server" ID="btnRemove" CssClass='<%#Eval("bidid")%>' Visible='<%# (Eval("CanDelete").ToString()=="Y") %>' OnClick="btnCancelRFQ_Click" ImageUrl="~/Images/Delete.jpg" OnClientClick='<%#"return AskRFQtoCancel(" + Eval("BidStatusId").ToString() + ")" %>' ToolTip="Click here to cancel this Quotation." />
                    </div>                    
                </td>
            </tr>
        </ItemTemplate>
        <AlternatingItemTemplate>
            <tr id='tr<%#Eval("bidid")%>' startclass='alternaterow' class='alternaterow' title="Double click to view the Quotation." ondblclick='ViewRFQ(<%#Eval("bidid")%>)'>
                <td style="text-align:left"><%# Eval("Sno")%></td> 
                <td style="text-align:left"><%# Eval("BIDGROUPNAME")%></td> 
                <td style=" text-align:left"><asp:Label ID="lblVendor" runat="server" Text='<%# Eval("SUPPLIERNAME") %>'  ></asp:Label>
                    <div style="padding:3px;color:Red"><%# Eval("ApprovalTypeName")%></div>
...
<!-- div for show vendor  -->
<div style="position:absolute;top:0px;left:0px; height :550px; width:100%;font-family:Arial;font-size:12px;" runat="server" id="ModalPopupExtender11" visible="false" >
    <center>
...
<div style="float:left;padding-left :5px;" ><asp:ImageButton runat="server" id="btnFind" OnClick="btnFind_Click" ImageUrl="~/Modules/HRD/Images/Search.jpg" AlternateText="Find"/> </div>
...
<asp:Button runat="server" ID="btnCreateRFQ" Text="Create Quotation" OnClick ="btnCreateRFQ_Click" CssClass="btn" /> 
</div>
</td>
</tr>
</table>
...
<div style="position:absolute;top:0px;left:0px; height :100%; width:100%;z-index:100;" runat="server" id="ModalPopupExtender21" visible="false" >
    <center>
    <div style="position:absolute;top:0px;left:0px; height :100%; width:100%; background-color :Gray;z-index:100; opacity:0.4;filter:alpha(opacity=40)"></div>
        <div style="position :relative; width:450px;padding :3px; text-align :center; border :solid 1px Red; background : white; z-index:150;top:100px;  ;opacity:1;filter:alpha(opacity=100)">
        <center>
<asp:HiddenField runat="server" ID="hfdBidId" /> 
<div style=" float :right " ><asp:Button runat="server" ID="btnClose2" TExt="Close"  ToolTip="Close this Window." onclick="btnClose2_Click" CssClass="btn"/> </div>
...
<div id="dvApprovalLevel" runat="server" visible="true" style="border:solid 1px #C2C2C2;margin:5px;padding:5px;font-family:Arial;font-size:12px;">
                <table border="0" bordercolor="#F0F5F5" cellpadding="6" cellspacing="0" style=" text-align: center; border-collapse:collapse; width:100%;">
                    ...
                    <tr>
                        <td >
                            <asp:TextBox runat="server" ID="txtpComments" TextMode="MultiLine" Width="100%" Rows="7"></asp:TextBox>
                        </td>
                    </tr>                     
                      </table>
                <table cellpadding="0" cellspacing="0" width="100%">
...
<%--<asp:ImageButton runat="server" ID="btnSend" ImageUrl="~/Images/sendmail.jpg" onclick="btnSendMail_Click" ValidationGroup="vv" style="display:none;"/>--%>
  ...
  <%--Div for Select Vendor List 11111111111--%>
  <div style="position:absolute;top:50px;left:0px; height :550px; width:100%;z-index:100;" runat="server" runat="server" id="divVendorSearch" visible="false" >
    <center>
    <div style="position:absolute;top:50px;left:0px; height :550px; width:100%; background-color :Gray;z-index:100; opacity:0.4;filter:alpha(opacity=40)"></div>
         ...
         <table cellpadding="3" cellspacing="3" border="0" width="100%">
             <tr class="header">
                 <td>
                     ...
                     <asp:Button ID="btnCloseAddBusinessTypePopup" runat="server" Text="Close" OnClick="btnCloseAddBusinessTypePopup_OnClick" style="float:right;" CssClass="btn"  />
                 </td>
             </tr>
            </table>
...
<%-- Purchaser Comments -------------------------------------------------------------------------%>
<div style="position:absolute;top:50px;left:0px; height :550px; width:100%;z-index:100;" runat="server"  id="dbPRComm" visible="false" >
    <center>
    <div style="position:absolute;top:50px;left:0px; height :550px; width:100%; background-color :Gray;z-index:100; opacity:0.4;filter:alpha(opacity=40)"></div>
