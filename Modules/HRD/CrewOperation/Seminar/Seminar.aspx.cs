...
public partial class Seminar_Seminar : System.Web.UI.Page
{
    public int UserId
    {
    ...
    protected void Bindgrid()
    {
        ...
        if (ddlCategory.SelectedIndex > 0)
            sql += " AND CATEGORYID=" + ddlCategory.SelectedValue;
    ...
    {
        int SeminarId = Common.CastAsInt32(((ImageButton)sender).CommandArgument);
        Common.Execute_Procedures_Select_ByQueryCMS("EXEC DBO.DeleteSeminar " + SeminarId);
        Bindgrid();
    }
