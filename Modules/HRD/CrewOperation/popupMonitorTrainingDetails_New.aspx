<%@ Page Language="C#" AutoEventWireup="true" CodeFile="popupMonitorTrainingDetails_New.aspx.cs" Inherits="CrewOperation_popupMonitorTrainingDetails_New" %>
    ...
    <div>
        <table style="border-collapse: collapse; border: solid 2px #4371a5" cellpadding="0" cellspacing="0" width="100%">
           ...
           <td style="border: #FFECFF 1px solid; background-color: #FFECFF; color:Black; height: 25px;">
               <span style="font-size: 15px;"><asp:Label runat="server" ID="lblOfficeName"></asp:Label></span>
           </td>
           </tr>
            <tr>
