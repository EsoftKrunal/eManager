<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ManageTraining1_Crew.aspx.cs" Inherits="CrewOperation_ManageTraining1_Crew" EnableEventValidation="false" EnableViewStateMac="false" %>
...
<body style="margin-left:0px;"> 
    ...
    <div style="text-align:center;background-color:black;color:white;border-bottom:solid 2px black;padding-top:10px;">
            <span style="font-size:20px;font-weight:bold;">Manage Crew Training</span>
            <div style="padding:5px;font-size:14px;">Crew Name : 
               ( <asp:label id="lblselectedCrewNumber" runat="server"></asp:label>) 
               <asp:label id="lblselectedUsername" runat="server" style="color:#fff"></asp:label>
                       , Rank :    
                       <asp:label id="lblselectedRankCode" runat="server" style="color:#fff"></asp:label>
                       , Status : <asp:label id="lblCrewStatus" runat="server"></asp:label>
                       , Vessel : <span id="lblVesselName" runat="server"></span>                        
                       <asp:label id="lblSignOnDate" runat="server" ToolTip="Sign On Date, Relief Due Date" style="color:#fff"></asp:label>     
            </div>
    </div>
    ...
    <div id="container" class="container" style="position:relative;height:650px;">
            <div class="slide slidecrewlist" >

            
            </div>
        <%--<asp:UpdatePanel ID="updatepanel1" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>--%>
            <div class="slide slidecrew" style="padding-top:1px;padding-bottom:5px;" id="divTrainings" runat="server" visible="false">
                ...
                <div style="text-align:right;padding:10px 15px;">
                    <div style="">
                        ...
                        <div class="newbtn" id="div_btnImportFromMatrix" runat="server" visible="false" ><i class="fa fa-download"></i> 
                            <asp:Button ID="btnImportFromMatrix" runat="server" Text="Assign From Matrix" CssClass="newbtn" OnClick="btnImportFromMatrix_OnClick" Width="120px" Visible="false"/> &nbsp;
                        </div>
                        &nbsp;
                    ...
                    <div class="newbtn" ><i class="fa fa-trash"></i> 
                        <asp:Button ID="btnDelete" runat="server" Text="Delete" CssClass="newbtn" OnClick="btnDelete_OnClick" OnClientClick="return confirm('Are you sure to delete the records');"  Width="55px"/> &nbsp;
                    </div>
                </div>
                
                </div>
                <div id="dvdue" runat="server" visible="false">
                <div id="dvtrainings" style="background-color:white;height:550px;overflow:hidden;"  >
...
<col width="100px" />
            ...
            <div id="dvdone" runat="server" visible="false">
                <div id="dvtrainings1" style="background-color:white;height:550px;overflow:hidden;"  >
...
<asp:Button ID="btnSaveClosure" runat="server" Text="Save" OnClick="btnSaveClosure_OnClick" />
...
<div class="modal-footer">
    ...
    <div class="modal-body">
        ...
        <div style="padding:10px;">
            ...
            <asp:Button ID="btnSaveTrainingsFromMatrix" runat="server" Text="Save" OnClick="btnSaveTrainingsFromMatrix_OnClick" />
