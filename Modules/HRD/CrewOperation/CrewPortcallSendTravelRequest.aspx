<%@ Page Language="C#"  AutoEventWireup="true" CodeFile="CrewPortcallSendTravelRequest.aspx.cs" Inherits="CrewOperation_OrderTickets" Title="EMANAGER" %>
...
<body>
    ...
    <table cellpadding="0" cellspacing="0" width="100%" border="1" bordercolor="#4371a5" >
    <tr>
        <td class="text headerband" colspan="2" >
            <strong> Crew Travel - Send Ticket Request </strong>
        </td>
    </tr>
    <tr>
    <td>
   ...
   <%-- <asp:TemplateField HeaderText="No(s) Tickets" ItemStyle-Width="40px" ItemStyle-HorizontalAlign="Center">
    ...
    <asp:TemplateField HeaderText="Rank" SortExpression="RankName" ItemStyle-Width="75px">
        <ItemStyle HorizontalAlign="Left" />
        <ItemTemplate>
    ...
    <asp:TemplateField HeaderText="Origin" >
        ...
        <ItemTemplate>
            <div>   
                <asp:TextBox runat="server" ID="txt_FA" CssClass='input_box' MaxLength="50"  Text='<%# Eval("FromAirport") %>' ></asp:TextBox><div style=""></div>
                <%--OnKeyDown="OnKeyDown(this);" onKeyUp='Show_List(this,2);'--%>
            </div>
        </ItemTemplate>
    </asp:TemplateField>
    <asp:TemplateField HeaderText="Destination" >
        ...
        <ItemTemplate>
            ...
            <asp:TextBox runat="server" ID="txt_TA" CssClass='input_box'  MaxLength="50" Text='<%# Eval("TOAIRPORT") %>'></asp:TextBox>
        </ItemTemplate>
    </asp:TemplateField>
    <asp:TemplateField HeaderText="Departure Dt." >
        <ItemStyle HorizontalAlign="Left" Width="100px" />
        <ItemTemplate>
            <asp:TextBox runat="server" ID="txt_Date" CssClass='input_box' Text='<%# Eval("DeptDate") %>' MaxLength="50" Width="90px"></asp:TextBox>
        ...
        <ItemTemplate>
            <asp:TextBox runat="server" ID="txt_remarks" CssClass='input_box' Text='<%# Eval("Remarks") %>'  MaxLength="200" Width="300px" TextMode="MultiLine"></asp:TextBox>
    ...
    <div style="float:right; padding:5px;width:100%;text-align:center;display:flex;">
        <b> Select Travel Agent : </b> 
        <asp:UpdatePanel ID="Up" runat="server">
            <ContentTemplate>
                 <asp:DropDownList runat="server" ID="ddl_TA"  CssClass='input_box' Width="250px" OnSelectedIndexChanged="ddl_TA_SelectedIndexChanged" AutoPostBack="True" ></asp:DropDownList> &nbsp;&nbsp;
    <asp:Button runat="server" ID="bthSave" Text="Save & Send Mail"  CssClass="btn" OnClick="btnSave_Click" />
            </ContentTemplate>
        </asp:UpdatePanel>
