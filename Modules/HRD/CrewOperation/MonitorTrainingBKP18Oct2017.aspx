<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MonitorTrainingBKP18Oct2017.aspx.cs" Inherits="CrewOperation_MonitorTrainingBKP18Oct2017" %>
            ...
            <asp:Repeater ID="rptVesselList" runat="server" >
                ...
                <tr onmouseover="this.style.historycolor=this.style.backgroundColor;this.style.backgroundColor='#c2c2c2';" onmouseout="this.style.backgroundColor=this.style.historycolor;">
                        ...
                        <td style="text-align:center">
                            <asp:ImageButton runat="server" id="btnMangeTraining1" ImageUrl="~/Modules/HRD/Images/training.png" ToolTip="Manage Training" OnClick="btnMangeTraining1_Click" CommandArgument='<%#Eval("VesselID")%>' OnClientClick="this.src='../Images/inprocss.gif';" />

                            <%--<asp:ImageButton runat="server" id="btnDueTraining" ImageUrl="~/Modules/HRD/Images/training.png" ToolTip="Manage Training" OnClick="btnDueTraining_Click" CommandArgument='<%#Eval("VesselID")%>' OnClientClick="this.src='../Images/inprocss.gif';" />--%>
                        </td>
                        <td style="text-align:center;">
