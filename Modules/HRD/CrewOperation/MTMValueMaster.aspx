<%@ Page Language="C#" MasterPageFile="~/Modules/HRD/CrewTraining.master" AutoEventWireup="true" CodeFile="MTMValueMaster.aspx.cs" Inherits="HSSQE_KST_MTMValueMaster" %>
    ...
    <div style="padding:5px; text-align:right;">
        ...
        <tr style='color:White; height:25px;'>
               <td style="width:50px;color:White;text-align:center;"><b>Edit</b></td>      
                ...
                <td style="color:White;text-align:left; width:300px;"><b>Behaviour</b></td>
                <td style="color:White;text-align:left;"><b>MTM Value</b></td>
...
<tr onmouseover="">
    <td style="width:50px;color:White;text-align:center;">
                    <b>
                        <asp:ImageButton runat="server" ID="btnEdit" CommandArgument='<%#Eval("BehaviourId")%>' OnClick="btnEdit_Click" ImageUrl="~/Modules/HRD/Images/editX12.jpg" />
                    </b>
                </td>      
                <td style="width:50px;color:White;text-align:center;">
                    <b>
                        <asp:ImageButton runat="server" ID="btndelete" CommandArgument='<%#Eval("BehaviourId")%>' OnClick="btnDelete_Click" OnClientClick="return confirm('Are you sure to delete?');" ImageUrl="~/Modules/HRD/Images/delete_12.gif" />
                    </b>
                </td>
        <td style="text-align:left; width:300px;"><%#Eval("BehaviourName")%></td>
    <td style="text-align:left;"><%#Eval("MTMValueName")%></td>
    <td style="width:30px;"><b>&nbsp;</b></td>
</tr>
</ItemTemplate>
</asp:Repeater>
...
<center>
    ...
    <div style="position :relative; width:600px; padding :10px; text-align :center; border :solid 1px #4371a5; background : white; z-index:150;top:50px;opacity:1;filter:alpha(opacity=100)">
        <div>
            <h2>Add/Edit MTM Value</h2>
            <table width="100%">
                <tr>
                    <td style="width:100px">Behaviour :</td>
                    <td><asp:DropDownList ID="ddlBehaviour" runat="server" CssClass="btn" Width="95%" />
                        <asp:RequiredFieldValidator runat="server" ControlToValidate="ddlBehaviour" ErrorMessage="*" ForeColor="Red" ></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td style="width:100px">MTM Value :</td>
                    <td><asp:TextBox ID="txtMTMValue" runat="server" CssClass="btn" Width="95%" />
                        <asp:RequiredFieldValidator runat="server" ControlToValidate="txtMTMValue" ErrorMessage="*" ForeColor="Red" ></asp:RequiredFieldValidator>
                    </td>
                </tr>
            </table>
        </div>
