<%@ Page Language="C#" MasterPageFile="~/Modules/HRD/CrewTraining.master" AutoEventWireup="true" CodeFile="Seminar.aspx.cs" Inherits="Seminar" Async="true"%>
<asp:Content ID="Content1" ContentPlaceHolderID="contentPlaceHolder1" Runat="Server">
    ...
    <table cellpadding="5" cellspacing="0" width="100%" >
        <tr>
            ...
            <td style="text-align: right">
                <asp:LinkButton Text=" + Add New" CssClass="btn" runat="server" ID="lnkAdd" OnClick="btnAdd_Click"></asp:LinkButton>
            </td>
        </tr>
    </table>
        ...
        <asp:Repeater runat="server" ID="rptSeminars">
            <ItemTemplate>
                <tr>
                    ...
                    <td style="text-align: center;">
                        <a href='SeminarAgenda.aspx?K=<%#Eval("SeminarId")%>' target="_blank">
                    ...
                    <td>
                        <asp:LinkButton ID="lnkInviteClick" runat="server" Text='<%#Eval("Invited")%>' Style="color: Red;"
                            OnClick="lnkInviteClick_OnClick" CommandArgument='<%#Eval("SeminarId")%>'></asp:LinkButton>
                    </td>
                    <td>
                        <%#Eval("Confirmed")%>
                    </td>
                    ...
                    <td style="text-align: center">
                        <%-- <a href='AddEditSeminar.aspx?SeminarId=<%#Eval("SeminarId")%>' target="_blank">
        <img src="../Images/editX12.jpg" style="border:none" />
    </a>--%>
                        <asp:ImageButton runat="server" ID="btEdit" OnClick="btnEdit_Click" ToolTip="Modify Seminar"
                            ImageUrl="~/Modules/HRD/Images/editX12.jpg" CommandArgument='<%#Eval("SeminarId")%>' />
                        <%--<asp:ImageButton runat="server" ID="btnAgenda" OnClick="btnAgenda_Click" ToolTip="Modfy Ageanda" ImageUrl="~/Modules/HRD/Images/report1.gif" CommandArgument='<%#Eval("SeminarId")%>' Visible='<%#(Eval("Status").ToString()=="1")%>' style="width:12px" />--%>
                        <%--<asp:ImageButton runat="server" ID="btnInvite" OnClick="btnInvite_Click" ToolTip="Invite Members" ImageUrl="~/Modules/HRD/Images/user.png" CommandArgument='<%#Eval("SeminarId")%>' Visible='<%#(Eval("Status").ToString()!="3")%>' style="width:12px" />--%>
                        <asp:ImageButton runat="server" ID="btnExecute" OnClick="btnExecute_Click" ToolTip="Execute Seminar"
                            ImageUrl="~/Modules/HRD/Images/check.gif" CommandArgument='<%#Eval("SeminarId")%>' Visible='<%#(Eval("Status").ToString()=="2")%>' />
                        <asp:ImageButton runat="server" ID="btnDelete" OnClick="btnDelete_Click" ToolTip="Delete Seminar"
                            ImageUrl="~/Modules/HRD/Images/delete_12.gif" CommandArgument='<%#Eval("SeminarId")%>' OnClientClick="return confirm('Are you sure to delete?');"
    ...
    <!-- IFRAME SECTION -->
    <div style="position: fixed; top: 40px; left: 0px; height: 100%; width: 100%;" id="dvFrame"
        ...
        <center>
            ...
            <div style="position: relative; text-align: center; background: white; z-index: 150;
                top: 30px; border: solid 5px black; width: 900px;">
                <center>
                    <div style="">
                        <iframe runat="server" id="frame1" width="100%" height="420px" frameborder="0"></iframe>
                    </div>
    ...
    <div style="position: fixed; top: 40px; left: 0px; height: 100%; width: 100%;" id="DivInvitedPerson"
        runat="server" visible="false">
        <center>
            <div style="position: fixed; top: 0px; left: 0px; min-height: 100%; width: 100%;
                background-color: black; z-index: 100; opacity: 0.6; filter: alpha(opacity=60)">
