<%@ Page Language="C#" MasterPageFile="~/Modules/HRD/CrewTraining.master" AutoEventWireup="true" CodeFile="Behaviours.aspx.cs" Inherits="HSSQE_KST_Behaviours" %>
    ...
    <div style="padding:5px; text-align:right;">
        ...
        <tr style='color:White; height:25px;'>
               <td style="width:50px;color:White;text-align:center;"><b>Edit</b></td>      
                ...
                <td style="color:White;text-align:left;"><b>Behaviours</b></td>
...
<tr onmouseover="">
    <td style="width:50px;color:White;text-align:center;">
        ...
        <td style="text-align:left;"><%#Eval("BehaviourName")%></td><td style="width:30px;"><b>&nbsp;</b></td>
</tr>
</ItemTemplate>
</asp:Repeater>
</tbody>
...
<center>
    ...
    <div style="position :relative; width:600px; padding :10px; text-align :center; border :solid 1px #4371a5; background : white; z-index:150;top:50px;opacity:1;filter:alpha(opacity=100)">
        <div>
            <h2>Add/Edit Behaviour</h2>
            <table width="100%">
                <tr>
                    <td style="width:100px">Behaviour :</td>
                    <td><asp:TextBox ID="txtBehaviour" runat="server" CssClass="btn" Width="95%" />
                        <asp:RequiredFieldValidator runat="server" ControlToValidate="txtBehaviour" ErrorMessage="*" ForeColor="Red" ></asp:RequiredFieldValidator>
                    </td>
                </tr>
            </table>
        </div>
