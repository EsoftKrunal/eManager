...
function ShowPrint()
{
    window.open('PrintWageScale.aspx');
}
</script>
 <div>
    <table border="0" cellpadding="0" cellspacing="0" style="border-right: #4371a5 1px solid;border-top: #4371a5 1px solid; border-left: #4371a5 1px solid; border-bottom: #4371a5 1px solid; text-align:center; width:100%">
            <tr>
                <td align="center" style=" width: 100%;" class="text headerband" >Wage Master</td>
            </tr>
            <tr>
            <td style="width: 100%">
                    ...
                    <td style="text-align: center; padding-right: 10px; padding-left: 10px; padding-bottom: 10px;">
                        ...
                        <table width="100%" cellpadding="3" cellspacing="0" >
                            <tr>
                                ...
                                <asp:Button ID="btn_Show_History" runat="server" Text="H" OnClick="btn_ShowHistory_Click" CausesValidation="false"/>
                                <asp:Button ID="btn_Show_Copy" runat="server" Text="S"  OnClick="btn_ShowCopy_Click" CausesValidation="false"/>
                ...
                <tr>
                    <td style="text-align: right;padding-right: 10px;padding-top: 10px; padding-bottom: 10px;" align="center">
                        ...
                        <td style=" text-align:center; width :200px;">
                            <asp:Button ID="btn_Print" runat="server" CssClass="btn" Text="Print" Width="60px" CausesValidation="false" OnClientClick="return ShowPrint();"/>&nbsp;
                            <asp:Button ID="btn_Save" runat="server" CssClass="btn" ValidationGroup="vg" OnClick="Save_Click" Text="Save" Width="60px" />
                        </td>
                        </tr>
                        </table>
                    </td>
