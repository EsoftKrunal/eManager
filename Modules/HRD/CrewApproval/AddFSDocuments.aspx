<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddFSDocuments.aspx.cs" Inherits="CrewApproval_AddFSDocuments" %>
                ...
                <td>
                    <table cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr >
                            ...
                            <ItemTemplate>
                                <div><asp:CheckBox runat="server" ID="ckh_L" Checked='<%#Common.CastAsInt32(Eval("RVID")) > 0 %>' ToolTip='<%#Eval("DocumentTypeId") %>' /><%#Eval("DocumentName") %></div>
                            </ItemTemplate>
                            </asp:Repeater>
                            </div>
                            </td>
