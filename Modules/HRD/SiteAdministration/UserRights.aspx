<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Modules/HRD/SiteAdministration/ManageRights.master" CodeFile="UserRights.aspx.cs" Inherits="SiteAdministration_UserRights" %>
...
<body style=" margin: 0 0 0 0;" >
    <form id="form1" runat="server">--%>
        <table cellpadding="0" cellspacing="0" style="width:100%; border-right: #4371a5 1px solid; border-top: #4371a5 1px solid;
            ...
            <tr>
                <td colspan="2">
                    <asp:Label ID="lblupdation" runat="server" ForeColor="Red" Height="11px"
                        Text="Record Updated.." Visible="False"></asp:Label>&nbsp;
                </td>
            </tr>
            <tr>
                ...
                <td style="padding-right: 5px; padding-left: 5px; width: 100%">
                    <fieldset style="border-right: #8fafdb 1px solid; border-top: #8fafdb 1px solid;
                        ...
                        <br />
                        <div style="overflow-x: hidden;overflow-y:scroll;width:100%; height: 163px">
