<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Modules/HRD/SiteAdministration/ManageRights_VIMS.master" CodeFile="UserOnBehalfRights_VIMS.aspx.cs" Inherits="SiteAdministration_UserRightsRoles_VIMS" Title="" %>
       ...
       <td>--%>
        <table cellpadding="0" cellspacing="0" style="width:97%; border-right: #4371a5 1px solid; border-top: #4371a5 1px solid;
            ...
            <tr>
                <td style="padding-left: 5px; width: 200px">
                    <fieldset style="border-right: #8fafdb 1px solid; border-top: #8fafdb 1px solid;
                        ...
                        <div style="overflow-y: auto; overflow-x: hidden; height: 164px">
                            <asp:GridView ID="GvAssgUser" runat="server" AutoGenerateColumns="False" GridLines="Horizontal"
                                Height="85px" OnSelectedIndexChanged="GvAssgUser_doselect" Style="text-align: center"
                                Width="200px">
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="Assigned User Name">
                                        <ItemStyle HorizontalAlign="Left" />
                                        <ItemTemplate>
                                            <asp:LinkButton ID="btnassgnuser" runat="server" CommandName="Select" Font-Underline="false"
                ...
                <td style="padding-right: 5px; padding-left: 5px; width: 605px">
                    <fieldset style="border-right: #8fafdb 1px solid; border-top: #8fafdb 1px solid;
                        padding-bottom: 10px; border-left: #8fafdb 1px solid; padding-top: 0px; border-bottom: #8fafdb 1px solid;
                        height: 187px">
                        <legend><strong>Subordinates List</strong></legend>
                        <br />
                        <div style="overflow: auto; height: 163px">
                            <asp:GridView ID="GVOnbehalfUser" runat="server" AutoGenerateColumns="False" GridLines="Horizontal"
                                Style="text-align: center" Width="555px">
                                <RowStyle CssClass="rowstyle" />
                                <SelectedRowStyle CssClass="selectedtowstyle" />
                                <PagerStyle CssClass="pagerstyle" />
                                <HeaderStyle CssClass="headerstylefixedheadergrid" />
                                <Columns>
                                    <asp:TemplateField HeaderText="Onbehalf User Name">
                                        <ItemStyle HorizontalAlign="Left" Width="200px" />
                                        <ItemTemplate>
                                            <asp:Label ID="UserId" runat="server" Text='<%#Eval("UserName")%>'></asp:Label>
