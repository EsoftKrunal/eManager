<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CandidateDetailInformation.aspx.cs" Inherits="CandidateDetailInformation" %>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0" style="border-right: #4371a5 1px solid;border-top: #4371a5 1px solid; border-left: #4371a5 1px solid; border-bottom: #4371a5 1px solid; text-align:center;background-color:#f9f9f9">
                ...
                <td >
                    ...
                    <legend><strong>Candidate Details </strong></legend>
                      ...
                      <asp:GridView ID="gvcandidate" runat="server"  AutoGenerateColumns="False" DataKeyNames="CandidateId" GridLines="Horizontal" Width="220%" OnPreRender="gvcandidate_PreRender" OnSelectedIndexChanged="gvcandidate_SelectedIndexChanged">
                            <Columns>
                                  <asp:TemplateField HeaderText="Select"><ItemTemplate><asp:CheckBox ID="chk1" runat="server" />
                                        </ItemTemplate>
                                        <ItemStyle Width="50px"/>
                                  </asp:TemplateField>
                                  
<asp:CommandField ButtonType="Image" HeaderText="View " SelectImageUrl="~/Modules/HRD/Images/HourGlass.gif" ShowSelectButton="True" ></asp:CommandField>
                                
                                  
                                  <asp:BoundField DataField="FirstName" HeaderText="First Name">
                                    <ItemStyle HorizontalAlign="Left"/>
                                    </asp:BoundField>
                                  <asp:BoundField DataField="MiddleName" HeaderText="Middle Name"><ItemStyle HorizontalAlign="Left"/></asp:BoundField>
                                  <asp:BoundField DataField="LastName" HeaderText="Family Name"><ItemStyle HorizontalAlign="Left"/></asp:BoundField>
                                  <asp:BoundField DataField="rankname" HeaderText="Rank Applied"><ItemStyle HorizontalAlign="Left"/></asp:BoundField>
                                  <asp:BoundField DataField="Gender" HeaderText="Gender"><ItemStyle HorizontalAlign="Left"/></asp:BoundField>
                                  <asp:BoundField DataField="AvailableFrom" HeaderText="Available From"><ItemStyle HorizontalAlign="Left" Width="170px" /></asp:BoundField>
                                  <asp:BoundField DataField="PassportNo" HeaderText="PassportNo"><ItemStyle HorizontalAlign="Left" Width="100px" /></asp:BoundField>
                                  <asp:BoundField DataField="EmailId" HeaderText="Email  "><ItemStyle HorizontalAlign="Left" /></asp:BoundField>
                                  <asp:BoundField DataField="DateOfBirth" HeaderText="DOB"><ItemStyle HorizontalAlign="Left" Width="80px" /></asp:BoundField>
                                  <asp:BoundField DataField="nationality" HeaderText="Nationality"><ItemStyle HorizontalAlign="Left"/></asp:BoundField>
                                  <asp:BoundField DataField="ContactNo" HeaderText="Contact #"><ItemStyle HorizontalAlign="Left" Width="250px" /></asp:BoundField>
                                  <asp:BoundField DataField="PlaceOfBirth" HeaderText="POB"><ItemStyle HorizontalAlign="Left"/></asp:BoundField>
                                  <asp:BoundField DataField="qualification" HeaderText="Qualification"><ItemStyle HorizontalAlign="Left"/></asp:BoundField>
                            </Columns>
         ...
         <table width="100%" style="background-color:#f9f9f9;" cellpadding="0" cellspacing="0"  >
             ...
             <tr>
                 <td align="right" style="height: 17px; text-align: right">
                   <fieldset style="border-right: #8fafdb 1px solid; border-top: #8fafdb 1px solid;border-left: #8fafdb 1px solid; border-bottom: #8fafdb 1px solid;padding:3px">
                    <legend><strong>Candidate Transferred :</strong></legend>
                     <asp:GridView ID="gv_result" runat="server" AutoGenerateColumns="true" PageSize="3" Style="text-align: center" Width="100%" GridLines="Horizontal">
                         <RowStyle CssClass="rowstyle" />
                         <SelectedRowStyle CssClass="selectedtowstyle" />
                         <PagerStyle CssClass="pagerstyle" />
                         <HeaderStyle CssClass="headerstylefixedheadergrid" />
