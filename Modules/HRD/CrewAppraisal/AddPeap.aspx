<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AddPeap.aspx.cs" Inherits="CrewAppraisal_ViewAppraisalData" %>
    ...
    <div>
        ...
        <div style="text-align:left;margin:5px; margin-bottom:0px;">
            <asp:UpdatePanel runat="server">
                <ContentTemplate>
                    <asp:Button ID="btnClosure" runat="server" Text="Closure" CssClass="btn" OnClick="btnClosure_OnClick" style="float:right;margin-right:3px;" OnClientClick='return confirm("Are you sure to close ? ");' Visible="false" />
                    ...
                    <table width="100%" cellpadding="4" cellspacing="2" border="0" style="border-collapse:collapse; text-align:left;" class="bordered" >
                            ...
                            <col />
                                ...
                                <tr >
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtPerScale1" runat="server" CssClass="CalPerScale" ></asp:TextBox>
                                    </td>
                                    <td>
                                ...
                                <tr >
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtPerScale2" runat="server" CssClass="CalPerScale"></asp:TextBox>
                                    </td>
                                    <td>
                                ...
                                <tr id="trPerScale3" runat="server" >
                                    ...
                                    <td>
                                        <asp:TextBox ID="txtPerScale3" runat="server" CssClass="CalPerScale"></asp:TextBox>
                                    </td>
                                    <td>
