<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DateWiseCrewContract.aspx.cs" Inherits="Reporting_DateWiseCrewContract" %>
...
<td align="center" valign="top" >
        <table border="0" cellpadding="0" cellspacing="0" style="border-right: #4371a5 1px solid;border-top: #4371a5 1px solid; border-left: #4371a5 1px solid; border-bottom: #4371a5 1px solid;text-align: center" width="100%">
            <tr>
                <td align="center" class="text headerband" style="width: 100%; ">Crew Contract Listing</td>
            </tr>
            <tr>
                <td style="width: 100%">
                            ...
                            <td style="text-align: left; padding :3px;">
                                 <table cellpadding="0" cellspacing="0" width="100%">
                                     <tr id="trdate" runat="server">
                                         <td style="height: 5px; width: 114px;">From Date :</td>
                                         <td style="height: 5px; width: 196px;"><asp:TextBox ID="txtfromdate" runat="server" CssClass="required_box"></asp:TextBox>
                                         ...
                                         <td style="height: 5px; width: 64px;">To Date :</td>
                                         <td style="height: 5px; ">
