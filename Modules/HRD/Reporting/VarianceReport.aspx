<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VarianceReport.aspx.cs" Inherits="Reporting_VarianceReport" %>
            ...
            <tr>
                <td style="width: 100%">
                    <table border="0" cellpadding="0" cellspacing="0" style="background-color: #ffffff" width="100%">
                        ...
                        <tr>
                            <td style="padding: 3px;width: 100%;text-align: left">
                                <table cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                        <td style="width: 100px; text-align: right">
                                            Owner :</td>
                                        <td style="width: 100px; text-align: left">
                                            <asp:DropDownList ID="ddl_Owner" runat="server" CssClass="input_box" Width="185px" AutoPostBack="True" OnSelectedIndexChanged="ddl_Owner_SelectedIndexChanged">
                                            </asp:DropDownList></td>
                                        <td style="width: 100px; text-align: right">
                                             Vessel :</td>
                                        <td style="width: 90px; text-align: left">
                                            <asp:DropDownList ID="ddvessel" runat="server" CssClass="input_box" Width="201px" AutoPostBack="false">
                                                <asp:ListItem Value="0">All</asp:ListItem>
                                            </asp:DropDownList></td>
                                        <td style="width: 570px; text-align: right">
                                            Budget Type:</td>
                                        <td style="width: 204px; text-align: left">
                                            <asp:DropDownList ID="ddlBudgetType" runat="server" CssClass="input_box"
                                                Width="112px">
                                            </asp:DropDownList></td>
                                        <td style="width: 100px; text-align: left">
                        ...
                        <tr>
                            <td colspan="7">
                              <iframe runat="server" id="Iframe2" frameborder="1" style="width: 100%; height:432px; overflow:auto"></iframe>
                            </td>
                        </tr>
                    </table>
                </td>
