<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrintContract.aspx.cs" Inherits="Reporting_PrintContract" %>
           ...
           <td align="center" class="text" style="width: 100%; height: 23px; background-color: #4371a5; color:White;">
            Print Contract
             ...
             <tr>
                ...
                <%-- <asp:RadioButtonList runat="server" ID="RadCtype" RepeatDirection="Horizontal">
                     <asp:ListItem Text="Yangon Format" Value="Y"></asp:ListItem>
                     <asp:ListItem Text="Mumbai Format" Value="M"></asp:ListItem>
                     <asp:ListItem Text="Other Format" Value="O"></asp:ListItem>
                 </asp:RadioButtonList>--%>
                  <td style="width:250px;text-align:left;padding-left:10px;">
                      <asp:DropDownList ID="ddl_ContractTemplate" runat="server" Width="225px">
