<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GOACrewList.aspx.cs" Inherits="GOACrewList" %>
         ...
         <td style="border-bottom: #4371a5 1px solid;" >
             <table cellpadding="0" cellspacing="0" style="width: 100%;">
                 <tr>
                     ...
                     <td style="padding-right: 10px; height: 13px; text-align: right">As on Date:</td>
                     ...
                     <td style="width: 200px; height: 13px; text-align : left ">
                         <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                             ControlToValidate="txt_from" Display="Dynamic" ErrorMessage="Required."></asp:RequiredFieldValidator>
