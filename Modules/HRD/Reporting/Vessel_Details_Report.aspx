<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Vessel_Details_Report.aspx.cs" Inherits="Reporting_Vessel_Details_Report" %>
         ...
         <table border="0" cellpadding="0" cellspacing="0" style="border-right: #4371a5 1px solid;
          ...
          <tr>
           <td>
             ...
             <tr>
                 <td>
                     <table cellpadding="0" cellspacing="0" style="width: 798px">
                         <tr>
                             <td style="padding-right: 5px; width: 144px; text-align: right; height: 19px;">
                                 </td>
