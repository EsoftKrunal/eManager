<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ReliefPlanningUnderOperation.aspx.cs" Inherits="Reporting_ReliefPlanningUnderOperation" %>
                                                                ...
                                                                <tr>
                                                                    <td colspan="2" style="padding: 3px; border-bottom: #4371a5 1px solid;">
                                                                        <table cellpadding="0" cellspacing="0" width="100%" border="0">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td style="text-align: right; width: 120px;" class="style6">&nbsp;</td>
                                                                                    <td style="text-align: right" class="style7">Fleet :
                                                                                    </td>
                                                                                    ...
                                                                                    <td style="height: 13px; width: 100px; text-align: right;">&nbsp;</td>
                                                                                    <td style="text-align: right;" align="left" class="style2">Days :</td>
                                                                                    ...
                                                                                    <td style="text-align: center;" class="style4">Rank : </td>
                                                                                    ...
                                                                                    <td align="left" style="width: 35px; height: 13px">&nbsp;</td>
                                                                                    <td style="height: 13px; text-align: center"></td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td style="text-align: right" class="style6">&nbsp;</td>
                                                                                    <td style="text-align: right" class="style7">Vessel List :</td>
                                                                                    ...
                                                                                    <td style="height: 13px; width: 100px; text-align: right;">&nbsp;</td>
                                                                                    <td style="text-align: right;" align="left" class="style2">Rank Group :</td>
                                                                                    <td style="width: 187px; height: 13px; text-align: left">
                                                                                ...
                                                                                <tr>
                                                                                    <td style="text-align: right" class="style1" colspan="2">Recruiting Office :
                                                                                    </td>
                                                                                    <td colspan="4">
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td style="width: 86px; height: 13px; text-align: left">&nbsp;&nbsp;</td>
                                                                                    <td style="height: 13px; width: 100px; text-align: right;">&nbsp;</td>
                                                                                    <td style="text-align: right;" align="left" class="style2">&nbsp;</td>
                                                                                    <td style="width: 187px; height: 13px; text-align: left">&nbsp;</td>
                                                                                    <td style="text-align: right;" class="style4">&nbsp;</td>
                                                                                    <td style="text-align: left;" class="style3">&nbsp;</td>
