<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrintCrewList.aspx.cs" Inherits="Reporting_PrintCrewList" %>
         ...
         <table border="0" cellpadding="0" cellspacing="0" style="border-right: #4371a5 1px solid;
          ...
          <tr>
           <td align="center" class="text" style="width: 100%; height: 23px; background-color: #4371a5">
               <asp:Label ID="Label2" runat="server" Width="568px"></asp:Label></td>
          </tr>
          <tr>
           <td style="text-align: left">
               <table cellpadding="0" cellspacing="0" width="100%">
                   <tr>
                       <td>
                           <iframe id="IFRAME1" runat="server" frameborder="1" style="overflow: auto; width: 100%;
                               height: 500px"></iframe>
                       </td>
                   </tr>
               </table>
