...
public partial class BirthdayListReportFamily : System.Web.UI.Page
{
    ...
    {
        IFRAME1.Attributes.Add("src", "BirthdayListContainerFamily.aspx?CrewStatus=" + ddl_Status.SelectedValue + "&Month=" + ddlMonth.SelectedValue +"&RecOff=" + ddlRecOff.SelectedValue + "&OffRat=" + ddlOffRat.SelectedValue);  
    }
