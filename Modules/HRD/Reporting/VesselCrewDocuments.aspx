<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VesselCrewDocuments.aspx.cs" Inherits="Reporting_VesselCrewDocuments" %>
       ...
       <tr>
        <td align="center" valign="top" style="height: 235px">
         <table border="0" cellpadding="0" cellspacing="0" style="border-right: #4371a5 1px solid;
            border-top: #4371a5 1px solid; border-left: #4371a5 1px solid; border-bottom: #4371a5 1px solid;" width="100%">
          <tr>
           <td align="center" class="text" style="width: 100%; height: 23px; background-color: #4371a5">
               Vessel Crew Documents Report
           </td>
          </tr>
          <tr>
