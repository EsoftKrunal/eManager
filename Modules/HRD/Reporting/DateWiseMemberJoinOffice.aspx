<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DateWiseMemberJoinOffice.aspx.cs" Inherits="Reporting_DateWiseMemberJoinOffice" %>
                            ...
                            <td style="text-align: left">
                                <table cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                        ...
                                        <td style="padding-right: 5px; width: 197px; text-align: right">
                                         From Date :</td>
                                        <td style="width: 196px; text-align: left">
                                         <asp:TextBox ID="txtfromdate" runat="server" CssClass="required_box" Width="102px"></asp:TextBox>
                                            <asp:ImageButton
                                                    ID="imgfrom" runat="server" CausesValidation="False" ImageUrl="~/Modules/HRD/Images/Calendar.gif"
                                                    TabIndex="79" /></td>
                                        <td style="width: 196px; text-align: left">
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" Display="Dynamic" runat="server" ControlToValidate="txtfromdate"
                                        ...
                                        <td style="padding-right: 5px; width: 132px; text-align: right">
                                         To Date :</td>
                                        <td style="width: 150px; text-align: left">
                                        <asp:TextBox ID="txttodate" runat="server" CssClass="required_box" Width="102px"></asp:TextBox>
                                        <asp:ImageButton ID="imgto" runat="server" CausesValidation="False" ImageUrl="~/Modules/HRD/Images/Calendar.gif" TabIndex="79" />
                                        </td>
                                        <td style="width: 239px; text-align :left  ">
                                             ...
                                             <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txttodate" ErrorMessage="Required" Display="Dynamic"></asp:RequiredFieldValidator>
                                        </td>
                                        <td>
