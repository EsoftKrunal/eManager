<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PromotioDetails.aspx.cs" Inherits="Reporting_PromotioDetails" MasterPageFile="~/Modules/HRD/Reporting/ActivityTracking.master"  %>
             ...
             <tr>
                 <td>
                     <table cellpadding="0" cellspacing="0" style="width: 100%">
                         <tr>
                             <td style="padding-right: 10px; text-align: right; width: 125px;">
                                 User Name:</td>
                             <td style="text-align: left; width: 234px;">
                                 <asp:DropDownList ID="ddl_UserName" runat="server" CssClass="input_box" TabIndex="1" Width="182px">
                                 </asp:DropDownList></td>
                             <td style="padding-right: 10px; text-align: right; width: 61px;">
                                 From:</td>
                             <td style="padding-right: 10px; width: 167px; text-align: left">
                                 <asp:TextBox ID="txt_from" runat="server" CssClass="required_box" Width="102px" TabIndex="2"></asp:TextBox>&nbsp;<asp:ImageButton
                             ...
                             <td style="padding-right: 10px; text-align: right; width: 53px;">
                                 To:</td>
                             <td style="width: 143px; text-align: left">
                                 <asp:TextBox ID="txt_to" runat="server" CssClass="required_box" Width="102px" TabIndex="4"></asp:TextBox>&nbsp;<asp:ImageButton
