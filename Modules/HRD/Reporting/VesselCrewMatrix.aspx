<%@ Page Language="C#" AutoEventWireup="true" CodeFile="VesselCrewMatrix.aspx.cs" Inherits="Reporting_VesselCrewMatrix" %>
                                    ...
                                    <tr style =" padding :3px;">
                                        ...
                                        <td style="text-align: left">
                                            ...
                                            <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToValidate="ddl_Vessel"
                                                ErrorMessage="Required" Operator="NotEqual" ValueToCompare="0" Visible="False"></asp:CompareValidator></td>
                                        <td style="text-align: right; padding-right: 5px">
                                            Matrix :</td>
                                        <td style="text-align: left">
                                            <asp:DropDownList ID="ddl_Matrix" runat="server" CssClass="required_box" Width="232px">
                                            </asp:DropDownList>
