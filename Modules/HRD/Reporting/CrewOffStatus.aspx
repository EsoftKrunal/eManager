<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CrewOffStatus.aspx.cs" Inherits="CrewOffStatus" Title="Crew Off Status Report" %>
                                 ...
                                 <table cellpadding="0" cellspacing="0" width="100%">
                                     <tr>
                                         <td colspan="2" style="padding:3px;border-bottom: #4371a5 1px solid;">
                                             <table cellpadding="0" cellspacing="0" width="100%">
                                                 <tr>
                                                     <td style="height: 13px; width: 88px;">
                                                         Nationality :</td>
                                                     <td style="height: 13px; text-align: left; width: 204px;">
                                                         <asp:DropDownList ID="ddl_Nationality" runat="server" CssClass="input_box" Width="190px">
                                                         </asp:DropDownList></td>
                                                     <td style="width: 102px; height: 13px; text-align: left">
                                                         Owner:</td>
                                                     <td style="width: 376px; height: 13px; text-align: left">
                                                         <asp:DropDownList ID="ddlowner" runat="server" CssClass="input_box" Width="190px">
                                                         </asp:DropDownList></td>
