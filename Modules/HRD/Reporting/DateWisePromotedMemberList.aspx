<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DateWisePromotedMemberList.aspx.cs" Inherits="Reporting_DateWisePromotedMemberList" %>
...
<td align="center" valign="top" >
        <table border="0" cellpadding="0" cellspacing="0" style="border-right: #4371a5 1px solid;border-top: #4371a5 1px solid; border-left: #4371a5 1px solid; border-bottom: #4371a5 1px solid;text-align: center" width="100%">
            <tr>
                <td align="center" class="text headerband" style="width: 100%;">Date Wise Promoted Officer</td>
            </tr>
            <tr>
                <td style="width: 100%">
                        ...
                        <tr>
                            <td style="text-align: left">
                                 <table cellpadding="0" cellspacing="0" width="100%">
                                         ...
                                         <td style="height: 4px; width: 150px; text-align : right ">From Date :</td>
                                         ...
                                         <td style="height: 4px;">
                                             ...
                                             <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtfromdate" ErrorMessage="Required"></asp:RequiredFieldValidator>
                                         </td>
                                         <td style="height: 4px; width: 64px;">To Date :</td>
                                         <td style="height: 4px; width: 330px;">
                                         ...
                                         <td style="height: 4px">
                                             <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txttodate" ErrorMessage="Required"></asp:RequiredFieldValidator>
                                     ...
                                     <tr>
                                         <td style="width: 330px;" colspan="7" >
