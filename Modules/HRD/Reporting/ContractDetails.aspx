<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ContractDetails.aspx.cs" Inherits="Reporting_ContractDetails" MasterPageFile="~/Modules/HRD/Reporting/ActivityTracking.master" %>
         ...
         <tr>
             ...
             <tr>
                 <td>
                     <table cellpadding="0" cellspacing="0" style="width: 100%; height: 25px;">
                         <tr>
                             <td style="padding-right: 10px; text-align: right; width: 141px;">
                                 User Name:</td>
                             <td style="text-align: left; width: 219px;">
                                 <asp:DropDownList ID="ddl_UserName" runat="server" CssClass="input_box" TabIndex="1" Width="174px">
                                 </asp:DropDownList></td>
                             <td style="padding-right: 10px; text-align: right">
                                 From:</td>
                             <td style="padding-right: 10px; width: 174px; text-align: left">
            ...
            <asp:Button ID="btn_show" runat="server" CssClass="btn" Text="Show Report" OnClick="btn_show_Click" TabIndex="6" /></td>
                     ...
                     <ajaxToolkit:CalendarExtender ID="CalendarExtender1" runat="server" 
                         Format="dd-MMM-yyyy" OnClientShown="onCalendarShown" PopupButtonID="img_from" 
                         PopupPosition="TopRight" TargetControlID="txt_from" ></ajaxToolkit:CalendarExtender>                    
                     <ajaxToolkit:CalendarExtender ID="CalendarExtender2" runat="server" 
                         Format="dd-MMM-yyyy" OnClientShown="onCalendarShown" PopupButtonID="img_to" 
                         PopupPosition="TopRight" TargetControlID="txt_to"></ajaxToolkit:CalendarExtender>
