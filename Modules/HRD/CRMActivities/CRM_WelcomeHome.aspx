<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CRM_WelcomeHome.aspx.cs" Inherits="CRMActivities_CRM_WelcomeHome" %>
...
<body>
    ...
    <ajaxToolkit:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server"></ajaxToolkit:ToolkitScriptManager> 
        ...
        <div style="font-family:Arial;font-size:12px;">            
            ...
            <div class="text headerband" style="font-size:13px; width:100%; height:25px; vertical-align:middle;  ">Welcome</div>
            ...
            <tr >
                ...
                <td ><%#Common.ToDateString(Eval("SignOffDate"))%></td>                
