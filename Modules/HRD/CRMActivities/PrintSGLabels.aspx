<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrintSGLabels.aspx.cs" Inherits="CRMActivities_PrintSGLabels" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Print Seasons Greeting Labels</title>
               ...
               <tr>
                    <td>
                        <table cellpadding="2" cellspacing="1" width="100%" border="0" style="border-collapse:collapse;font-weight:bold; ">
                            ...
                            <td style="text-align:left;"><asp:Label ID="lblRecOffice" runat="server" ></asp:Label> </td>
