<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PrintBirthDayLabels.aspx.cs" Inherits="CRMActivities_PrintBirthDayLabels" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Print Birth Day Labels</title>
...
<script type="text/javascript" language="javascript" >
    ...
    function printFamilyBDLabel(Ids) {
        window.open('FamilyBirthDayLabelPrinting.aspx?Ids=' + Ids, '_blank', '', '');
    }
</script>
               ...
               <tr>
                    <td>
                        <table cellpadding="2" cellspacing="1" width="100%" border="0" style="border-collapse:collapse;font-weight:bold; ">
                            ...
                            <td id="tdRelationTit" runat="server" style="text-align:right;">Relation : </td>
                            <td id="tdRelationdd" runat="server" style="text-align:left;"><asp:DropDownList ID="ddlrelation" runat="server" CssClass="input_box" Width="165px"></asp:DropDownList></td>
                     ...
                     <tr> 
                          ...
                          <td>
                               <div id="dv_Print_Crew" runat="server">
                               ...
                               <div id="dv_Print_Family" runat="server" visible="false">
                                   <div style="height:25px; text-align:center; overflow-y:scroll; overflow-x:hidden; border:solid 1px #c2c2c2">
                                        <table cellpadding="2" cellspacing="1" width="100%" border="0" style="border-collapse:collapse; height:25px; background-color:#FFEB99; font-weight:bold; ">
                                        <colgroup>  
                                            <col style="width:50px; text-align:center;" />
                                        ...
                                        <tr> 
                                        <td><asp:CheckBox ID="chkSelectAll_Print_Family" AutoPostBack="true" ToolTip="Select All" OnCheckedChanged="chkCheckAll_Print_CheckedChanged" runat="server"  /></td>           
                                        <td>Emp#</td>
                                   ...
                                   <div style="height:450px; text-align:center; overflow-y:scroll; overflow-x:hidden; border:solid 1px #c2c2c2">
                                        ...
                                        <asp:Repeater runat="server" ID="rpt_PrintLabel_Family">
                                        <ItemTemplate>
                                        <tr >
                                        <td><asp:CheckBox ID="chkSelect" CrewFamilyId='<%#Eval("CrewFAMILYId")%>' runat="server" /></td>            
                                        <td><%#Eval("FAMILYEMPLOYEENUMBER")%></td>
                                        <td>&nbsp;<%#Eval("CrewFamilyName")%></td> 
                                        <td><%#Common.ToDateString(Eval("DateOfBirth"))%></td>
                                        <td><%#Eval("Relation")%></td>        
                                        <td><%#Eval("CrewNumber")%></td>
                                        <td>&nbsp;<%#Eval("CrewName")%></td>
