<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CRM_BirthDays.aspx.cs" Inherits="CRMActivities_CRM_BirthDays" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>CRM BirthDays</title>
...
<script type="text/javascript" language="javascript" >
    function openprintLabel(CF, Days) {
        window.open('PrintBirthDayLabels.aspx?CF=' + CF + '&Days=' + Days, '_blank', '', '');
    }
</script>
...
<body>
    ...
    <ajaxToolkit:ToolkitScriptManager ID="ToolkitScriptManager1" runat="server"></ajaxToolkit:ToolkitScriptManager>   
        ...
        <div style="font-family:Arial;font-size:12px;">            
            ...
            <div class="text headerband" style=" font-size:13px; width:100%; height:25px; vertical-align:middle;  ">Birth Day Card</div>
            <div style="float:right; ">
               <asp:Button ID="btnBack" Text="Back" OnClick="btnBack_Click" class="btn" runat="server" />
            </div>
            <table cellpadding="2" cellspacing="1" width="100%" border="0" style="border-collapse:collapse; ">
            <tr>
            <td style="text-align:right;">Crew/ Family : </td>
            <td style="text-align:left;"><asp:RadioButton ID="rdoCrew" AutoPostBack="true" OnCheckedChanged="rdoCrew_CheckedChanged" Text="Crew" Checked="true" runat="server" GroupName="CF" /><asp:RadioButton ID="rdoFamily" AutoPostBack="true" OnCheckedChanged="rdoCrew_CheckedChanged" Text="Family" runat="server" GroupName="CF" /> </td>
            ...
            <td style="text-align:left;"><asp:DropDownList ID="ddlrelation" runat="server" CssClass="input_box" Width="165px"></asp:DropDownList></td>
            </tr>
            <tr>
            <td colspan="5" style="text-align:left; padding-left:10px;"><asp:Button ID="btnSendBD" OnClick="btnSendBD_Click" Text="Update Card Delivery" Width="160px" runat="server" CssClass="btn"  />&nbsp;&nbsp;<asp:Button ID="btnPrintLabel" OnClick="btnPrintLabel_Click" Text="Print Label" runat="server" CssClass="btn" /></td>            
            <td colspan="5" style="text-align:right; padding-right:10px;"><asp:Label runat="server" ID="lblMsg" ForeColor="Red"></asp:Label>&nbsp;&nbsp;<asp:Label runat="server" ID="lblRcount1"></asp:Label>&nbsp;&nbsp;<asp:Button ID="btnSearchBD" OnClick="btnSearchBD_Click" Text="Search" runat="server" CssClass="btn" />
            ...
            <td >Rect. Office</td>
            <td >Curr./ Last VSL</td>
            <%--<td style="width:70px; text-align:center;">Last VSL</td>--%>
            <td >City</td>
            <td >Sent By/ On</td>
            <td >&nbsp;</td>
            </tr>
            ...
            <ItemTemplate>
            <tr >
                <td ><asp:CheckBox ID="chkSent" CrewId='<%#Eval("CrewId")%>'  runat="server" Visible='<%#Eval("CardSent").ToString() == "" %>' /><img id="Img3" alt="" src="../Images/favicon.png" runat="server" title='<%# (Eval("CardSent").ToString() == "" ? "" : "Sent On : " + Common.ToDateString(Eval("CardSent"))) %>' visible='<%#Eval("CardSent").ToString() != "" %>' /> </td>            
                ...
                <%--<td style="width:70px; text-align:center;">&nbsp;<%#Eval("LastVsl")%></td>--%>
                <td >&nbsp;<%#Eval("City")%></td>
            ...
            <div id="dv_CrewFamily" runat="server" visible="false">
                <div style="height:25px; text-align:center; overflow-y:scroll; overflow-x:hidden; border:solid 1px #c2c2c2">
            <table cellpadding="2" cellspacing="1" width="100%" border="0" style="border-collapse:collapse; height:25px; background-color:#FFEB99; font-weight:bold; ">
            <colgroup>
                    <col style="width:50px; text-align:center;" />
            ...
            <tr class= "headerstylegrid"> 
            <td ><asp:CheckBox ID="chkCheckAll_Family" AutoPostBack="true" ToolTip="Select All"  OnCheckedChanged="chkCheckAll_CheckedChanged" runat="server"  /></td>           
            <td >Emp#</td>
            ...
            <asp:Repeater runat="server" ID="rpt_CrewFamily">
            <ItemTemplate>
            <tr >
                <td ><asp:CheckBox ID="chkSent" CrewFamilyId='<%#Eval("CrewFAMILYId")%>' runat="server" Visible='<%#Eval("CardSent").ToString() == "" %>' /><img id="Img4" alt="" src="../Images/favicon.png" runat="server" title='<%# (Eval("CardSent").ToString() == "" ? "" : "Sent On : " + Common.ToDateString(Eval("CardSent"))) %>' visible='<%#Eval("CardSent").ToString() != "" %>' /> </td>            
                <td ><%#Eval("FAMILYEMPLOYEENUMBER")%></td>
                <td align="left">&nbsp;<%#Eval("CrewFamilyName")%></td> 
                <td ><%#Common.ToDateString(Eval("DateOfBirth"))%></td>
                <td align="left"><%#Eval("Relation")%></td>        
                <td ><%#Eval("CrewNumber")%></td>
                <td align="left">&nbsp;<%#Eval("CrewName")%></td>
                <td align="left"><%#Eval("RankCode")%></td>
                <td align="left">&nbsp;<%#Eval("RecruitingOfficeName")%></td>
                <td align="left"><%#Eval("City")%></td>
                <td align="left">&nbsp;<%# (Eval("UpdatedBy").ToString() == "" ? "" : (Eval("UpdatedBy").ToString() + "/ " + Common.ToDateString(Eval("CardSent"))))%></td>           
                <td >&nbsp;</td>
            </tr>
            </ItemTemplate>
            <AlternatingItemTemplate>
