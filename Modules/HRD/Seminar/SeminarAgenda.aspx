...
<head id="Head1" runat="server">
    ...
    <link rel="stylesheet" type="text/css" href="../Styles/SeminarAgenda.css?ddddd" />
        ...
        <asp:Repeater ID="rptAgenda"  runat="server">
            <ItemTemplate>
                <div class="row">
                    ...
                    <tr>
                    <td style="width:25px; vertical-align:top; text-align:center;vertical-align:middle;">
                        <div class="listaction" onclick="EditAgenda(<%#Eval("TableID")%>,'E')"><img alt="" src="../Images/AddPencil.gif" ></img></div>                        
                    </td>
                    <td style="width:25px; vertical-align:top; text-align:center;vertical-align:middle;">
                        <div class="listaction" onclick="return DeleteAgenda(<%#Eval("TableID")%>,'D')" > <img alt="" src="../Images/delete_12.gif" ></img> </div>
                    </td>
        ...
        <center>
            ...
            <div style="position: relative; text-align: center; background: white; z-index: 150;top: 30px; border: solid 5px black; width: 900px;">
                <center>
                    ...
                    <div style="padding: 5px; text-align: right; background-color: #E2EAFF;">
                        <asp:Button runat="server" ID="Button1" Text="Close" OnClick="btnClose_Click" Style="background-color: Red;color: White; border: none; padding: 4px;" Width="100px" />
                    </div>
                </center>
            </div>
        </center>
