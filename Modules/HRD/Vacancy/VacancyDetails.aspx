<%@ Page Title="EMANAGER" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="VacancyDetails.aspx.cs"  EnableEventValidation="false" Inherits="Modules_HRD_Vacancy_VacancyDetails" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentMainMaster" Runat="Server">
    ...
    <div style="text-align: left">
        ...
        <table style="width: 100%" cellpadding="0" cellspacing="0">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" style="border-right: #4371a5 1px solid; border-top: #4371a5 1px solid; border-left: #4371a5 1px solid; border-bottom: #4371a5 1px solid; text-align: center" width="100%">
                        ...
                        <tr>
                                                ...
                                                <tr>
                                                    <td >
                                                        <table border="0" cellspacing="0" cellpadding="0px" width="100%" >
                                                            ...
                                                            <tr>
                                                                <td colspan="2" style="text-align: left;padding-left:60px;">US Visa : 
                                                                    <asp:CheckBox ID="chk_UsVisa" runat="server" TabIndex="4" />
                                                                    &nbsp;&nbsp;&nbsp;
                                                                    Schengen visa : &nbsp;&nbsp;
                                                                    <asp:CheckBox ID="chk_SchengenVisa" runat="server" TabIndex="5" />
                                                                </td>
                                                                <td style="text-align: right;"> Vessel Type : </td>
                                                                <td colspan="4" style="text-align: left;">
                                                                    <asp:DropDownList ID="ddl_VesselType" runat="server" CssClass="form-control" Width="165px" TabIndex="6">
                                                                        <asp:ListItem Text="&lt; Select &gt;" ></asp:ListItem>
                                                                    </asp:DropDownList>
                                                                    </td>
                                                             ...
                                                             <tr>
                                                                <td style="text-align: right;">Vacancy Status :
                                                                </td>
                                                                <td >
                         ...
                         <asp:HiddenField ID="hdnResendProposal" runat="server" Value="false" ></asp:HiddenField>
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%">
                                                            <tr>
                                                                <td align="center" colspan="6" style="padding-right: 15px; text-align: right;">
                                                                    <strong>Total Filterd Records :&nbsp;<asp:Label ID="VacancyCount" runat="server"></asp:Label>&nbsp;</strong>
                                                ...
                                                <tr>
                                                    <td>
                                                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                            <tr>
                                                                <td colspan="3" style="padding-right: 0px; padding-left: 0px; padding-bottom: 5px; padding-top: 0px;width:50%;">
                                                                    <div style="height: 340px; overflow-x: hidden; overflow-y: scroll;">
                                                                        <center>
                                                                            <asp:Label ID="lblGrid" runat="Server"></asp:Label>
                                                                        </center>
                                                                        <asp:GridView OnDataBound="DataBound" CellPadding="0" CellSpacing="0" ID="Gv_Vacancy" OnRowCommand="Gv_Vacancy_RowCommand" runat="server" AllowSorting="True" AutoGenerateColumns="False" OnPageIndexChanging="gvCustomers_OnPageIndexChanging" OnRowDataBound="Gv_Vacancy_RowDataBound" OnSelectedIndexChanged="Gv_Vacancy_SelectIndexChanged" OnSorted="on_Sorted" OnSorting="on_Sorting" Width="98%"  OnRowDeleting="Row_Deleting" GridLines="horizontal" OnPreRender="Gv_Vacancy_PreRender" OnRowCancelingEdit="Gv_Vacancy_RowCancelingEdit">
                                                                            <Columns>
                                            ...
                                            Text="Delete" />
                                                        ...
                                                        <asp:Button ID="Button1" runat="server" CausesValidation="False" CommandArgument="Prev"
                                                            CommandName="Page" CssClass="previous" Text="" ToolTip="Previous Page" />
                                                                 ...
                                                                 <td colspan="3" style="padding-right: 0px; padding-left: 0px; padding-bottom: 5px; padding-top: 0px;width:50%;">
                                                                     <table id="tblCandidate" runat="server" visible="false" width="100%">
                                                                         <tr><td>
                                ...
                                <td scope="col" style=" text-align:left">Proposal Action</td>       
                                </tr>
                                </table>
                                </div>
         ...
         <!--  Add Signer Details -->
    <div style="position:absolute;top:50px;left:100px; height :510px; width:90%;" id="dvAddSignerDetails" runat="server" visible="false">
    <center>
        <div style="position:fixed;top:0px;left:100px; min-height :100%; width:90%; background-color :Gray;z-index:100; opacity:0.4;filter:alpha(opacity=40)"></div>
        <div style="position:relative;width:90%; padding :5px; text-align :center;background : white; z-index:150;top:50px; border:solid 0px black;">
            <center >
        ...
        <div style="position: absolute; top: 25px; left: 100px; height: 650px; width: 85%;" id="dvProposalToOwner" runat="server" visible="false">
            ...
            <div style=" text-align: center;width:100%;">
                <table style="width:100%;" >
                    <tr>
                        <td style="padding-right:5px;text-align:right;width:200px;padding:5px;"> Vacancy Id : </td>
                        <td style="padding-left:5px;text-align:left;padding:5px;"> <b><asp:Label ID="lblVacancyId" runat="server"></asp:Label>  </b> </td>
                    </tr>
                    <tr>
                    ...
                    <tr id="trToEmail" runat="server" visible="false">
                        <td style="padding-right:5px;text-align:right;width:200px;padding:5px;">
                            To Email : 
                        </td>
                        <td style="padding-left:5px;text-align:left;vertical-align:middle;padding:5px;" >
