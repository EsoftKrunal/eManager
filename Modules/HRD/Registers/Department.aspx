<%@ Page Language="C#" MasterPageFile="~/Modules/HRD/RegistersMasterPage.master" AutoEventWireup="true" CodeFile="Department.aspx.cs" Inherits="Registers_Department" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <table  align="center" width="100%" border="0" cellpadding="0" cellspacing="0">
        <tr>
       <td>
           <asp:Label ID="Label1" runat="server" CssClass="textregisters" Text="Department"></asp:Label></td>
    </tr>  
        <tr>
            <td>
                <fieldset style="border-right: #8fafdb 1px solid; border-top: #8fafdb 1px solid;
                    border-left: #8fafdb 1px solid; border-bottom: #8fafdb 1px solid; padding-top:0px; padding-bottom:10px">
                    <legend><strong>Department List</strong></legend>
                            ...
                            <Columns>
                               ...
                               <%-- <asp:CommandField ButtonType="Image" EditImageUrl="~/Modules/HRD/Images/edit.jpg" HeaderText="Edit"
                                 ...
                                 <asp:TemplateField HeaderText="Edit">
                                    <ItemStyle Width="40px" />
                                            <ItemTemplate>
                                                <asp:ImageButton ID="btnEditDepartment" CausesValidation="false" OnClick="btnEditDepartment_click"
                                ...
                                <asp:TemplateField HeaderText="Department">
                                    ...
                                    <ItemTemplate>
                                        ...
                                        <asp:HiddenField ID="HiddenDepartmentId" runat="server" Value='<%#Eval("DepartmentId")%>' />
                                        <asp:HiddenField ID="HiddenDepartmentName" runat="server" Value='<%#Eval("DepartmentName")%>' />
                                    </ItemTemplate>
                                </asp:TemplateField>
                ...
                <asp:Label ID="lbl_Department_Message" runat="server" ForeColor="#C00000"></asp:Label>
                    </fieldset> </td>
        </tr>
            <tr>
                <td style="padding-top:15px">
                    <asp:Panel ID="Departmentpanel" runat="server" Visible="false" Width="100%">
                         <fieldset style="border-right: #8fafdb 1px solid; border-top: #8fafdb 1px solid;
                                    ...
                                    <legend><strong>Department Details</strong></legend>
                                          <table cellpadding="0" cellspacing="0" width="100%">
                                              <tr>
                                                 <td colspan="4">
                                                     <asp:HiddenField ID="HiddenDepartmentpk" runat="server" />
                                                     &nbsp;
                                                 </td>
                                              </tr>
                                              <tr>
                                                 <td align="right" style="padding-right:15px; height: 19px;">
                                                     Department:</td>
                                                 <td align="left">
                                                     <asp:TextBox ID="txtDepartmentname" runat="server" CssClass="required_box" MaxLength="24" TabIndex="1"
                                              ...
                                              <tr>
                                                 <td align="right" style="padding-right:15px; height: 19px;">
                                                     Status:</td>
                                                 <td align="left" style="height: 20px">
                                                     <asp:DropDownList ID="ddstatus_Department" runat="server" CssClass="input_box" Width="129px" TabIndex="2">
                                                     </asp:DropDownList></td>
            ...
            <tr>
                <td align="right" style="height: 18px">
                    <asp:Button ID="btn_Department_add" runat="server" CausesValidation="False" CssClass="btn"
                        OnClick="btn_Department_add_Click" Text="Add" Width="59px" TabIndex="3" />
                    <asp:Button ID="btn_Department_save" runat="server" CssClass="btn" OnClick="btn_Department_save_Click"
                            Text="Save" Width="59px" Visible="False" TabIndex="4" />
                    <asp:Button ID="btn_Department_Cancel" runat="server"
                                CausesValidation="false" CssClass="btn" OnClick="btn_Department_Cancel_Click" Text="Cancel"
                                Width="59px" Visible="False" TabIndex="5" />
                    <asp:Button ID="btn_Print_Department" runat="server" CausesValidation="False" CssClass="btn" OnClick="btn_Print_Department_Click" TabIndex="6" Text="Print" Width="59px" OnClientClick="javascript:CallPrint('ctl00_ContentPlaceHolder1_Departmentpanel');" Visible="False" />                                 
                </td>
            </tr>
            <tr>
