<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ManningGrade.aspx.cs" Inherits="Registers_ManningGrade" MasterPageFile="~/Modules/HRD/RegistersMasterPage.master"  %>
     ...
     <tr>
       <td>
        <table cellpadding="0" cellspacing="0" width="100%">
             <tr>
       <td>
           <asp:Label ID="Label1" runat="server" CssClass="textregisters" Text="Mannin Grades"></asp:Label></td>
       </tr> 
            <tr>
                       ...
                       <asp:GridView ID="GridView_FlagState" runat="server" AutoGenerateColumns="False" GridLines="Horizontal" Width="98%" DataKeyNames="GradeId" OnSelectedIndexChanged="GridView_FlagState_SelectedIndexChanged" OnRowEditing="GridView_FlagState_Row_Editing" OnRowDeleting="GridView_FlagState_Row_Deleting" OnPreRender="GridView_FlagState_PreRender" OnDataBound="GridView_FlagState_DataBound" OnRowCommand="GridView_FlagState_RowCommand" >
                         <Columns>
                              ...
                              <asp:TemplateField HeaderText="Edit">
                               ...
                               <asp:TemplateField HeaderText="Grade Name"><ItemStyle HorizontalAlign="Left" Width="200px" />
                                  <ItemTemplate>  
                                   <asp:Label ID="lblflagstate" runat="server" Text='<%#Eval("GradeName")%>'></asp:Label>
                                   <asp:HiddenField ID="HiddenFlagStateId" runat="server" Value='<%#Eval("GradeId")%>' />
                                    <asp:HiddenField ID="HiddenFlagStateName" runat="server" Value='<%#Eval("GradeName")%>' />
                                  </ItemTemplate>
                               </asp:TemplateField>
                    ...
                    <tr>
                      ...
                      <tr>
                          ...
                          <td style="text-align: left; height: 13px;">
                                                            ...
                                                            <tr>
                                                                <td align="right" style="text-align: right; padding-right:15px; vertical-align:top; ">
                                                                    Manning Grade:</td>
                                                                ...
                                                                <div style="width:230px; overflow-y:scroll;oveflow-x:hidden; vertical-align:top; height :150px;" class="input_box" >
                                                                    <asp:CheckBoxList ID="chkbxRank" runat="server" TabIndex="2" Width="205px">
                                                                    </asp:CheckBoxList>
                                                                    </div>
                                                                </td>
                                                            </tr>
