<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CertSubCategory.aspx.cs" Inherits="Registers_CertSubCategory" MasterPageFile="~/Modules/HRD/RegistersMasterPage.master" %>
...
<body>
    ...
    <tr>
       <td>
           <asp:Label ID="Label1" runat="server" CssClass="textregisters" Text="Certificate Sub Category"></asp:Label></td>
    </tr>   
     <tr>
       <td>
          ...
          <tr>
            <td style="text-align: center;">
              <fieldset style="border-right: #8fafdb 1px solid; border-top: #8fafdb 1px solid;border-left: #8fafdb 1px solid; border-bottom: #8fafdb 1px solid; text-align: center; padding-top:0px; padding-bottom:10px">
                 <legend><strong>Certificate Sub Category</strong></legend>
                    <table cellpadding="0" cellspacing="0" width="100%">
                     <tr>
                         ...
                         <Columns>
                               ...
                               <asp:TemplateField HeaderText="Edit">
                                    <ItemStyle Width="40px" />
                                            <ItemTemplate>
                                                <asp:ImageButton ID="btnEditCertSubCat" CausesValidation="false" OnClick="btnEditCertSubCat_Click"
                                                    ImageUrl="~/Modules/HRD/Images/edit.jpg" runat="server" ToolTip="Edit" 
                                                    CommandArgument='<%#Eval("CertSubCatId")%>' />
                                                <asp:HiddenField ID="hdnCertSubCatId" runat="server" Value='<%#Eval("CertSubCatId")%>' />
                                            </ItemTemplate>
                                                                    </asp:TemplateField>
                               ...
                               <ItemTemplate>  
                                   <asp:Label ID="lblCertCatName" runat="server" Text='<%#Eval("CertSubCatName")%>'></asp:Label>
                                   <asp:HiddenField ID="CertCatId" runat="server" Value='<%#Eval("CertSubCatId")%>' />
                               </ItemTemplate>
                               </asp:TemplateField>
                          ...
                          <td style="text-align: left; height: 13px;">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="right" style="text-align: right;padding-right:15px">
                                                                    Category :</td>
                                                                <td style="text-align: left">
                                                                    <asp:DropDownList ID="ddlCat" runat="server" CssClass="input_box" 
