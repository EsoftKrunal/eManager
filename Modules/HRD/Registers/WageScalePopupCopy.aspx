...
<head runat="server">
    ...
    {
        window.parent.document.getElementById('txtHistory').value=id;    
        window.parent.document.getElementById('btn_Show_History').click();
        parent.tb_remove();
    }
    ...
    {   
        ...
        var Nat=0;
        window.parent.document.getElementById('txtCopy').value="WCId=" + WSId + "&Sen=" + Sen + "&Nat=" + Nat;;    
        window.parent.document.getElementById('btn_Show_Copy').click();
        parent.tb_remove();
    }
    </script> 
    <style type="text/css">
         ...
         <legend><strong>Copy From</strong></legend>
            <table cellpadding="5" cellspacing="5" style="width:85%"  >
                <tr>
                    ...
                    <td style="text-align: left; " class="style1"><asp:DropDownList ID="ddcopywage" 
                            runat="server" CssClass="required_box" Width="274px"></asp:DropDownList></td>
             ...
             <%--   <tr>
                    ...
                    <td style=" text-align: left" valign="top" class="style1">
                        <asp:DropDownList ID="ddcopynationality" runat="server" CssClass="required_box" 
                ...
                <tr>
                    ...
                    <td style=" text-align: left" valign="top" class="style1">
                        <asp:TextBox ID="txtcopyseniority" runat="server" CssClass="required_box" 
                            MaxLength="2" Width="57px"></asp:TextBox></td>
                ...
                <tr>
                    ...
                    <td style=" text-align: center" valign="top">
                        <asp:Button ID="btncopyshow" runat="server" CssClass="btn" OnClientClick='BindCopy();return false;' Text="Copy to create New" Width="150px" ValidationGroup="aa" />
                    </td>
