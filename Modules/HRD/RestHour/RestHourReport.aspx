<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RestHourReport.aspx.cs" Inherits="RestHourReport" Async="true" %>
...
<head runat="server">
    <title>Rest Hour Management</title>
...
<body>
    ...
    <div>
    <div>
    <div style="padding:7px; background:#1a8cff; color:White;">Rest Hour Management</div>
    ...
    <div>
        ...
        <table cellpadding="0" cellspacing="0" width="100%" border="0" style="border-collapse:collapse;" class="table-border-header">
         <tr>
            ...
            <td style="width:250px;text-align:center">More than 3 Days NC ( No of Crew )</td>
         ...
         <ItemTemplate>
          <tr class="myrow">
            ...
            <td style="width:100px;text-align:center">
                <img month='<%#Eval("MNTH")%>' vesselid='<%#Eval("vesselid")%>' src="../Images/Calendar.gif" style="cursor:pointer" onclick="PostForm(this);" />
    ...
    <td style="width:150px; text-align:center">
        <asp:Button runat="server" ID="btnAddremarks" Text=" + Add Office Remarks" OnClick="btnAddComments_Click"/>
    </td>
    </tr>
    </table>
    </div>
    ...
    <div style="position:absolute;top:0px;left:0px; height :100%; width:100%; " id="dv_AddComments" runat="server" visible="false">
        <center>
            ...
            <div style="position:relative;width:800px; padding :0px; text-align :center;background : white; z-index:150;top:20px; border:solid 3px #4db8ff;">
                <center >
                    <div style="padding:5px; background:#4db8ff"><b><asp:Label ForeColor="white" ID="lblVessel1" runat="server" Font-Size="18px"></asp:Label></b></div>
                    ...
                    <asp:Button ID="btnSaveComments" style=" background-color:#333; color:White; border:none; padding:3px; " Width="80px" runat="server" Text="Save" OnClick="btnSaveComments_Click" />
                    <asp:Button ID="btnClose" style=" background-color:RED; color:White; border:none; padding:3px; " Width="80px" runat="server" Text="Close" OnClick="btnClose_Click" />
