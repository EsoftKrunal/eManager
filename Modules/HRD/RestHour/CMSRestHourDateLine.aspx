...
<body style="font-size:13px; color:#333">
    ...
    <div style="text-align: center" id="content">
            ...
            <asp:Button runat="server" ID="btnpost"  Text="post" OnClick="btnpost_Click" style="display:none" />
             <table cellpadding="5" border="0">
                 <tr>
                     ...
                     <td style="font-size:18px;text-align:left; width:230px;" id="datelineheader" runat="server"><%--International Dateline :--%> </td>
        ...
        <div style="text-align:center;">
            ...
            <br />
            <asp:LinkButton runat="server" id="dvmsglogs" ForeColor="Red" Font-Size="18px" OnClick="dvmsglogs_Click"></asp:LinkButton>
