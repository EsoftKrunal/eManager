<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HomeAllotmentSummary.aspx.cs" Inherits="Modules_HRD_CrewPayroll_HomeAllotmentReport" %>
                                                ...
                                                <table cellpadding="2" cellspacing="0" style="border-collapse:collapse;width:100%;" border="1">
                                                    ...
                                                    <tr class= "headerstylegrid" style=" height:45px;font-size:14px;">
                                                       ...
                                                       <%-- <td style="width :7%;text-align :center">Sign On Date</td>--%>
                                                        ...
                                                        <td style="width :4%;text-align :center">Regular Allotment</td>
                                                        <td style="width :4%;text-align :center">Special Allotment</td>
                                                    ...
                                                    <tr style='font-size:14px;' >
                                                       ...
                                                       <%-- <td>
                                                        ...
                                                        <td style="text-align :center;color:black;"><%#Eval("Regular_Allotment")%></td> 
                                                        <td style="text-align :center;color:black;"><%#Eval("Special_Allotment")%></td> 
                                                    ...
                                                    <tr  style=" height:45px;font-size:14px;">
                                                        ...
                                                        <td style="width :7%;text-align :center"><b><asp:Label ID="lblTotalRegularAllotment" runat="server" Text="0"></asp:Label></b></td>
                                                        <td style="width :7%;text-align :center"><b><asp:Label ID="lblTotalSpecialAllotment" runat="server" Text="0"></asp:Label></b></td>
